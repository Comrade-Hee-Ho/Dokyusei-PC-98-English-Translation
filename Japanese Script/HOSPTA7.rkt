(mes
 ...
 (dict #\・ #\い #\【 #\】 #\。 #\っ #\子 #\、 #\た #\亜 #\ん #\に #\な #\の
  #\ね #\ら #\は #\ち #\て #\ま #\と #\れ #\さ #\よ #\が #\る #\く #\え #\ゃ
  #\も #\（ #\） #\し)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
         ...
         (cond ((== V 0)
                (<>
                 ...
                 (cond ((== N 1)
                       ...
                       ((== N 2)
                        (<>
                         (text #:color 7 "【" 0 "】（よそうぜ・・・今は入りたくない。）")
                         (wait)))
                       ((== N 3)
                        (<>
                         (text #:color 2 "【亜子】" 0 "君、私は店に戻るけど・・・。")
                         (wait)))
                       (else (<>)))))
               ((&& (== V 2) (== N 1) (== (: 10) 0))
                (<>
               ...
               ((&& (== V 2) (== N 1) (== (: 10) 2))
                (<>
                 (text #:color 2 "【亜子】さて、届け物のすんだし・・・店に戻らないと。")
                 (wait)))
               ((&& (== V 1) (== N 2))
                (<>
                 (text #:color 7 "【" 0 "】（うーん・・・これで処女だなんて、もったいないな。）")
                 (wait)))
               ((&& (== V 1) (== N 3))
                (<>
                 (text #:color 7 "【" 0 "】（亜子さんって、ロングにしても似合うぜ・・・。）")
                 (wait)))
               ((&& (== V 1) (== N 4))
                (<>
                 (text #:color 7 "【" 0 "】（このふくらみに触れたい・・・けど、真子先生が恐いな。）")
                 (wait)))
               ((&& (== V 1) (== N 5))
                (<>
                 (text #:color 7 "【" 0 "】（全身にキスをしたら・・・今度は一ヶ月ぐらい寝込んだりして。）")
                 (wait)))
               (else (<>)))))
 (set-arr~ @ 7 1))