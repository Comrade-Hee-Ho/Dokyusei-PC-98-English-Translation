(mes
 ...
 (dict #\の #\・ #\ゃ #\な #\【 #\】 #\家 #\秘 #\密 #\主 #\た #\い #\じ #\る
  #\う #\が #\。 #\、 #\は #\か #\ま #\よ #\に #\て #\事 #\と #\っ #\ら #\こ
  #\ん #\も #\来 #\し #\り #\え #\あ #\く #\ろ #\を #\君 #\時 #\間 #\れ #\ぞ
  #\？ #\教 #\女 #\で #\今 #\日 #\そ #\だ #\わ #\お #\す #\々 #\言 #\色 #\ー
  #\行 #\彼 #\け #\み #\一 #\つ #\子 #\ぜ #\む #\意 #\味 #\特 #\別 #\葉 #\ば
  #\性 #\出 #\シ #\所 #\内 #\緒 #\会 #\ワ #\場 #\人 #\ち #\げ)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 (while (== 1 1)
        (<>
         ...
         (cond ((&& (== V 277) (== (: 215) 0))
                (<>
                 ...
                 (wait)
                 (text #:color 1 "【秘密の家の主】せっかく来たんじゃから、よい事を教えてやろう・・・『美穂と美沙』は仲がいいだけに相反する関係なんじゃよ。")
                 (wait)
               ...
               ((&& (== V 277) (== H 813) (< R H))
                (<>
                 ...
                 (wait)
                 (text #:color 1 "【秘密の家の主】駅前で、いつも君の事を待っているからな・・・その駅前で他の人に会えない可能性が出てくるのじゃ。")
                 (wait)
               ...
               ((&& (== V 277) (== H 814) (< R H))
                (<>
                 ...
                 (wait)
                 (text #:color 1 "【秘密の家の主】友達の家には、あまり行く必要がないという事じゃ・・・行ったとしても、追い帰されるだけじゃからな。")
                 (wait)
               ...
               ((&& (== V 277) (== H 815) (< R H))
                (<>
                 ...
                 (text #:color 1 "【秘密の家の主】うーん、特別じゃぞ・・・みんなには内緒にする事じゃ。")
                 (wait)
                 (text #:color 1 "【秘密の家の主】美穂という子が、学校の放送室にいる事がある・・・君はそこで彼女に会わないと、新たな展開は望めないじゃろう。")
                 (wait)
               ...
               ((&& (== V 277) (== H 816) (< R H))
                (<>
                 ...
                 (wait)
                 (text #:color 1 "【秘密の家の主】彼女とも出会いがないと、ある場所に行く事ができなくなる・・・それも一箇所ではなく、二箇所もじゃよ。")
                 (wait)
               ...
               ((&& (== V 277) (== H 818) (< R H))
                (<>
                 ...
                 (text #:color 1 "【秘密の家の主】うーん、特別じゃぞ・・・ここだけの話にしておいておくれ。")
                 (wait)
                 (text #:color 1 "【秘密の家の主】最初の一週間は、ほとんど何も起こらないじゃろうが・・・しかし、見えないところでは色々と起こっておるんじゃ。")
                 (wait)
                 (text #:color 1 "【秘密の家の主】ようするに、この一週間が君にとって一番大事な時・・・種をまく時じゃな。")
                 (wait)
                 (text #:color 1 "【秘密の家の主】この種のまき方によって、その後の収穫が違ってくるのじゃ・・・間違ってはいかんぞ、種をまくとは、女の子とするという意味ではないからな。")
                 (wait)
               ...
               ((&& (== V 277) (== H 822) (< R H))
                (<>
                 ...
                 (text #:color 1 "【秘密の家の主】・・・。")
                 (wait)
                 (text #:color 1 "【秘密の家の主】冗談じゃよ・・・今日教えられる事はじゃな、夏子という女性と知り合いであれば、彼女の相談にのってあげる事じゃよ。")
                 (wait)
               ...
               ((&& (== V 277) (== H 823) (< R H))
                (<>
                 ...
                 (wait)
                 (text #:color 1 "【秘密の家の主】まあいい、今日も一つだけいい事を教えてやろう・・・これからは真子と亜子がポイントじゃよ、彼女達とコミュニケーションをとる事が重要じゃ。")
                 (wait)
               ...
               ((&& (== V 277) (== H 824) (< R H))
                (<>
                 ...
                 (text #:color 1 "【秘密の家の主】うーん、特別じゃぞ・・・みんなには内緒にする事じゃ。")
                 (wait)
                 (text #:color 1 "【秘密の家の主】君は色々と選択しなければならん、行く場所もそうじゃろうが、一番重要なのは女の子達からの質問じゃよ。")
                 (wait)
                 (text #:color 1 "【秘密の家の主】いつもいい顔ばかりしてたのでは、人間として面白みがないものじゃよ・・・その事に気づけば、きっといい結果を生む事となるじゃろう。")
                 (wait)
                 (text #:color 1 "【秘密の家の主】うむ、今日はここまでじゃ・・・時間がたってからまた来るがよいぞ。")
                 (wait)
                 (set-var R H)
               ...
               ((&& (== V 277) (== H 825) (< R H))
                (<>
                 ...
                 (wait)
                 (text #:color 1 "【秘密の家の主】最初の一週間は色々な場所に行く事になるじゃろうが・・・その後は、ついつい行く場所もかたよりがちじゃ。")
                 (wait)
                 (text #:color 1 "【秘密の家の主】思わぬ時間に、思わぬ人物がいる時もあるじゃろう・・・たまには深夜の散歩もおつなものではないかな？")
                 (wait)
               ...
               ((&& (== V 277) (== H 826) (< R H))
                (<>
                 ...
                 (wait)
                 (text #:color 1 "【秘密の家の主】約束の時間には、なるべく早く行った方がよいじゃろう・・・他の女の子との出会いによって、予定外の時間を浪費する事もあるじゃろうからな。")
                 (wait)
                 (text #:color 1 "【秘密の家の主】今日はここまでじゃ・・・時間がたってからまた来るがよいぞ。")
                 (wait)
                 (set-var R H)
