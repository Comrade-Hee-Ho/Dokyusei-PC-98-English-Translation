(mes
 ...
 (dict #\・ #\【 #\】 #\な #\。 #\い #\だ #\健 #\二 #\っ #\て #\、 #\の #\る
  #\ん #\に #\は #\が #\か #\も #\う #\を #\ら #\れ #\と #\車 #\？ #\！ #\く
  #\こ #\で #\よ #\僕 #\け #\乗 #\た #\ろ #\言 #\さ #\お #\し #\ち #\ふ #\せ
  #\り)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
         ...
         (cond ((== V 0)
               ...
               ((&& (== V 2) (== N 1) (== (: 10) 0))
                (<>
                 ...
                 (wait)
                 (text #:color 4 "【健二】ふっ・・・日本の法律では、１８歳になれば免許を取得できるんだ、・・・もっとも" 0 "は、免許を取る金さえないだろうがね。")
                 (wait)
                 (set-reg: 10 1)))
               ((&& (== V 2) (== N 1) (== (: 10) 1) (== (: 11) 0))
                (<>
               ...
               ((&& (== V 1) (== N 3))
                (<>
                 (text #:color 7 "【" 0 "】健二、その髪型にその顔は似合わないぜ・・・金持ちなんだから、頭の中味ごと取り替えてもらったらどうだ？")
                 (wait)
