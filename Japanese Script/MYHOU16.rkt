(mes
 ...
 (dict #\・ #\【 #\】 #\。 #\美 #\い #\穂 #\な #\ん #\、 #\っ #\の #\う #\て
  #\か #\だ #\？ #\ち #\と #\ゃ #\君 #\に #\も #\は #\あ #\る #\が #\く #\こ
  #\し #\よ #\ら #\れ #\で #\き #\た #\事 #\！ #\を #\行 #\つ #\私 #\沙 #\俺
  #\（ #\） #\わ #\す #\そ #\け #\聞 #\ま #\好 #\ど #\ね #\何 #\め #\ご #\じ
  #\り #\手 #\ょ #\気 #\ー #\お #\嫌 #\ば #\え #\変 #\合 #\さ #\や #\ろ #\返
  #\げ #\子 #\大 #\紙 #\ホ #\テ #\ル #\ぜ #\本 #\当 #\持 #\言)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 (set-arr~ @ 7 0)
        ...
        (<>
         ...
         (cond ((== V 0)
                (<>
                 ...
                 (cond ((&& (== N 1) (== (: 50) 0))
                        (<>
                         (text #:color 7 "【" 0 "】（まだ美穂ちゃんと話が終ってないだろ？）")
                         (wait)))
                       ((&& (== N 1) (== (: 50) 1))
                        (<>
                         (text #:color 6 "【美穂】" 0 "君、ホテルに行くんでしょ？")
                         (wait)))
                       ((&& (== N 2) (== (: 50) 0))
                        (<>
                         (text #:color 6 "【美穂】だめ。")
                       ...
                       ((&& (== N 4) (== (: 50) 0))
                        (<>
                         (text #:color 7 "【" 0 "】そうだな・・・ここにいようぜ。")
                         (wait)))
                       ((&& (== N 4) (== (: 50) 1))
                        (<>
                         (text #:color 7 "【" 0 "】（まだここにいるのか？・・・蚊に刺されるだけだぜ。）")
                         (wait)))
                       (else (<>)))))
               ((&& (== V 2) (== N 1) (== (: 10) 0))
                (<>
               ...
               ((&& (== V 2) (== N 1) (== (: 10) 3))
                (<>
                 ...
                 (cond ((== N 1)
                        (<>
                         (text #:color 7 "【" 0 "】美穂ちゃん、これからホテルに行かないか？")
                         (wait)))
                       ((== N 2)
                        (<>
                         (text #:color 7 "【" 0 "】美穂ちゃん、これから喫茶店に行かないか？")
                         (wait)))
                       ((== N 3)
                        (<>
                         (text #:color 7 "【" 0 "】美穂ちゃん、これから公園に行かないか？")
                         (wait)))
                       ((== N 4)
                        (<>
                         (text #:color 7 "【" 0 "】美穂ちゃん、俺の部屋に来ないか？")
                         (wait)))
                       (else (<>)))
               ...
               ((&& (== V 1) (== N 2) (== (: 11) 0))
                (<>
                 (text #:color 6 "【美穂】リボンをつける時はいつも、" 0 "君が私の事を好きでありますようにって・・・お願いしながらつけるの。")
                 (wait)
               ...
               ((&& (== V 1) (== N 4) (== (: 13) 1))
                (<>
                 (text #:color 6 "【美穂】私ね・・・すぐに顔が赤くなっちゃうの。")
                 (wait)))
               ((&& (== V 1) (== N 5) (== (: 14) 0))
                (<>
                 (text #:color 6 "【美穂】白いから・・・恥ずかしい。")
                 (wait)
                 (set-reg: 14 1)))
               ((&& (== V 1) (== N 5) (== (: 14) 1))
                (<>
                 (text #:color 6 "【美穂】" 0 "君・・・そんなに見ないで。")
                 (wait)))
               ((&& (== V 1) (== N 6) (== (: 15) 0))
                (<>
               ...
               ((&& (== V 1) (== N 7) (== (: 16) 1))
                (<>
                 (text #:color 7 "【" 0 "】（美穂ちゃんは・・・なぜか正面を向かない。）")
                 (wait)))
               (else (<>)))))
 (set-arr~ @ 7 1))