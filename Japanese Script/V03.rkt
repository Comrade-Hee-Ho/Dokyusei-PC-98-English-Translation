(mes
 ...
 (dict #\・ #\【 #\】 #\。 #\舞 #\の #\っ #\て #\、 #\い #\な #\ん #\た #\し
  #\だ #\か #\う #\あ #\は #\に #\？ #\る #\と #\ち #\ゃ #\君 #\が #\き #\事
  #\わ #\よ #\（ #\） #\も #\え #\れ #\そ #\ま #\で #\好 #\く #\私 #\ふ #\一
  #\部 #\ね #\俺 #\ら #\ー #\を #\り #\！ #\女 #\こ #\屋 #\さ #\洗 #\奇 #\麗
  #\掃 #\除 #\濯 #\や #\ぜ #\ど #\ガ #\緒 #\時 #\彼 #\ン #\覚 #\見 #\今)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 (set-arr~ @ 7 0)
 ...
 (while (== 1 1)
        (<>
         ...
         (cond ((== V 0)
               ...
               ((&& (== V 2) (== N 1) (== (: 12) 7))
                (<>
                 (text #:color 3 "【舞】私ね、" 0 "君の事をずっと見てたの・・・" 0 "君が他の男の子達と一緒にいる時も、他の女の子と一緒にいる時も。")
                 (wait)
                 (text #:color 7 "【" 0 "】ふーん・・・。")
                 (wait)
                 (text #:color 3 "【舞】" 0 "君が他の女の子と一緒にいたり、話してるのを見た時は・・・自分でも不思議なくらい変な気持ちになったのを覚えてるわ。")
                 (wait)
               ...
               ((&& (== V 1) (== N 3) (== (: 14) 1))
                (<>
                 (text #:color 7 "【" 0 "】（俺の部屋にいても奇麗って事は・・・きっと本当に奇麗なんだろう。）")
                 (wait)))
               ((&& (== V 1) (== N 4) (== (: 15) 0))
                (<>
               ...
               ((&& (== V 1) (== N 5) (== (: 16) 1))
                (<>
                 (text #:color 7 "【" 0 "】（どきっとする事を言うな・・・今日の舞ちゃんは。）")
                 (wait)))
               ((&& (== V 1) (== N 6) (== (: 17) 0))
                (<>
                 (text #:color 3 "【舞】" 0 "君・・・。")
               ...
               ((&& (== V 1) (== N 6) (== (: 17) 1))
                (<>
                 (text #:color 7 "【" 0 "】（見てると興奮しちゃうぜ・・・ごっくん。）")
                 (wait)))
               ((&& (== V 1) (== N 7) (== (: 18) 0))
                (<>
