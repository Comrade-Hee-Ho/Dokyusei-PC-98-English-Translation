(mes
 ...
 (dict #\・ #\い #\の #\【 #\】 #\な #\一 #\哉 #\か #\っ #\、 #\て #\。 #\に
  #\ら #\う #\母 #\は #\わ #\す #\！ #\で #\？ #\た #\だ #\と #\よ #\君 #\し
  #\ま #\ん #\を #\も #\ン #\あ #\る #\来 #\が #\ゃ #\言 #\く #\こ #\ー #\そ
  #\れ #\じ #\ね #\帰 #\ち)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
         ...
         (cond ((&& (== V 238) (> T 0) (< T 600))
               ...
               ((&& (== V 238) (== (: 216) 0))
                (<>
                 ...
                 (color 8)
                 (clear)
                 (text #:color 2 "【一哉の母】一哉が帰って来たら、" 0 "君が来たって言っておくわよ・・・もっとも、いつ帰って来るかわからないけど。")
                 (wait)
                 (set-arr~ @ 13 15 322 64 391)
                 (color 8)
                 (clear)
                ...
                (<>
                 ...
                 (cond ((&& (> T 600) (< T 800))
                        (<>
                         ...
                         (wait)
                         (text #:color 2 "【一哉の母】一哉は天使のような寝顔で、スヤスヤと寝ています・・・起こすとかわいそうだから、また来てくれないかしら？")
                         (wait)
                         (set-arr~ @ 13 15 322 64 391)
                         (color 8)
                         (clear)
                       ...
                       ((&& (== V 238) (> T 2000) (< T 2359))
                        (<>
                         ...
                         (color 8)
                         (clear)
                         (text #:color 2 "【一哉の母】あいかわらず口の聞き方がなってないわね・・・一哉の言葉使いが乱暴なのは、" 0 "君のせいかしら？")
                         (wait)
                         (set-arr~ @ 13 15 322 64 391)
                         (color 8)
                         (clear)
