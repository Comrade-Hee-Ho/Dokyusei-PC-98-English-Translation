(mes
 ...
 (dict #\・ #\【 #\】 #\か #\。 #\い #\っ #\な #\り #\て #\お #\、 #\だ #\ん
  #\あ #\う #\と #\よ #\に #\さ #\の #\る #\く #\が #\た #\し #\は #\行 #\ら
  #\？ #\そ #\こ #\を #\（ #\） #\君 #\や #\ま #\ゃ #\じ #\店 #\ひ #\ち #\ね
  #\ろ #\も #\ぜ #\ー #\デ #\わ #\え #\私 #\れ #\け #\で #\事)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 (set-arr~ @ 7 0)
         ...
         (cond ((== V 0)
                (<>
                 ...
                 (cond ((&& (== N 1) (== (: 50) 0))
                       ...
                       ((== N 3)
                        (<>
                         (text #:color 7 "【" 0 "】そうだな・・・もう少しここにいようぜ。")
                         (wait)))
                       (else (<>)))))
               ((&& (== V 2) (== N 1) (== (: 10) 0))
                (<>
               ...
               ((&& (== V 1) (== N 2))
                (<>
                 (text #:color 7 "【" 0 "】（うーん、さすがウォタービジネスだ・・・紫色に染まってるぜ。）")
                 (wait)))
               ((&& (== V 1) (== N 3))
                (<>
                 (text #:color 7 "【" 0 "】（明るい所で会うと・・・化粧がちょっとハデハデだぜ。）")
                 (wait)))
               ((&& (== V 1) (== N 4))
                (<>
                 (text #:color 7 "【" 0 "】（キスマークはついてないけど・・・処女じゃない事は確実だ。）")
                 (wait)))
               ((&& (== V 1) (== N 5))
                (<>
                 (text #:color 7 "【" 0 "】（見たところ・・・８３センチって感じかな？）")
                 (wait)))
               ((&& (== V 1) (== N 6))
                (<>
                 (text #:color 7 "【" 0 "】（さすがって感じのガラだ・・・ひっひっひっ。）")
                 (wait)))
               ((&& (== V 1) (== N 7))
                (<>
                 (text #:color 7 "【" 0 "】（かおりさんって・・・化粧美人って事はないだろうな？）")
                 (wait)))
               (else (<>)))))
 (set-arr~ @ 7 1))