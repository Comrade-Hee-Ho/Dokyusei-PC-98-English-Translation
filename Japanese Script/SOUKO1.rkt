(mes
 ...
 (dict #\・ #\【 #\】 #\い #\。 #\な #\の #\真 #\子 #\、 #\う #\て #\か #\だ
  #\こ #\が #\れ #\先 #\生 #\に #\た #\ん #\は #\ら #\と #\わ #\を #\も #\く
  #\る #\あ #\で #\っ #\よ #\？ #\し #\り #\俺 #\け #\さ #\出 #\入 #\君 #\ち
  #\愛 #\受 #\時 #\ー #\倉 #\庫 #\つ #\一 #\ね #\（ #\） #\じ #\ゃ #\ょ #\事
  #\世 #\界)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
         ...
         (cond ((== V 0)
                (<>
                 ...
                 (cond ((== N 1)
                       ...
                       ((== N 2)
                        (<>
                         (text #:color 7 "【" 0 "】こんなカビ臭い部屋で寝るつもりはないぜ・・・。")
                         (wait)))
                       ((== N 3)
                        (<>
                         (text #:color 3 "【真子】" 0 "君、この部屋は使われてないわ・・・カビ臭いだけよ。")
                         (wait)))
                       (else (<>)))))
               ((&& (== V 2) (== N 29) (== (: 10) 0))
                (<>
