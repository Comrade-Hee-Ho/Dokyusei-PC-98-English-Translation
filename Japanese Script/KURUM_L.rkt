(mes
 ...
 (dict #\・ #\【 #\】 #\。 #\く #\る #\い #\み #\ん #\、 #\て #\な #\の #\た
  #\っ #\さ #\し #\ど #\だ #\き #\ゃ #\は #\ち #\う #\あ #\と #\で #\に #\ら
  #\事 #\そ #\私 #\け #\か #\が #\も #\？ #\れ #\言 #\好 #\嫌 #\わ #\ぁ #\ね
  #\つ #\合 #\ひ #\よ #\人 #\ま #\一 #\友 #\達 #\女)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
                   ...
                   (cond ((< (: 112) 3)
                         ...
                         ((< (: 112) 6)
                          (<>
                           ...
                           (text #:color 7 "【" 0 "】あ・・・。")
                           (wait)
                           (text #:color 6 "【くるみ】明日から学校だけど、この事は誰にも言わないから・・・いやだもの、" 0 "さんから告白されただなんて。")
                           (wait)
                           (text #:color 7 "【" 0 "】ひ、ひどい・・・ひどすぎる。")
                           (wait)
                           (set-reg: 828 1)
                         ...
                         ((< (: 112) 13)
                          (<>
                           ...
                           (wait)
                           (text #:color 6 "【くるみ】私ね、色々と考えたけど・・・" 0 "さんとつき合ったら、ずっと心配してないといけないなって。")
                           (wait)
                           ...
                           (if-else (== (: 734) 1)
                                    (<>
                                     (text #:color 6 "【くるみ】それに私・・・一哉君とつき合い始めたし。")
                                     (wait))
                                    (<>))
                           (text #:color 7 "【" 0 "】・・・。")
                           (wait)
                          ...
                          (<>
                           ...
                           (if-else (== (: 734) 1)
                                    (<>
                                     ...
                                     (wait))
                                    (<>))
                           (text #:color 6 "【くるみ】私、自分で知ってたの・・・一哉君の友達としてじゃなくて、好きな人として" 0 "さんを見てた。")
                           (wait)
