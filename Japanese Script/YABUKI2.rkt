(mes
 ...
 (dict #\・ #\【 #\】 #\か #\い #\な #\。 #\り #\っ #\お #\あ #\た #\、 #\だ
  #\て #\の #\る #\？ #\は #\し #\う #\ん #\と #\ゃ #\に #\ね #\も #\で #\わ
  #\ら #\よ #\！ #\じ #\を #\が #\ど #\こ #\ン #\ち #\え #\前 #\言 #\さ #\ま
  #\す #\キ #\ク #\私 #\ヤ #\大 #\き #\ラ #\名 #\子 #\く #\や #\ボ #\ウ #\ぜ
  #\そ #\人 #\ー #\れ #\男 #\俺 #\ろ #\ス #\パ #\勉 #\強)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 (set-arr~ @ 7 0)
         ...
         (cond ((== V 0)
                (<>
                 ...
                 (cond ((&& (== N 1) (== (: 50) 0))
                       ...
                       ((== N 3)
                        (<>
                         (text #:color 7 "【" 0 "】そうだぜ、１００年でもずっとここにいたい。")
                         (wait)))
                       (else (<>)))))
               ((&& (== V 1) (== N 2) (== (: 10) 0))
                (<>
               ...
               ((&& (== V 1) (== N 3) (== (: 11) 1))
                (<>
                 (text #:color 7 "【" 0 "】化粧のうまい女性は、大人の女性だぜ。")
                 (wait)))
               ((&& (== V 1) (== N 4) (== (: 12) 0))
                (<>
               ...
               ((&& (== V 2) (== N 1) (== (: 16) 0))
                (<>
                 ...
                 (set-arr~ @ 7 0)
                 (proc 18)
                 (menu-show (<.> (text "ナンパしてる")
                             (text "散歩してる") (text "勉強してる")))
                 (cond ((== N 1)
                        (<>
               ...
               ((&& (== V 2) (== N 1) (== (: 50) 0))
                (<>
                 ...
                 (wait)
                 (text #:color 6 "【かおり】私の知合いなんて、みんなオヂサンだから・・・あなたみたいなボウヤを見ていると、食べたくなっちゃうわ。")
                 (wait)
                 (text #:color 7 "【" 0 "】どきっ！！")
                 (wait)
                 (text #:color 6 "【かおり】って、赤くなるところがかわいいのよねえ・・・オヂサン達にこんな事を言ったら、すぐにホテルの予約に走っちゃうわよ。")
                 (wait)
                 (set-reg: 50 1)))
               ((&& (== V 2) (== N 1) (== (: 50) 1))
                (<>
