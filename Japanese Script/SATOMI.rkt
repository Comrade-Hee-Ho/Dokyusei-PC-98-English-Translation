(mes
 ...
 (dict #\・ #\【 #\】 #\の #\は #\、 #\い #\な #\と #\さ #\み #\。 #\た #\ン
  #\！ #\ら #\ん #\？ #\う #\て #\か #\し #\だ #\っ #\ま #\あ #\君 #\ー #\こ
  #\も #\る #\ど #\ピ #\ポ #\に #\じ #\ゃ #\何 #\く)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
        ...
        (<>
         ...
         (cond ((&& (== V 155) (== (: 431) 1) (== (: 436) 0))
                (<>
                 ...
                 (color 8)
                 (clear)
                 (text #:color 6 "【さとみ】私だって、普通の女の子なんだから・・・" 0 "は昔からの私を知ってるから、私が全然変わってないと思ってるんでしょ？")
                 (wait)
                 (set-arr~ @ 13 15 322 64 391)
                 (color 8)
                 (clear)
               ...
               ((&& (== V 155) (== (: 210) 0))
                (<>
                 ...
                 (cond ((&& (> T 600) (< T 800))
                        (<>
                         (text "あら、" 0 "君じゃない・・・こんなに朝早く、どうしたの？")))
                       ((&& (> T 2000) (< T 2359))
                        (<>
                         (text "あら、" 0 "君じゃない・・・こんなに夜遅く、どうしたの？")))
                       ((== T T)
                        (<>
                         (text "あら、" 0 "君じゃない・・・何か用かしら？")))
                       (else (<>)))
                 (wait)
                 (set-arr~ @ 13 15 322 64 391)
                 (color 8)
