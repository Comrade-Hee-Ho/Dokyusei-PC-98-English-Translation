(mes
 ...
 (dict #\u3000 #\・ #\ル #\の #\ト #\る #\い #\。 #\、 #\て #\っ #\ラ #\を #\だ
  #\に #\か #\フ #\グ #\０ #\は #\な #\く #\れ #\ら #\ん #\俺 #\め #\し #\う
  #\こ #\と #\よ #\で #\『 #\』 #\ー #\前 #\き #\そ #\ま #\み #\り #\わ #\が
  #\ゃ #\チ #\生 #\！)
 (set-arr~ @ 7 0)
 (set-var Z 0)
 (set-arr~ @ 5 Z)
 ...
 (set-arr~ @ 7 0)
 (proc 18)
 (menu-show (<.> (text "デスクトップ") (text "９８ＮＯＴＥ")
             (text "ハードディスク")))
 (if-else (== N 2)
          (<> (set-arr~ @ 9 (// (~ @ 9) 64)))
          (<> (set-arr~ @ 9 (&& (~ @ 9) 65471))))
 ...
 (if-else (== N 1)
          ...
          (<>
           ...
           (set-arr~ @ 7 0)
           (proc 18)
           (menu-show (<.> (text "フラグ００") (text "フラグ０１")
                       (text "フラグ０２") (text "フラグ０３")
                       (text "フラグ０４") (text "フラグ０５")
                       (text "フラグ０６") (text "フラグ０７")
                       (text "フラグ０８") (text "フラグ０９")
                       (text "やめる")))
           (set-arr~ @ 7 0)
           (set-var A (~ @ 99))
           (set-var I 32768)
 ...
 (define-proc 30
  (<>
   ...
   (if-else (== P C)
            (<>
             (box-inv (+ M 18 (* (- P 1) 2)) (+ (* (+ N 12) 16) 14)
              (+ M 19 (* (- P 1) 2)) (+ (* (+ N 12) 16) 15)))
            (<>
             (box-inv (+ M 18 (* P 2)) (+ (* (+ N 12) 16) 14) (+ M 19 (* P 2))
              (+ (* (+ N 12) 16) 15))))
   (if-else (!= Y 8)
            (<>
             (box-inv (+ M 2 (* X 2)) (* (+ N 3 Y) 16) (+ M 3 (* X 2))
              (+ (* (+ N 3 Y) 16) 15)))
            (<>
             (box-inv (+ M 38 (* X 12)) (* (+ N 12) 16) (+ M 38 (* X 12) 9)
              (+ (* (+ N 12) 16) 15))))
   (color 23)
   (mouse 0)))
 (define-proc 31
 ...
 (text #:color 7 "・・・。")
 (wait)
 (text #:color 7 "今年の夏は、学生生活最後の夏休みだからな・・・俺は夏休みの前半をアルバイトに費やし、女の子達と『でいと』する為の資金をきっちり貯めさせてもらった。")
 (wait)
 (text #:color 7 "そう、これからが俺にとって本当の夏休みだ・・・学生生活最後の甘酸っぱい思い出をつくる為に、俺は時間を無駄にする事はできない。")
 (wait)
