(mes
 ...
 (dict #\・ #\い #\ん #\【 #\】 #\な #\よ #\。 #\や #\だ #\っ #\て #\の #\に
  #\、 #\か #\う #\で #\ら #\さ #\る #\も #\た #\す #\し #\は #\こ #\ま #\事
  #\（ #\） #\と #\を #\人 #\私 #\？ #\あ #\く #\！ #\が #\り #\け #\大 #\看
  #\護 #\婦)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 ...
 (while (== 1 1)
        (<>
         ...
         (cond ((== V 0)
               ...
               ((&& (== V 1) (== N 2))
                (<>
                 (text #:color 7 "【" 0 "】（美人だぜ・・・そう思うだろ？）")
                 (wait)))
               ((&& (== V 1) (== N 3))
                (<>
                 (text #:color 7 "【" 0 "】（夜風にフワフワとなびいてる・・・。）")
                 (wait)))
               ((&& (== V 1) (== N 4))
                (<>
                 (text #:color 7 "【" 0 "】（うーん・・・首筋にキスしたい。）")
                 (wait)))
               ((&& (== V 1) (== N 5))
                (<>
