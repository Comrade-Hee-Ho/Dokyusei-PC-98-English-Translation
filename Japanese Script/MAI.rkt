(mes
 ...
 (dict #\・ #\な #\！ #\い #\【 #\】 #\っ #\、 #\の #\ん #\家 #\た #\だ #\し
  #\と #\政 #\婦 #\あ #\は #\ま #\て #\う #\ン #\。 #\？ #\お #\こ #\に #\で
  #\舞 #\か #\ー #\ゃ #\を #\る #\様 #\り #\じ #\嬢 #\ち #\ね #\わ #\き #\よ
  #\さ #\出 #\れ #\す #\ピ #\ポ #\ょ #\バ)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
         ...
         (cond ((&& (== V 109) (> T 0) (< T 600))
               ...
               ((&& (== V 109) (== (: 160) 0))
                (<>
                 ...
                 (color 8)
                 (clear)
                 (text #:color 7 "【" 0 "】今の時代に『押売り』なんているのか？・・・もしいたら、ヤンバルクイナと同じくらい貴重な存在だぜ。")
                 (wait)
                 (set-arr~ @ 13 28 48 65 127)
                 (color 8)
                 (clear)
               ...
               ((&& (== V 109) (== (: 160) 1) (== (: 161) 0))
                (<>
                 ...
                 (color 8)
                 (clear)
                 (text #:color 3 "【家政婦】舞お嬢様は、ただいま勉強中です・・・お友達でも取り次ぐわけにはいきません。特にあなたのようなナマイキなガキとはね、フン！！")
                 (wait)
                 (set-reg: 161 1)
                 (break)))
               ((&& (== V 109) (== (: 161) 1) (== (: 762) 0))
