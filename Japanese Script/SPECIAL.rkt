(mes
 ...
 (dict #\・ #\【 #\】 #\っ #\い #\。 #\、 #\な #\の #\ん #\か #\だ #\！ #\て
  #\あ #\は #\う #\し #\る #\ら #\こ #\た #\と #\も #\？ #\に #\ま #\よ #\ち
  #\が #\で #\ゃ #\れ #\（ #\） #\お #\さ #\生 #\く #\り #\わ #\ン #\す #\長
  #\え #\ル #\ー #\画 #\家 #\き #\私 #\を #\や #\デ #\モ #\キ #\ほ #\そ #\子
  #\じ #\ど #\コ #\け #\バ #\先 #\ぞ #\イ #\社 #\ピ #\女 #\ね #\徒 #\ょ #\リ
  #\オ #\ア #\誰 #\ノ #\つ #\君 #\ろ #\み #\見 #\事 #\受 #\付 #\嬢 #\せ #\ひ
  #\め #\ご #\何 #\入 #\ず #\間 #\ぜ #\部 #\度 #\一 #\ぎ #\大 #\ケ #\学 #\校
  #\聞 #\出 #\義 #\中 #\人 #\恵 #\政 #\げ #\車 #\言 #\最 #\『 #\』 #\ス #\来
  #\声 #\へ #\自 #\乳 #\首 #\俺 #\ぇ #\音 #\楽)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 ...
 (cond ((&& (== V 112) (== (: 799) 0))
       ...
       ((&& (== V 104) (== (: 802) 0) (== (: 801) 1) (== (: 803) 0))
        (<>
         ...
         (wait)
         (text #:color 5 "【画家】ふんっ、私は男は嫌いだからな・・・ちゃんと断ってこの場所を借りておるぞ、はっきり言って君は邪魔だから、どこかに行ってくれたまえ。")
         (wait)
 ...
 (cond ((&& (== V 106) (== (: 808) 0))
        (<>
         ...
         (wait)
         (text #:color 1 "【さとし】平気だよ、うちの学校に『" 0 "』ってやつがいてさ・・・そいつときたら、めちゃくちゃな事をするやつなんだ。")
         (wait)
         (text #:color 7 "【" 0 "】（あのねえ・・・。）")
         (wait)
         (text #:color 6 "【りか】ふーん・・・。")
       ...
       ((&& (== V 106) (== (: 808) 1))
        (<>
         ...
         (wait)
         (text #:color 1 "【さとし】それだけじゃない、あの後に校長室で宴会が始まって・・・机は窓から落とすわ、消火器をブチまけるわで、ひどいもんだったよ。")
         (wait)
 ...
 (cond ((&& (== V 107) (== (: 813) 0))
        (<>
         ...
         (wait)
         (text #:color 6 "【はなこ】まさか私達が・・・ポンプ室を点検に来るたびに、こんな事してるなんて・・・ああっ・・・思わないでしょうね。")
         (wait)
       ...
       ((&& (== V 105) (== (: 815) 0))
        (<>
         ...
         (animate 0 8 1)
         (animate 4 8)
         (text #:color 4 "【ピアノの先生】ま、また間違えおった・・・うーむ『柔道一直線弾き』に『亀甲縛り弾き』をアレンジしたのがいけなかったのだろうか！？")
         (wait)
