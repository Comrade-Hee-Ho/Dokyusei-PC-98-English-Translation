(mes
 ...
 (dict #\・ #\【 #\】 #\い #\、 #\っ #\健 #\二 #\な #\か #\。 #\の #\だ #\ん
  #\は #\く #\う #\に #\て #\が #\る #\し #\！ #\じ #\ゃ #\た #\？ #\を #\で
  #\も #\あ #\僕 #\ど #\ま #\場 #\所 #\こ #\行 #\匂)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 ...
 (if (== (: 443) 0)
     (<>
      ...
      (wait)
      (text #:color 4 "【健二】たまには学校でのデートもいいものだな、普段勉強している場所で・・・おっと、ここから先の話は" 0 "には毒だな。")
      (wait)
 ...
 (while (== 1 1)
        (<>
         ...
         (cond ((== V 0)
               ...
               ((&& (== V 2) (== N 1) (== (: 10) 2))
                (<>
                 (text #:color 4 "【健二】せっかくの気分が台無しだ・・・" 0 "、他の場所に行ってくれ。")
                 (wait)))
               ((&& (== V 1) (== N 2))
                (<>
