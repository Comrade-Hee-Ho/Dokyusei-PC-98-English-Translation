(mes
 ...
 (dict #\・ #\【 #\】 #\な #\。 #\い #\美 #\沙 #\か #\っ #\ん #\、 #\て #\だ
  #\の #\う #\も #\た #\に #\よ #\は #\あ #\ら #\る #\？ #\さ #\を #\そ #\や
  #\と #\が #\ゃ #\し #\ぜ #\陸 #\上 #\で #\ち #\ま #\く #\こ #\行 #\め #\ど)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 (set-arr~ @ 7 0)
               ...
               ((&& (== V 2) (== N 7) (== (: 10) 1))
                (<>
                 ...
                 (cond ((== N 1)
                       ...
                       ((== N 2)
                        (<>
                         (text #:color 7 "【" 0 "】そりゃあ、若い肉体が残るさ・・・今までは運動で性欲を発散させてたからいいけど、陸上をやめたらそうはいかないぜ。")
                         (wait)))
                       ((== N 3)
                        (<>
