(mes
 ...
 (dict #\・ #\【 #\】 #\い #\、 #\。 #\な #\子 #\に #\の #\て #\真 #\ん #\っ
  #\か #\は #\ら #\が #\る #\た #\う #\あ #\水 #\し #\と #\わ #\だ #\よ #\こ
  #\生 #\を #\君 #\先 #\着 #\ち #\ゃ #\つ #\？ #\じ #\も #\ま #\見 #\く #\そ
  #\ど #\き #\ね #\り #\泳 #\さ #\で #\れ #\え #\ー #\け #\舞 #\ル #\私 #\せ
  #\気 #\戻 #\姿 #\好)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
         ...
         (cond ((== V 0)
                (<>
                 ...
                 (cond ((== N 1)
                       ...
                       ((== N 2)
                        (<>
                         (text #:color 3 "【真子】" 0 "君、プールに入る時は水着に着替えてね。")
                         (wait)))
                       ((== N 3)
                        (<>
               ...
               ((&& (== V 2) (== N 29) (== (: 10) 2))
                (<>
                 ...
                 (wait)
                 (text #:color 7 "【" 0 "】先生の姿を見たあとで、水泳部の女を見ても・・・マツタケを食べたあとに、毒キノコを食べるようなものだからな。")
                 (wait)
               ...
               ((&& (== V 1) (== N 24))
                (<>
                 ...
                 (cond ((== (: 604) 1)
                       ...
                       ((== (: 604) 0)
                        (<>
                         (text #:color 3 "【真子】" 0 "君、先生は学校に泳ぎに来てるんじゃありません。")
                         (wait)))
                       (else (<>)))))
               ((&& (== V 1) (== N 25))
                (<>
