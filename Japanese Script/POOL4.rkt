(mes
 ...
 (dict #\・ #\な #\【 #\】 #\い #\だ #\る #\。 #\の #\、 #\太 #\て #\郎 #\に
  #\れ #\か #\う #\は #\を #\と #\ん #\し #\が #\？ #\た #\ら #\っ #\ー #\あ
  #\く #\も #\事 #\で #\そ #\プ #\ル #\ゃ #\ど #\タ #\泳 #\水 #\女 #\よ #\じ
  #\僕 #\来 #\す #\性 #\何 #\ば #\マ #\ロ #\ウ #\ろ #\こ #\忘)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 (set-arr~ @ 7 0)
         ...
         (cond ((== V 0)
               ...
               ((&& (== V 2) (== N 7) (== (: 18) 0))
                (<>
                 ...
                 (wait)
                 (text #:color 5 "【太郎】ちょっとニュアンスが違うな・・・ようするに、あの女性の事を忘れる為には何かをしなくてはいけないと言う事だ。")
                 (wait)
