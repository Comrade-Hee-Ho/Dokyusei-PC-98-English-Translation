(mes
 ...
 (dict #\・ #\【 #\】 #\な #\だ #\健 #\二 #\。 #\い #\ん #\、 #\の #\が #\っ
  #\る #\は #\に #\！ #\？ #\か #\う #\て #\た #\で #\僕 #\あ #\を #\そ #\お
  #\舞 #\し #\と #\ら #\ゃ #\よ #\も #\ぜ #\け #\一 #\や #\じ #\ま #\ッ #\ト
  #\性 #\ち #\ー #\つ)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
         ...
         (cond ((== V 0)
                (<>
                 ...
                 (cond ((== N 1)
                       ...
                       ((== N 3)
                        (<>
                         (text #:color 4 "【健二】なんだ・・・まだ僕に用があるのか？")
                         (wait)))
                       (else (<>)))))
               ((&& (== V 2) (== N 1) (== (: 10) 0))
                (<>
               ...
               ((&& (== V 1) (== N 6))
                (<>
                 (text #:color 7 "【" 0 "】（なんでこんなやつが、舞ちゃんの幼馴染みなんだ！？）")
                 (wait)))
               (else (<>)))))
 (set-arr~ @ 7 1))