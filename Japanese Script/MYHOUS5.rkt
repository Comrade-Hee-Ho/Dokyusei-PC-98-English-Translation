(mes
 ...
 (dict #\・ #\【 #\】 #\な #\い #\う #\。 #\だ #\、 #\ん #\よ #\て #\冬 #\彦
  #\っ #\か #\る #\の #\に #\ろ #\は #\し #\を #\ゃ #\ち #\ら #\み #\が #\？
  #\ひ #\た #\事 #\く #\あ #\ぞ #\と #\も #\れ #\！ #\僕 #\そ #\君 #\す #\や
  #\け #\ま #\ど #\で #\言 #\わ #\き #\じ #\え #\お #\こ #\つ #\ッ #\む #\め
  #\手 #\へ #\俺 #\前 #\逃 #\げ #\カ #\り #\話 #\嫌 #\ぜ #\彼)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 (set-arr~ @ 7 0)
 ...
 (while (== 1 1)
        (<>
         ...
         (cond ((== V 0)
               ...
               ((&& (== V 1) (== N 6) (== (: 15) 1))
                (<>
                 (text #:color 7 "【" 0 "】（うーん、見るからに危ないやつだぜ・・・。）")
                 (wait)))
               ((&& (== V 2) (== N 1) (== (: 16) 0))
                (<>
               ...
               ((&& (== V 2) (== N 1) (== (: 16) 2))
                (<>
                 (text #:color 7 "【" 0 "】いい事を教えてやろう・・・もしお前の言う通りだとしても、ひろみちゃんを俺様が奪った・・・それだけの事だぜ。")
                 (wait)
                 ...
                 (cond ((== N 1)
                       ...
                       ((== N 2)
                        (<>
                         ...
                         (wait)
                         (text #:color 4 "【冬彦】君がそんな事を言うなら、僕にだって考えがあるぞう・・・君がひろみの事を嫌いと言ったと、嘘をついちゃうぞう。")
                         (wait)
