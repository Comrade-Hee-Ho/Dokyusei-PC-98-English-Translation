(mes
 ...
 (dict #\・ #\な #\い #\【 #\】 #\。 #\て #\う #\子 #\の #\か #\真 #\る #\、
  #\ん #\っ #\だ #\ら #\し #\が #\は #\わ #\た #\？ #\も #\に #\で #\ど #\き
  #\（ #\） #\あ #\よ #\く #\生 #\け #\と #\ね #\ス #\を #\れ #\ー #\好 #\事
  #\先 #\そ #\ゃ #\君 #\人 #\え #\女 #\じ #\こ #\ま #\ち #\思 #\ふ #\さ #\言
  #\す #\つ #\キ #\考 #\気 #\み #\俺 #\恋 #\愛 #\ッ #\大 #\嫌 #\ク #\彼 #\ル
  #\何 #\ろ #\や #\め #\セ #\り #\見 #\ぜ #\ょ #\欲 #\徒 #\ン #\持 #\ト #\中
  #\男 #\関 #\係 #\性)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
        ...
        (<>
         ...
         (cond ((== V 0)
                (<>
                 ...
                 (cond ((&& (== N 1) (== (: 50) 0))
                        (<>
                         (text #:color 7 "【" 0 "】（まだここにいたいなあ・・・みんな、そう思うだろ？）")
                         (wait)))
                       ((&& (== N 1) (== (: 50) 1))
                        (<>
                       ...
                       ((&& (== N 2) (== (: 50) 0))
                        (<>
                         (text #:color 7 "【" 0 "】（うんうん・・・まだここにいよう。）")
                         (wait)))
                       ((&& (== N 2) (== (: 50) 1))
                        (<>
                         (text #:color 7 "【" 0 "】（ちょっといずらくなってきたな・・・。）")
                         (wait)))
                       (else (<>)))))
               ((&& (== V 2) (== N 1) (== (: 10) 0))
                (<>
               ...
               ((&& (== V 2) (== N 1) (== (: 10) 1))
                (<>
                 ...
                 (set-arr~ @ 7 0)
                 (proc 18)
                 (menu-show (<.> (text "本能だから")
                             (text "セックスしたい")
                             (text "寂しいから") (text "わからない")))
                 (cond ((== N 1)
                        (<>
               ...
               ((&& (== V 2) (== N 1) (== (: 10) 2))
                (<>
                 ...
                 (wait)
                 (text #:color 3 "【真子】先生は、何も変わってないと思う・・・自分よりも、人の言う事の方を信じてしまうから、わからなくなっているだけだと思うわね。")
                 (wait)
                ...
                (<>
                 ...
                 (cond ((== N 1)
                        (<>
                         ...
                         (text #:color 7 "【" 0 "】うん・・・。")
                         (wait)
                         (text #:color 3 "【真子】" 0 "君・・・私の妹だから言うわけじゃないけど、嫌いな女の子にキスするなんて最低よ、キスされた彼女の気持ちを考えた？")
                         (wait)
                       ...
                       ((== N 2)
                        (<>
                         ...
                         (wait)
                         (text #:color 3 "【真子】" 0 "君、いい事を教えてあげるわね・・・欲望のおもむくまま、好きな女の子全てにキスやセックスをしたら、どうなると思う？")
                         (wait)
                       ...
                       ((== N 3)
                        (<>
                         ...
                         (text #:color 7 "【" 0 "】うん・・・。")
                         (wait)
                         (text #:color 3 "【真子】" 0 "君・・・私の妹だから言うわけじゃないけど、好きでもない女の子にキスするなんてよくないわね、キスされた彼女の気持ちを考えた？")
                         (wait)
                         (text #:color 7 "【" 0 "】（ああ・・・俺は何て事を言ってしまったんだあ！！）")
                         (wait)
               ...
               ((&& (== V 2) (== N 1) (== (: 10) 4))
                (<>
                 ...
                 (text #:color 7 "【" 0 "】・・・。")
                 (wait)
                 (text #:color 3 "【真子】みんな色々と悩んでいるのよ・・・恋愛のルールを勉強してる最中だから、悩まなくていい事でも悩んでしまうの。")
                 (wait)
               ...
               ((&& (== V 2) (== N 1) (== (: 10) 9))
                (<>
                 ...
                 (wait)
                 (text #:color 3 "【真子】キスした事はもういいけど、彼女に思わせぶりな態度をとるのはよくないわ・・・つき合う気がないのなら、彼女に誤解される行動は禁物よ。")
                 (wait)
                 (set-reg: 10 10)))
               ((&& (== V 2) (== N 1) (== (: 10) 10))
                (<>
               ...
               ((&& (== V 1) (== N 3) (== (: 12) 0))
                (<>
                 (text #:color 7 "【" 0 "】（髪の毛が風で揺れてる・・・。）")
                 (wait)
                 (set-reg: 12 1)))
               ((&& (== V 1) (== N 3) (== (: 12) 1))
                (<>
                 (text #:color 7 "【" 0 "】（奇麗な髪だ・・・一本くれないかな？）")
                 (wait)))
               ((&& (== V 1) (== N 4) (== (: 13) 0))
                (<>
               ...
               ((&& (== V 1) (== N 5) (== (: 14) 0))
                (<>
                 (text #:color 7 "【" 0 "】（赤いネクタイだ・・・。）")
                 (wait)
                 (set-reg: 14 1)))
               ((&& (== V 1) (== N 5) (== (: 14) 1))
                (<>
                 (text #:color 7 "【" 0 "】（だから赤いネクタイだって・・・。）")
                 (wait)))
               ((&& (== V 1) (== N 6) (== (: 15) 0))
                (<>
               ...
               ((&& (== V 1) (== N 6) (== (: 15) 1))
                (<>
                 (text #:color 7 "【" 0 "】（うーん・・・モスグリーンのスカートだぜ。）")
                 (wait)))
               ((&& (== V 1) (== N 7) (== (: 16) 0))
                (<>
               ...
               ((&& (== V 1) (== N 7) (== (: 16) 1))
                (<>
                 (text #:color 7 "【" 0 "】（真子先生の脚だ・・・スタイルもいいよな。）")
                 (wait)))
               ((&& (== V 1) (== N 8) (== (: 17) 0))
                (<>
               ...
               ((&& (== V 1) (== N 9) (== (: 18) 1))
                (<>
                 (text #:color 7 "【" 0 "】（この金網がなけりゃ、色々といたずらができるのにな・・・。）")
                 (wait)))
               ((&& (== V 1) (== N 10) (== (: 19) 0))
                (<>
               ...
               ((&& (== V 1) (== N 10) (== (: 19) 1))
                (<>
                 (text #:color 7 "【" 0 "】（ここは屋上だ・・・考え事をする時はこの場所に限るな。）")
                 (wait)))
               ((&& (== V 1) (== N 11) (== (: 20) 0))
                (<>
               ...
               ((&& (== V 1) (== N 11) (== (: 20) 1))
                (<>
                 (text #:color 7 "【" 0 "】（風がちょっとあるが、いい天気だ・・・気持ちがいい。）")
                 (wait)))
               (else (<>)))))
 (set-arr~ @ 7 1))