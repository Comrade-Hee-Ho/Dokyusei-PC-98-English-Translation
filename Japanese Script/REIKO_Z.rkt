(mes
 ...
 (dict #\・ #\ん #\た #\【 #\】 #\。 #\の #\し #\に #\な #\て #\、 #\を #\い
  #\っ #\だ #\は #\で #\が #\う #\麗 #\る #\あ #\俺 #\子 #\ま #\さ #\か #\彼
  #\女 #\れ #\そ #\ら #\と #\上 #\乗 #\く)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
                  ...
                  (<>
                   ...
                   (if-else (== (: 555) 1)
                            (<>
                             ...
                             (proc 24)
                             (set-arr~ @ 7 0)
                             (text #:color 7 "【" 0 "】彼女は台の上に乗って、靴を取ろうとした・・・そして俺は、彼女に頼まれるままに一緒に台の上に乗ったんだ。")
                             (wait)
                             (set-arr~ @ 7 1)
                             (set-arr~ @ 1 4096)
                             (set-arr~ @ 9 (&& (~ @ 9) 65534))
                             ...
                             (text #:color 7 "【" 0 "】・・・。")
                             (wait)
                             (text #:color 7 "【" 0 "】あの寂しそうな目を見ていたら・・・どんな男でも、麗子さんを抱きしめたくなってしまうだろう。")
                             (wait)
                             ...
                             (animate 1 0)
                             (set-arr~ @ 7 0)
                             (text #:color 7 "【" 0 "】たぶん、俺の上に彼女が乗ったまま落ちたんだろうな・・・俺は一瞬意識を失い、気がついたら麗子さんが上に乗ってたんだ。")
                             (wait)
                             (text #:color 7 "【" 0 "】・・・。")
                             (wait)
                             ...
                             (wait)
                             (text #:color 7 "【" 0 "】彼女は俺の上に乗り、腰を激しく動かした・・・あの麗子さんがあんなに乱れるなんて、今でも信じられないぜ。")
                             (wait)
