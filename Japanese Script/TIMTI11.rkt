(mes
 ...
 (dict #\・ #\【 #\】 #\。 #\美 #\穂 #\い #\の #\が #\ん #\あ #\は #\に #\だ
  #\な #\っ #\る #\、 #\ゃ #\て #\服 #\ち #\俺 #\（ #\） #\君 #\れ #\か #\ー
  #\う #\え #\き #\で #\ば #\と #\一 #\好 #\も)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
         ...
         (cond ((== V 0)
               ...
               ((&& (== V 2) (== N 1) (== (: 10) 1))
                (<>
                 ...
                 (set-arr~ @ 7 0)
                 (proc 18)
                 (menu-show (<.> (text "セーラー服")
                             (text "看護婦の制服") (text "裸がいい")
                             (text "何でもいい")))
                 (cond ((== N 1)
                        (<>
               ...
               ((&& (== V 1) (== N 2))
                (<>
                 (text #:color 7 "【" 0 "】（リボンだぜ・・・誰が何と言おうがリボンだ。）")
                 (wait)))
               ((&& (== V 1) (== N 3))
                (<>
               ...
               ((&& (== V 1) (== N 4))
                (<>
                 (text #:color 7 "【" 0 "】（彼女が俺を見る視線は・・・ちょっと恐い。）")
                 (wait)))
               ((&& (== V 1) (== N 5))
                (<>
                 (text #:color 7 "【" 0 "】（ああ・・・あの感触がよみがえってくるぜ。）")
                 (wait)))
               ((&& (== V 1) (== N 6))
                (<>
                 (text #:color 7 "【" 0 "】（美穂ちゃんは俺にしがみついてきたんだ・・・ひっひっひっ。）")
                 (wait)))
               ((&& (== V 1) (== N 7))
                (<>
