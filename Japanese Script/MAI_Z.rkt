(mes
 ...
 (dict #\・ #\【 #\】 #\。 #\い #\ん #\た #\の #\な #\て #\っ #\、 #\だ #\し
  #\ち #\う #\ゃ #\に #\舞 #\を #\が #\は #\ま #\あ #\か #\そ #\で #\と #\よ
  #\女 #\俺 #\き #\れ #\！ #\く #\る #\つ #\も #\彼 #\時 #\ら #\ぜ #\ン #\ど
  #\ー #\け #\一 #\わ #\事 #\二 #\見 #\ふ #\す #\り #\健 #\こ #\着 #\キ #\ぞ
  #\顔 #\せ #\ろ #\目 #\や #\子 #\姿 #\ス #\思 #\じ #\気 #\忘 #\？ #\げ #\言)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 (set-arr~ @ 7 0)
                ...
                (<>
                 ...
                 (cond ((== (: 765) 0)
                        (<>
                         ...
                         (wait)
                         (text #:color 7 "【" 0 "】問題は健二だぜ・・・舞ちゃんと健二が、幼馴染みというだけで仲がいいなんて・・・ああ、俺はなんて不幸なんだ！！")
                         (wait)
                         (text #:color 7 "【" 0 "】くっそー・・・あんな成金ボンボン野郎に、舞ちゃんを奪われてたまるか！！")
                         (wait)))
                       ((== (: 765) 1)
                        (<>
                         (text #:color 7 "【" 0 "】そのかわいい舞ちゃんが・・・なんで健二なんかと。")
                         (wait)))
                       (else (<>)))
                 (if-else (== (: 305) 1)
                          (<>
                           ...
                           (animate 1 0)
                           (set-arr~ @ 7 0)
                           (text #:color 7 "【" 0 "】あんな水着姿のかわいい舞ちゃんと・・・健二が幼馴染みだなんて、世の中は間違ってるぜ、まったく。")
                           (wait)
                           (text #:color 7 "【" 0 "】・・・。")
                           (wait)
                 ...
                 (if-else (== (: 760) 1)
                          (<>
                           ...
                           (animate 0 8 1)
                           (animate 4 8)
                           (text #:color 7 "【" 0 "】なんて事を考えてる場合か？・・・そのふくよかな胸は、健二のものになっちまったんだ、うっうっうっ。")
                           (wait))
                          (<>))
                 (slot 1 2)
                 (set-arr~ @ 7 1)
                 ...
                 (cond ((== (: 745) 0)
                       ...
                       ((== (: 760) 1)
                        (<>
                         (text #:color 7 "【" 0 "】ふう・・・舞ちゃんは、俺の手が届かないところに行ってしまった。")
                         (wait)))
                       (else (<>)))
                 (set-reg: 608 1)
                 (slot 1 2)
