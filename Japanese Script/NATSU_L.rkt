(mes
 ...
 (dict #\・ #\【 #\】 #\。 #\夏 #\子 #\い #\な #\、 #\て #\っ #\君 #\の #\ん
  #\う #\わ #\た #\る #\に #\し #\が #\か #\と #\私 #\も #\ど #\ら #\さ #\よ
  #\く #\は #\言 #\あ #\き #\ね #\だ #\？ #\で #\そ #\事 #\ぁ #\れ #\け #\ひ
  #\気 #\顔 #\俺 #\好 #\思 #\を #\見 #\す #\ち)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
        ...
        (<>
         ...
         (if-else (== N 6)
                  (<>
                   ...
                   (cond ((&& (< (: 109) 6) (== (: 587) 0))
                          (<>
                           (text #:color 2 "【夏子】" 0 "君・・・どうしてここがわかったの？")
                           (wait)))
                         ((&& (< (: 109) 6) (== (: 587) 1))
                          (<>
                           (text #:color 2 "【夏子】" 0 "君、どうしたのよ・・・真面目な顔して。")
                           (wait)))
                         ((&& (> (: 109) 5) (== (: 587) 0))
                          (<>
                           (text #:color 2 "【夏子】" 0 "君・・・よく私の住んでる場所がわかったわね。")
                           (wait)))
                         ((&& (> (: 109) 5) (== (: 587) 1))
                          (<>
                           (text #:color 2 "【夏子】" 0 "君・・・どうしたの？")
                           (wait)))
                         (else (<>)))
                         ...
                         ((< (: 109) 16)
                          (<>
                           ...
                           (cond ((== (: 533) 1)
                                 ...
                                 ((== (: 533) 0)
                                  (<>
                                   (text #:color 2 "【夏子】私、つき合ってる人はいないし・・・" 0 "君だけなのよ。")
                                   (wait)))
                                 (else (<>)))
                           (wait)
                           (text #:color 7 "【" 0 "】夏子さん・・・。")
