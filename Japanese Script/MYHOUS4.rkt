(mes
 ...
 (dict #\・ #\【 #\】 #\い #\っ #\な #\。 #\の #\て #\、 #\舞 #\か #\た #\ん
  #\だ #\し #\は #\う #\？ #\に #\る #\ら #\も #\ゃ #\で #\そ #\あ #\れ #\ち
  #\と #\を #\く #\よ #\こ #\ね #\わ #\事 #\俺 #\り #\ど #\！ #\が #\じ #\ま
  #\何 #\え #\君 #\ろ #\さ #\け #\お #\す #\つ #\言 #\食 #\ト #\ー #\ば #\ン
  #\せ #\き #\（ #\） #\ふ #\思 #\や #\話 #\み #\病 #\院 #\所 #\時 #\行 #\入
  #\ぜ #\目 #\マ #\キ #\べ #\人 #\生 #\私)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 ...
 (if (== (: 308) 0)
     (<>
      ...
      (if (> T 1800)
          (<>
           (text #:color 7 "【" 0 "】こんな時間なのに、これから行くんだ・・・大変だなあ。")
           (wait)))
      (set-reg: 308 1)))
 (while (== 1 1)
        (<>
         ...
         (cond ((== V 0)
               ...
               ((&& (== V 1) (== N 2) (== (: 10) 1))
                (<>
                 (text #:color 7 "【" 0 "】（舞ちゃんの身体についてる物だったら・・・たとえゴミでも欲しいぞ。）")
                 (wait)))
               ((&& (== V 1) (== N 3))
                (<>
               ...
               ((&& (== V 1) (== N 6))
                (<>
                 (text #:color 7 "【" 0 "】あれを引っ張ると・・・胸元がガバッと開くのかな？")
                 (wait)))
               ((&& (== V 1) (== N 7) (== (: 11) 0))
                (<>
               ...
               ((&& (== V 1) (== N 7) (== (: 11) 1))
                (<>
                 (text #:color 7 "【" 0 "】（この胸のふくらみは・・・俺の物だあ！！）")
                 (wait)))
               ((&& (== V 1) (== N 8))
                (<>
               ...
               ((&& (== V 2) (== N 1) (== (: 13) 0))
                (<>
                 ...
                 (set-arr~ @ 7 0)
                 (proc 18)
                 (menu-show (<.> (text "レトルト食品")
                             (text "拾い喰い") (text "何も食べない")))
                 (cond ((== N 1)
                        (<>
                       ...
                       ((== N 3)
                        (<>
                         ...
                         (wait)
                         (text #:color 7 "【" 0 "】この身体が壊れれば・・・きっと舞ちゃんも俺の方を向いてくれるんじゃないかと、うっうっうっ。")
                         (wait)
                 ...
                 (cond ((== N 1)
                       ...
                       ((== N 2)
                        (<>
                         ...
                         (wait)
                         (text #:color 7 "【" 0 "】たとえ一回しか喋った事がないヤツでも・・・そいつが怒った顔をしてるより、ニコニコしてた方が楽しいだろ？")
                         (wait)
                         (text #:color 3 "【舞】うん。")
                         (wait)
