(mes
 ...
 (dict #\・ #\【 #\】 #\。 #\、 #\ん #\た #\っ #\の #\な #\だ #\て #\い #\し
  #\に #\を #\は #\で #\と #\が #\夏 #\う #\る #\子 #\れ #\あ #\さ #\も #\く
  #\そ #\か #\ま #\ー #\女 #\事 #\ち #\俺 #\時 #\よ #\り #\彼 #\け #\き #\え
  #\胸 #\ル #\ら #\前 #\奇 #\麗 #\見 #\ぜ #\ば #\や #\ゃ #\人 #\大 #\忘 #\プ
  #\今 #\ッ #\１ #\行 #\ど #\一 #\哉 #\ひ #\す #\出 #\ン #\ブ #\イ #\ト #\会
  #\つ #\こ #\日 #\合 #\わ #\遊 #\二 #\考 #\美)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
        ...
        (<>
         ...
         (cond ((&& (== N 6) (== (: 544) 0))
                (<>
                 ...
                 (wait)
                 (text #:color 7 "【" 0 "】彼女に会う為には、ブティックに行けばいい・・・でも、それ以上の関係になる為には、いったいどうしたらいいんだ？")
                 (wait)
                 (if-else (== (: 481) 1)
                          (<>
                           (slot 1 2)
                           ...
                           (text #:color 7 "【" 0 "】・・・。")
                           (wait)
                           (text #:color 7 "【" 0 "】それ以前に、一哉のやつがそれ以上の関係になりそうだぜ・・・いやだなあ、俺は一哉と義兄弟になりたくないし。")
                           (wait)
                           (text #:color 7 "【" 0 "】一哉のやつ、うまいことやってるよな・・・くるみちゃんに対して強気なはずだよ、ちゃんと夏子さんがいるんだもんな。")
                           (wait)
                 ...
                 (cond ((&& (== (: 513) 1) (< H 827))
                        (<>
                         ...
                         (wait)
                         (text #:color 7 "【" 0 "】夏子さんとプールに行く約束をしてるんだぜ・・・２７日の午前１０時に、矢吹町駅で待ち合わせだ。")
                         (wait)
                 ...
                 (if-else (&& (== (: 539) 1) (== (: 515) 1))
                          (<>
                           ...
                           (text #:color 7 "【" 0 "】・・・。")
                           (wait)
                           (text #:color 7 "【" 0 "】ああ、夏子さんが女神のように見えたんだ・・・いや、あの時の夏子さんは、本当に夏の女神だったのかもしれない。")
                           (wait)
                           (set-arr~ @ 7 1)
                           (set-arr~ @ 1 4096)
                           (set-arr~ @ 9 (&& (~ @ 9) 65534))
                           ...
                           (wait)
                           (text #:color 7 "【" 0 "】夏子さんが動くたびに、大きな胸が揺れていた・・・ああ、思い出しただけでポコチンが固くなってくる。")
                           (wait)
                           (set-arr~ @ 7 1)
                           (set-arr~ @ 1 4096)
                           (set-arr~ @ 9 (&& (~ @ 9) 65534))
                           ...
                           (text #:color 7 "【" 0 "】・・・。")
                           (wait)
                           (text #:color 7 "【" 0 "】夏子さんに頼まれるままに、背中にオイルを塗ったんだ・・・あの時の手の感触を、今でも忘れる事ができない。")
                           (wait)
                           (text #:color 7 "【" 0 "】夏子さんの事を考えると、胸が熱くなってくる・・・あんなに奇麗な人と知り合えただけでも俺の幸運だ。")
                           (wait)
                           (set-arr~ @ 7 1)
                           (set-arr~ @ 1 4096)
                           (set-arr~ @ 9 (&& (~ @ 9) 65534))
                           ...
                           (wait)
                           (text #:color 7 "【" 0 "】ちょっと欲張りすぎたかな・・・腹の調子が悪くなって、遊園地を出た所で夏子さんとはお別れだ。")
                           (wait)
               ...
               ((&& (== N 6) (== (: 544) 1))
                (<>
                 ...
                 (animate 1 0)
                 (set-arr~ @ 7 0)
                 (text #:color 7 "【" 0 "】しかし、一哉と夏子さんが二人でいた時にはびっくりしたぜ・・・まあ、一哉ごときは俺様の敵ではないが。")
                 (wait)
                 ...
                 (wait)
                 (text #:color 7 "【" 0 "】俺は興奮のあまり、訳がわからなくなって・・・気がついたら胸をあらわにした夏子さんがベットに寝ていた。")
                 (wait)
                 (set-arr~ @ 7 1)
                 (set-arr~ @ 1 4096)
                 (set-arr~ @ 9 (&& (~ @ 9) 65534))
                 ...
                 (wait)
                 (text #:color 7 "【" 0 "】奇麗すぎるほど、奇麗だった・・・プロポーションは日本人離れしているし、肌は奇麗だし、胸は大きいし。")
                 (wait)
                 (set-arr~ @ 7 1)
                 (set-arr~ @ 1 4096)
                 (set-arr~ @ 9 (&& (~ @ 9) 65534))
                 ...
                 (proc 15)
                 (set-arr~ @ 7 0)
                 (text #:color 7 "【" 0 "】俺は夏子さんと愛し合った時の事を、絶対に忘れない・・・彼女の事を考えると、今でも胸と股間がはり割けそうになるんだ。")
                 (wait)
                 (set-reg: 608 1)
                 (slot 1 2)
                 (mes-jump "myroom.mes")))
