(mes
 ...
 (dict #\・ #\【 #\】 #\な #\一 #\い #\。 #\だ #\っ #\哉 #\て #\、 #\う #\ん
  #\る #\く #\か #\あ #\の #\に #\そ #\た #\が #\し #\は #\で #\よ #\れ #\ゃ
  #\？ #\み #\さ #\も #\俺 #\と #\ち #\を #\事 #\ら #\ど #\こ #\や #\じ #\ま
  #\人 #\ぜ #\！ #\き #\元 #\気 #\え #\け #\女)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
         ...
         (cond ((== V 0)
               ...
               ((&& (== V 2) (== N 8) (== (: 10) 0))
                (<>
                 ...
                 (text #:color 5 "【一哉】・・・。")
                 (wait)
                 (text #:color 5 "【一哉】色々考えたんだけどさ・・・何もできなくても、俺にはやっぱりくるみが似合ってるんじゃないかなって、思うようになったんだ。")
                 (wait)
               ...
               ((&& (== V 2) (== N 8) (== (: 11) 0))
                (<>
                 (text #:color 5 "【一哉】俺が別れるって言ってから、一度も電話はかかって来ないし・・・でももう一度会ってくるみと話がしたいんだ。")
                 (wait)
