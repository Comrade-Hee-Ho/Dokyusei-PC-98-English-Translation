(mes
 ...
 (dict #\・ #\【 #\】 #\い #\し #\よ #\。 #\な #\こ #\、 #\て #\の #\で #\っ
  #\に #\か #\は #\ん #\す #\る #\ら #\う #\を #\だ #\た #\が #\ま #\あ #\？
  #\生 #\と #\君 #\も #\先 #\事 #\れ #\く #\り #\ゃ #\さ #\そ #\け #\！ #\ど
  #\せ #\じ #\ち #\来 #\わ #\言 #\き #\ー #\ね #\え #\ン #\つ #\人 #\何 #\校
  #\ッ #\室 #\学 #\ス #\用 #\』 #\や #\職 #\ょ #\め #\入 #\員 #\お #\見 #\へ
  #\女 #\み #\俺 #\取 #\ト #\会 #\考 #\ば #\子 #\私 #\一 #\中 #\イ #\知 #\ク
  #\キ #\分 #\バ #\コ #\『 #\u3000 #\気 #\仕 #\ろ #\大 #\タ #\出 #\時 #\本 #\勉
  #\強 #\性 #\聞 #\変 #\ム #\机 #\教 #\芹 #\沢 #\手 #\今 #\談 #\徒 #\チ #\げ
  #\ル #\目 #\違 #\宿 #\題 #\ウ #\思 #\下 #\日)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 ...
 (cond ((== (: 239) 0)
        (<>
         ...
         (wait)
         (text #:color 7 "【" 0 "】（『芹沢　よしこ』先生・・・男女交際にうるさくて、お堅くて、鉄の処女膜を持っていると噂のある・・・。）")
         (wait)
       ...
       ((&& (== (: 239) 1) (== (: 252) 0))
        (<>
         ...
         (wait)
         (text #:color 6 "【よしこ】" 0 "君、夏休みになると学校が好きになるのね・・・２学期が始まったら、遅刻しないでちゃんと来るのよ。")
         (wait)
         (text #:color 7 "【" 0 "】はいはい。")
         (wait)
       ...
       ((== (: 632) 10)
        (<>
         ...
         (wait)
         (text #:color 6 "【よしこ】忙しくて、寂しがっている暇なんかありません・・・" 0 "君も宿題が忙しくて、職員室に来ている暇などないはずですが？")
         (wait)
        ...
        (<>
         ...
         (cond ((== V 0)
               ...
               ((&& (== V 2) (== N 1) (== (: 239) 0) (== (: 11) 1)
                 (== (: 12) 0) (== (: 252) 0))
                (<>
                 (text #:color 6 "【よしこ】勉強を一生懸命すれば、いい会社に入れます・・・いい会社に入れれば、素敵な女性と知り合う事ができますよ。")
                 (wait)
               ...
               ((&& (== V 2) (== N 1) (== (: 239) 1) (== (: 10) 0)
                ...
                (<>
                 ...
                 (wait)
                 (text #:color 6 "【よしこ】" 0 "君、先生を失望させないで・・・今は考えなくて済んでも、必ず考えなくてはいけない時が来るものなんですよ。")
                 (wait)
               ...
               ((&& (== V 2) (== N 1) (== (: 252) 1) (== (: 10) 0) (== H 817))
                (<>
                 ...
                 (wait)
                 (text #:color 6 "【よしこ】" 0 "君、あなたにとっての学校は仕事場ですよ・・・学生の本分は勉強をする事で、ようするに勉強は学生にとって仕事と同じ事です。")
                 (wait)
                 (set-reg: 10 1)))
               ...
               ((&& (== V 2) (== N 1) (== (: 10) 0))
                (<>
                 ...
                 (if (== S 2)
                     (<>
                      (text #:color 7 "【" 0 "】ははは・・・何だそりゃ。")
                      (wait)))
                 (if (== S 3)
                     (<>
                      (text #:color 7 "【" 0 "】馬鹿じゃないか・・・そいつ。")
                      (wait)))
                 (if (== S 4)
                     (<> (text #:color 7 "【" 0 "】え！？") (wait)))
                 (if (== S 5)
                     (<>
                      (text #:color 7 "【" 0 "】そ、そんな事をしたやつがいるの！？")
                      (wait)))
                 (if (== S 6)
                     (<>
                      (text #:color 7 "【" 0 "】はははっ・・・俺と同じようなやつが、この学校にはいるんだな。")
                      (wait)))
                 (if (== S 7)
                     (<>
                      (text #:color 7 "【" 0 "】知りません・・・全然。")
                      (wait)))
                 (if (== S 8)
                     (<>
                      (text #:color 7 "【" 0 "】よしこ先生、俺のせいにしないでくれよ・・・。")
                      (wait)))
                 (if (== S 9)
                     (<> (text #:color 7 "【" 0 "】へ！？") (wait)))
                 (set-var S (? 3))
                 (if (== S 0)
                     (<>
                      (text #:color 6 "【よしこ】だめよ・・・嘘をついても。")))
                 (if (== S 1)
                     (<>
                      (text #:color 6 "【よしこ】正直に言いなさい・・・。")))
                 (if (== S 2)
                     (<>
                      (text #:color 6 "【よしこ】" 0 "君の目を見ればわかりますよ。")))
                 (wait)
                 ...
                 (if (== S 0)
                     (<>
                      (text "職員会議に裸で乱入して、腹踊りをするような子ですから・・・。")
                      (wait)))
                 (if (== S 1)
                     (<>
                      (text "生徒会の会長を脅して、総会の時に『二人羽織』をさせるような人ですから。")
                      (wait)))
                 (if (== S 2)
                     (<>
                      (text "プールの中に金魚を入れて、生徒からお金を取って金魚すくいをさせるような人ですから。")
                      (wait)))
                 (if (== S 3)
                     (<>
                      (text "消火器を廊下に立てて、バイクでスラロームするような人ですから。")
                      (wait)))
                 (if (== S 4)
                     (<>
                      (text "進路相談に来た生徒のお母さんを、お茶に誘うような人ですから・・・。")
                      (wait)))
                 (if (== S 5)
                     (<>
                      (text "身体に制服の絵を描いて、裸のまま学校に来るような子ですから・・・。")
                      (wait)))
                 (if (== S 6)
                     (<>
                      (text "バレーボール大会の時、ボールの中に鉛をつめて・・・みんなに鼻血を出させるような人ですから。")
                      (wait)))
                 (if (== S 7)
                     (<>
                      (text "他校の生徒とケンカをして、いくら勝ったとはいえ、自分の学校の廊下に立たせるような人ですから・・・。")
                      (wait)))
                 (if (== S 8)
                     (<>
                      (text "新入生に、倉庫を教室だと嘘ついて・・・あんな狭い場所に４０人も押し込むような事をする子ですから。")
                      (wait)))
                 (if (== S 9)
                     (<>
                      (text "校庭でヤキソバ屋を始めるような子ですから・・・。")
                      (wait)))
                 (set-var S (? 6))
                 (if (== S 0)
                     (<>
               ...
               ((&& (== V 1) (== N 2) (== (: 15) 0))
                (<>
                 ...
                 (wait)
                 (text #:color 6 "【よしこ】いい？・・・女の子と知り合う事は、社会に出てからでも十分できるわ・・・でも学校の勉強は今しかできないのよ、わかるわね？")
                 (wait)
                 (set-reg: 15 1)))
               ((&& (== V 1) (== N 2) (== (: 15) 1))
                (<>
                 (text #:color 7 "【" 0 "】アップにしてるからわからないが・・・けっこうロングな髪だと思う。")
                 (wait)))
               ((&& (== V 1) (== N 3) (== (: 239) 0))
                (<>
               ...
               ((&& (== V 1) (== N 4) (== (: 17) 0))
                (<>
                 ...
                 (wait)
                 (text #:color 6 "【よしこ】" 0 "君、若い男の子だから性欲が旺盛なのはわかります・・・でも、そんな事を女性に聞くもんじゃありません。")
                 (wait)
                 (set-reg: 17 1)))
               ((&& (== V 1) (== N 4) (== (: 17) 1))
                (<>
               ...
               ((&& (== V 1) (== N 6) (== (: 19) 1))
                (<>
                 ...
                 (wait)
                 (text #:color 7 "【" 0 "】水商売のスカウトに声をかけられるって事・・・１にアミタイツ、２にガラストッキング、３に黒ストッキングだもんな。")
                 (wait)
               ...
               ((&& (== V 1) (== N 11) (== (: 239) 0))
                (<>
                 (text #:color 7 "【" 0 "】そのペンの太さじゃ、物足りないだろう？・・・ほーら、このペンはどうだい？・・・白いインクしか出ないけど。")
                 (wait)
               ...
               ((&& (== V 1) (== N 12) (== (: 25) 0))
                (<>
                 (text #:color 7 "【" 0 "】先生、これは中に電池が入ってて・・・スイッチを入れると『ウィーン、ウィーン』って音がするもんでしょ？")
                 (wait)
               ...
               ((&& (== V 1) (== N 13) (== (: 239) 0))
                (<>
                 ...
                 (wait)
                 (text #:color 6 "【よしこ】仕事をしていると、雑然としてくるものなんです・・・ちゃんとかたづけてから帰ってますから、余計な心配は無用です。")
                 (wait)
               ...
               ((&& (== V 1) (== N 13) (== (: 26) 0))
                (<>
                 ...
                 (wait)
                 (text #:color 6 "【よしこ】教師はね、生徒に勉強を教えるだけが仕事じゃないの・・・夏休みだって研修とかあるから、ほとんど休みがないのよ。")
                 (wait)
               ...
               ((&& (== V 1) (== N 13) (== (: 26) 1))
                (<>
                 (text #:color 6 "【よしこ】貸して欲しい参考書があったら言いなさい・・・" 0 "君が勉強してくれるのなら、先生は何でも協力するわよ。")
                 (wait)
               ...
               ((&& (== V 1) (== N 17) (== (: 30) 1))
                (<>
                 (text #:color 7 "【" 0 "】ザックリと切り落とされた手首・・・あるいは、ザックリと切り落とされた足首が入ってるんじゃないか？")
                 (wait)
               ...
               ((&& (== V 1) (== N 21) (== (: 33) 1))
                (<>
                 (text #:color 7 "【" 0 "】黒いストッキングだ・・・そばで見ると迫力だなあ。")
                 (wait)))
               (else (<>)))))
 (set-arr~ @ 7 1))