(mes
 ...
 (dict #\・ #\っ #\い #\な #\ん #\お #\、 #\の #\て #\【 #\】 #\だ #\さ #\事
  #\場 #\工 #\現 #\。 #\は #\か #\る #\し #\こ #\が #\う #\く #\に #\た #\０
  #\よ #\れ #\？ #\や #\ら #\と #\ち #\ぜ #\も #\そ #\ゃ #\時 #\間 #\を #\で
  #\わ #\ま #\手 #\前 #\働 #\言 #\人 #\若 #\え #\じ #\ど #\今 #\ト #\疲 #\つ
  #\イ #\日 #\１ #\円 #\体 #\き #\見 #\ろ #\プ #\ょ #\足 #\労 #\ふ #\経 #\験
  #\忙 #\俺 #\せ #\ね #\め #\何 #\り #\小 #\僧 #\ー #\ア #\ル #\バ #\２ #\４
  #\け #\み #\伝 #\あ)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
        ...
        (<>
         ...
         (cond ((&& (== V 114) (== (: 166) 0) (> M 19999))
                (<>
                 ...
                 (cond ((> T 2200)
                        (<>
                         (text #:color 1 "【工事現場のおっさん】だいたい、こんな時間に何をしているんだ？・・・だめだぞ、ちゃんと家に帰らないとな。")
                         (wait)))
                       ((< T 500)
                        (<>
                         (text #:color 1 "【工事現場のおっさん】だいたい、こんな時間に何をしているんだ？・・・だめだぞ、ちゃんと家に帰らないとな。")
               ...
               ((&& (== V 114) (== (: 166) 1) (> M 19999))
                (<>
                 ...
                 (cond ((> T 2200)
                        (<>
                         (text #:color 1 "【工事現場のおっさん】子供は家に帰って、テレビでも見ているんだな・・・おまわりさんに、補導されちゃうぜ。")
                         (wait)))
                       ((< T 500)
                        (<>
                         (text #:color 1 "【工事現場のおっさん】子供は家に帰って、テレビでも見ているんだな・・・おまわりさんに、補導されちゃうぜ。")
               ...
               ((&& (== V 114) (== (: 166) 0) (== (: 167) 0) (== (: 168) 0)
                ...
                (<>
                 ...
                 (cond ((> T 2200)
                       ...
                       ((< T 500)
                        (<>
                         ...
                         (wait)))
                       (else (<>)))
                 (text #:color 1 "【工事現場のおっさん】そうだ・・・ちょうど今、人手が不足しているんだ・・・よかったら、ここでアルバイトしていかないか？")
                 (wait)
                 ...
                 (color 8)
                 (clear)
                 (text #:color 1 "【工事現場のおっさん】はっはっはっ！！ガキがナマイキ言っているじゃないよ・・・若いうちはな、働けるだけ働いておくもんだぜ。")
                 (wait)
                 ...
                 (cond ((== N 1)
                        (<>
                         ...
                         (wait)
                         (text #:color 1 "【工事現場のおっさん】また忙しくなって、人手が足りなくなったら手伝ってくれよ・・・お前、なかなか見所があるぜ。")
                         (wait)
                         (sound 1)
                         (set-var I 58)
                         (proc 26)
                       ...
                       ((== N 2)
                        (<>
                         ...
                         (wait)
                         (text #:color 1 "【工事現場のおっさん】今の若いやつらは、３Ｋだなんて言っていやがるが・・・俺に言わせてもらえれば、いい人生の経験になると思うんだがね。")
                         (wait)))
                       (else (<>)))
                 (set-reg: 166 1)
                 (set-reg: 168 1)
                 (break)))
               ((&& (== V 114) (== (: 166) 1) (== (: 167) 0) (== (: 168) 0)
                 (< M 20000))
                (<>
                 (proc 19)
                 (set-arr~ @ 7 1)
                 ...
                 (cond ((== N 1)
                       ...
                       ((== N 2)
                        (<>
                         ...
                         (wait)
                         (text #:color 1 "【工事現場のおっさん】また気が向いたらアルバイトをしてくれよな・・・もっとも、こっちが人手不足だったらの話だが。")
                         (wait)))
                       (else (<>)))
                 (break)))
               (else (<>)))))
