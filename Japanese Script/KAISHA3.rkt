(mes
 ...
 (dict #\・ #\【 #\】 #\く #\る #\。 #\い #\ん #\う #\み #\の #\か #\な #\、
  #\て #\こ #\？ #\だ #\ゃ #\も #\に #\っ #\と #\ち #\た #\さ #\は #\を #\し
  #\ま #\あ #\ら #\俺)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
         ...
         (cond ((== V 0)
                (<>
                 ...
                 (cond ((== N 1)
                       ...
                       ((== N 3)
                        (<>
                         (text #:color 7 "【" 0 "】ここにいるって・・・まだくるみちゃんと話をするのか？")
                         (wait)))
                       (else (<>)))))
               ((&& (== V 2) (== N 7) (== (: 13) 0))
                (<>
               ...
               ((&& (== V 2) (== N 7) (== (: 14) 1))
                (<>
                 (text #:color 6 "【くるみ】あ・・・もう行かないと。")
                 (wait)))
               ((&& (== V 1) (== N 8))
                (<>
                 (text #:color 7 "【" 0 "】くるみちゃんの髪だ・・・。")
                 (wait)))
               ((&& (== V 1) (== N 9))
                (<>
