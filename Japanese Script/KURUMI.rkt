(mes
 ...
 (dict #\・ #\な #\の #\る #\く #\【 #\】 #\は #\み #\、 #\か #\い #\ん #\。
  #\に #\う #\た #\？ #\っ #\だ #\父 #\て #\！ #\娘 #\を #\ら #\私 #\と #\言
  #\君 #\事 #\ま #\ン #\こ #\り #\が #\わ #\ち #\え #\お #\れ #\ね #\よ #\あ
  #\何 #\も #\じ #\ー #\用 #\つ)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
         ...
         (cond ((&& (== V 203) (== (: 515) 1) (== (: 518) 0))
               ...
               ((&& (== V 203) (== (: 856) 0))
                (<>
                 ...
                 (color 8)
                 (clear)
                 (text #:color 7 "【" 0 "】はははははっ！！・・・くるみちゃんの側に、べったりとくっついて見張ってない限り、そんな事を言っても無駄だよーん。")
                 (wait)
                 (set-arr~ @ 13 28 48 65 127)
                 (color 8)
                 (clear)
