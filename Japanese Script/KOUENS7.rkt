(mes
 ...
 (dict #\・ #\【 #\】 #\い #\な #\一 #\。 #\哉 #\っ #\ん #\だ #\、 #\は #\て
  #\る #\の #\く #\か #\に #\う #\よ #\あ #\た #\と #\つ #\俺 #\が #\？ #\子
  #\し #\ら #\み #\で #\そ #\ぶ #\き #\夏 #\さ #\ち #\ろ #\も #\ぜ #\ゃ #\ま
  #\ど #\れ)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 ...
 (if (== (: 485) 0)
     (<>
      ...
      (text #:color 7 "【" 0 "】何がだ？")
      (wait)
      (text #:color 5 "【一哉】" 0 "、俺はどうしたらいいんだ・・・くるみにはっきり言えないし、でも今の俺は夏子さんの方がいいし・・・。")
      (wait)
      (text #:color 5 "【一哉】くるみから電話がかかって来ても、居留守を使ってるんだ・・・そのたびにくるみの顔が浮かんできて・・・心がシクシクと痛むんだあ。")
      (wait)
         ...
         (cond ((== V 0)
               ...
               ((&& (== V 1) (== N 10))
                (<>
                 ...
                 (wait)
                 (text #:color 5 "【一哉】" 0 "って強いよな・・・俺は２股かけただけでアセりまくってるけど、" 0 "は常時６股ぐらいだろ？")
                 (wait)
