(mes
 ...
 (dict #\・ #\【 #\】 #\い #\。 #\な #\っ #\か #\ん #\亜 #\子 #\に #\ら #\、
  #\う #\る #\く #\て #\だ #\し #\は #\と #\の #\ー #\？ #\が #\あ #\た #\ど
  #\さ #\そ #\（ #\） #\！ #\れ #\お #\わ #\も #\よ #\ゃ #\ま #\ち #\り)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 (set-arr~ @ 7 0)
         ...
         (cond ((== V 0)
               ...
               ((&& (== V 2) (== N 1) (== (: 10) 0))
                (<>
                 ...
                 (wait)
                 (text #:color 7 "【" 0 "】俺達は体育って授業があるから、強制的に運動させられるけど・・・卒業したら、自主的にやらない限り運動しなくなるんだろうな。")
                 (wait)
               ...
               ((&& (== V 1) (== N 2))
                (<>
                 (text #:color 7 "【" 0 "】（亜子さんの顔って・・・目がちょっとタレてて、かわいいよなあ。）")
                 (wait)))
               ((&& (== V 1) (== N 3))
                (<>
