(mes
 ...
 (dict #\・ #\【 #\】 #\い #\か #\。 #\な #\ん #\て #\だ #\、 #\の #\に #\は
  #\っ #\り #\う #\お #\し #\る #\さ #\？ #\が #\こ #\た #\あ #\ら #\よ #\れ
  #\け #\ま #\で #\と #\ど #\入 #\や #\ー #\も #\部 #\屋 #\ゃ #\ぜ #\ン #\そ
  #\事 #\気 #\中 #\ね #\き #\ろ #\を #\来 #\じ #\く #\す #\君 #\俺 #\！ #\女
  #\マ)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 ...
 (cond ((&& (== (: 581) 1) (> H 820) (== (: 592) 0))
       ...
       ((== (: 578) 1)
        (<>
         (text #:color 7 "【" 0 "】かおりさんが住んでるマンションだぜ・・・どうするんだ？")
         (wait))))
 (while (== 1 1)
        (<>
         (proc 17)
         ...
         (cond ((== V 0)
                (<>
                 ...
                 (cond ((== N 1)
                       ...
                       ((&& (== N 2) (== (: 50) 2))
                        (<>
                         (text #:color 7 "【" 0 "】かおりさんが部屋にいないのに、どうして中に入るんだ？")
                         (wait)))
                       ((&& (== N 2) (> T 2300) (== (: 10) 0))
                        (<>
                       ...
                       ((&& (== N 2) (> T 2300) (== (: 10) 1))
                        (<>
                         (text #:color 7 "【" 0 "】かおりさん・・・部屋にいないのかなあ？")
                         (wait)))
                       ((&& (== N 2) (< T 600) (== (: 11) 0))
                        (<>
                         (text #:color 7 "【" 0 "】こんな時間だぜ・・・本当に中に入るのか？")
                       ...
                       ((&& (== N 2) (< T 600) (== (: 11) 1))
                        (<>
                         (text #:color 7 "【" 0 "】うーん・・・かおりさんは、夜遊びでもしてるのかな？")
                         (wait)))
                       ((&& (== N 2) (== (: 12) 0))
                        (<>
                       ...
                       ((&& (== N 2) (== (: 12) 1))
                        (<>
                         (text #:color 7 "【" 0 "】かおりさん・・・寝てるんじゃないか？")
                         (wait)))
                       ((== N 3)
                        (<>
                         (text #:color 7 "【" 0 "】うーん・・・どうして俺はここにいるんだろ？")
                         (wait)))
                       (else (<>)))))
               ((&& (== V 1) (== N 1) (== (: 13) 0))
                (<>
               ...
               ((&& (== V 1) (== N 4) (== (: 16) 1))
                (<>
                 (text #:color 7 "【" 0 "】マンモスマンションってやつか？・・・死語かな。")
                 (wait)))
               ((&& (== V 1) (== N 5) (> T 1900))
                (<>
                 (text #:color 7 "【" 0 "】空だぜ・・・星がまたたいている。")
                 (wait)))
               ((&& (== V 1) (== N 5) (> T 0) (< T 600))
                (<>
                 (text #:color 7 "【" 0 "】空には星が・・・俺の心には甘酸っぱい気持ちがまたたいている。")
                 (wait)))
               ((&& (== V 1) (== N 5) (== (: 17) 0))
                (<>
                 (text #:color 7 "【" 0 "】うーん・・・いい天気だぜ。")
                 (wait)
                 (set-reg: 17 1)))
               ((&& (== V 1) (== N 5) (== (: 17) 1))
                (<>
                 (text #:color 7 "【" 0 "】空を見上げても、かおりさんは降ってこないぜ。")
                 (wait)))
               (else (<>)))))
 (set-arr~ @ 7 1))