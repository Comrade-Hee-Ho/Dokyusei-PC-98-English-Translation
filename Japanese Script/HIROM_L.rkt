(mes
 ...
 (dict #\・ #\【 #\】 #\。 #\ひ #\み #\ろ #\い #\ん #\て #\、 #\な #\の #\君
  #\っ #\し #\る #\が #\と #\私 #\た #\に #\う #\で #\ゃ #\ち #\か #\わ #\も
  #\！ #\だ #\く #\ぁ #\？ #\れ #\は #\ど #\あ #\冬 #\彦 #\ら #\そ #\よ #\ね
  #\話 #\き)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
        ...
        (<>
         ...
         (if-else (== N 4)
                  (<>
                   ...
                   (cond ((< (: 103) 6)
                          (<>
                           (text #:color 2 "【ひろみ】早く話して・・・私、時間がないの。")
                           (wait)))
                         ((> (: 103) 5)
                          (<>
                           (text #:color 2 "【ひろみ】・・・。")
                   ...
                   (cond ((< (: 103) 3)
                         ...
                         ((< (: 103) 16)
                          (<>
                           ...
                           (text #:color 7 "【" 0 "】・・・。")
                           (wait)
                           (text #:color 2 "【ひろみ】" 0 "君が一緒にいてくれないと・・・無理して" 0 "君の事を忘れようとしたけど、やっぱり駄目みたい。")
                           (wait)
