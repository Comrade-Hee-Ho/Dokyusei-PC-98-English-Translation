(mes
 ...
 (dict #\・ #\【 #\】 #\し #\。 #\よ #\こ #\い #\な #\は #\す #\、 #\ん #\で
  #\か #\あ #\て #\の #\生 #\ら #\だ #\ま #\君 #\私 #\た #\っ #\先 #\に #\そ
  #\と #\も #\り #\を #\事 #\わ #\れ #\？ #\言 #\が #\る #\う #\き #\ぁ #\く
  #\さ #\け #\業 #\ゃ #\俺 #\好 #\！ #\教 #\師 #\徒 #\明 #\日 #\帰)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 (set-arr~ @ 7 0)
        ...
        (<>
         ...
         (if-else (== N 7)
                  (<>
                   ...
                   (cond ((< (: 110) 6)
                          (<>
                           (text #:color 6 "【よしこ】" 0 "君、私を呼び出して・・・いったい何の相談ですか？")
                           (wait)))
                         ((> (: 110) 5)
                          (<>
                           (text #:color 6 "【よしこ】" 0 "君・・・何か相談かしら？")
                           (wait)))
                         (else (<>)))
                   ...
                   (cond ((< (: 110) 3)
                          (<>
                           ...
                           (set-var I 47)
                           (proc 26)
                           (text #:color 6 "【よしこ】正直言って、こんな事を言われると困ります・・・" 0 "君、そんな事を考える暇があるのなら、もっと勉強をしなさい。")
                           (wait)
                           (text #:color 7 "【" 0 "】先生・・・。")
                           (wait)
