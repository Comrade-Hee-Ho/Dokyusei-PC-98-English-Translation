(mes
 ...
 (dict #\・ #\な #\い #\【 #\】 #\。 #\だ #\に #\の #\、 #\て #\る #\太 #\郎
  #\は #\か #\を #\ん #\う #\た #\と #\し #\が #\観 #\そ #\れ #\っ #\ら #\く
  #\映 #\画 #\で #\も #\？ #\事 #\よ #\ゃ #\人 #\ロ #\ま #\わ #\ど #\勉 #\一
  #\マ #\タ #\ウ #\じ #\考 #\あ #\ろ #\本 #\め #\つ #\強)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 (set-arr~ @ 7 0)
 ...
 (if (== (: 297) 0)
     (<>
      ...
      (wait)
      (text #:color 5 "【太郎】馬鹿な事を・・・僕にはそんな時間はない、ただ参考書を買いに矢吹町に来て、それでたまたま映画館の前を・・・。")
      (wait)
