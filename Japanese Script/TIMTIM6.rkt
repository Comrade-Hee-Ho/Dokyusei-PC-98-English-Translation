(mes
 ...
 (dict #\・ #\【 #\】 #\。 #\な #\一 #\哉 #\だ #\い #\る #\ん #\、 #\っ #\て
  #\う #\よ #\あ #\た #\く #\が #\は #\か #\に #\の #\と #\も #\み #\そ #\ら
  #\れ #\ど #\を #\し #\で #\ぜ #\？ #\事 #\さ #\や #\ま #\け #\俺 #\会 #\き
  #\す #\つ #\り #\言 #\ゃ #\気 #\え)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
        ...
        (<>
         ...
         (cond ((== V 0)
                (<>
                 ...
                 (cond ((&& (== N 1) (== (: 50) 0))
                        (<>
                         (text #:color 5 "【一哉】待てよ・・・聞きたい事があるんだ。")
                         (wait)))
                       ((== N 1)
                        (<>
               ...
               ((&& (== V 2) (== N 8) (== (: 11) 0))
                (<>
                 ...
                 (text #:color 7 "【" 0 "】うんうん。")
                 (wait)
                 (text #:color 5 "【一哉】そんな考えだと、どうも気合いが入らなくてさ・・・それで戻る場所をなくせば、もっと真剣にアタックできるかと思って。")
                 (wait)
                 (text #:color 7 "【" 0 "】お前って、マグマ大使みたいなやつだな。")
                 (wait)
                 (text #:color 5 "【一哉】はあ？")
                 (wait)
                 (text #:color 7 "【" 0 "】地球のまん中にはマグマがあるだろ？・・・だから、自分中心で地球が回ってると考えるヤツの事をそう言うんだ。")
                 (wait)
