(mes
 ...
 (dict #\・ #\【 #\】 #\る #\い #\く #\み #\。 #\っ #\の #\ん #\た #\に #\う
  #\な #\、 #\て #\か #\ち #\を #\だ #\ら #\ゃ #\し #\え #\れ #\！ #\と #\？
  #\（ #\） #\あ #\は #\も #\一 #\君 #\来 #\会 #\け #\さ #\こ #\哉 #\よ #\事
  #\行 #\ー #\や #\ば #\が)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 ...
 (while (== 1 1)
        (<>
         ...
         (cond ((== V 0)
               ...
               ((&& (== V 1) (== N 3))
                (<>
                 (text #:color 7 "【" 0 "】（この表情がたまらないんだ・・・ぞくぞくきちゃうぜ。）")
                 (wait)))
               ((&& (== V 1) (== N 4))
                (<>
                 (text #:color 7 "【" 0 "】（リボンを・・・俺の手で取ってみたい。）")
                 (wait)))
               ((&& (== V 1) (== N 5))
                (<>
                 (text #:color 7 "【" 0 "】（うーん・・・ピチピチだぜ。）")
                 (wait)))
               ((&& (== V 1) (== N 6))
                (<>
                 (text #:color 7 "【" 0 "】（いつも胸を隠してるよな・・・自信がないのかな？）")
                 (wait)))
               ((&& (== V 1) (== N 7))
                (<>
               ...
               ((&& (== V 1) (== N 8))
                (<>
                 (text #:color 7 "【" 0 "】（くるみちゃんだ・・・全身を見ても、やっぱりかわいい。）")
                 (wait)))
               (else (<>)))))
 (set-arr~ @ 7 1))