(mes
 ...
 (dict #\・ #\【 #\】 #\か #\。 #\り #\お #\な #\の #\い #\ん #\っ #\、 #\て
  #\君 #\よ #\と #\さ #\る #\わ #\う #\き #\し #\で #\た #\私 #\は #\に #\が
  #\も #\こ #\あ #\ら #\そ #\事 #\だ #\を #\ぁ #\く #\？ #\ゃ #\大 #\話 #\ち
  #\れ #\来 #\つ #\合 #\！ #\好 #\一 #\誤 #\解)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
        ...
        (<>
         ...
         (if-else (== N 5)
                  (<>
                   ...
                   (cond ((&& (< (: 107) 6) (== (: 587) 0))
                          (<>
                           (text #:color 6 "【かおり】" 0 "君・・・よく私の住んでる場所がわかったわね。")
                           (wait)))
                         ((&& (< (: 107) 6) (== (: 587) 1))
                          (<>
                           (text #:color 6 "【かおり】" 0 "君・・・どうしたのよ、真面目な顔して。")
                           (wait)))
                         ((&& (> (: 107) 5) (== (: 587) 0))
                          (<>
                           (text #:color 6 "【かおり】" 0 "君・・・よく私の住んでる場所がわかったわね。")
                   ...
                   (cond ((< (: 107) 3)
                         ...
                         ((< (: 107) 13)
                          (<>
                           ...
                           (wait)
                           (text #:color 6 "【かおり】店が終って、客とつき合わないといけないし・・・" 0 "君は子供だから、我慢できない事がいっぱいあるの。")
                           (wait)
