(mes
 ...
 (dict #\・ #\【 #\】 #\な #\。 #\い #\と #\だ #\て #\、 #\の #\る #\に #\う
  #\っ #\ん #\さ #\か #\こ #\が #\み #\？ #\も #\は #\あ #\し #\で #\よ #\ら
  #\た #\れ #\を #\何 #\そ #\ま #\え #\ぜ #\ち #\ゃ #\ろ #\す #\く #\所 #\わ
  #\場 #\や #\つ #\！ #\ー #\じ #\部 #\使 #\思 #\り #\物 #\事 #\ど #\ね #\誰
  #\健 #\二 #\き #\切 #\ぶ #\お #\戻 #\屋 #\ば #\け #\め #\カ #\入)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 (set-arr~ @ 7 0)
         ...
         (cond ((== V 0)
                (<>
                 ...
                 (cond ((== N 1)
                       ...
                       ((== N 3)
                        (<>
                         (text #:color 7 "【" 0 "】俺は倉庫の入口に立っている・・・このままここにいるのか？")
                         (wait)))
                       (else (<>)))))
               ((&& (== V 1) (== N 1) (== (: 10) 0))
                (<>
                 (text #:color 7 "【" 0 "】バレーボールだな・・・ボロボロだぜ。")
                 (wait)
                 (set-reg: 10 1)))
               ((&& (== V 1) (== N 1) (== (: 10) 1))
                (<>
               ...
               ((&& (== V 1) (== N 3) (== (: 12) 1))
                (<>
                 (text #:color 7 "【" 0 "】跳箱だ・・・ここで飛ぶと、窓ガラスを破って下に落ちそうだ。")
                 (wait)))
               ((&& (== V 1) (== N 4) (== (: 13) 0))
                (<>
               ...
               ((&& (== V 1) (== N 5) (== (: 14) 1))
                (<>
                 (text #:color 7 "【" 0 "】マットだ・・・酸っぱい臭いがするぜ。")
                 (wait)))
               ((&& (== V 1) (== N 6) (== (: 15) 0))
                (<>
               ...
               ((&& (== V 1) (== N 7) (== (: 16) 1))
                (<>
                 (text #:color 7 "【" 0 "】貼紙だ・・・使いたいなら、教官に断れと書いてあるんだ。")
                 (wait)))
               ((&& (== V 1) (== N 8) (== (: 17) 0))
                (<>
               ...
               ((&& (== V 1) (== N 9) (== (: 18) 1))
                (<>
                 (text #:color 7 "【" 0 "】錆ているな・・・たいぶ古い物のようだぜ。")
                 (wait)))
               ((&& (== V 1) (== N 10) (== (: 19) 0))
                (<>
               ...
               ((&& (== V 1) (== N 11) (== (: 20) 1))
                (<>
                 (text #:color 7 "【" 0 "】床には、うっすらとホコリが積もってる。")
                 (wait)))
               ((&& (== V 1) (== N 12) (== (: 21) 0))
                (<>
               ...
               ((&& (== V 1) (== N 12) (== (: 21) 1))
                (<>
                 (text #:color 7 "【" 0 "】閉所恐怖症のやつが、一番嫌いそうな場所だぜ・・・。")
                 (wait)))
               (else (<>)))))
 (set-arr~ @ 7 1))