(mes
 ...
 (dict #\・ #\【 #\】 #\。 #\と #\い #\さ #\み #\な #\、 #\て #\か #\っ #\た
  #\る #\う #\の #\だ #\れ #\に #\ら #\し #\ん #\？ #\が #\は #\こ #\で #\そ
  #\あ #\よ #\く #\（ #\ゃ #\） #\わ #\事 #\き #\も #\ど #\ち #\じ #\を #\ば
  #\気 #\け #\！ #\ま #\す #\俺 #\私 #\え #\つ #\ラ #\り #\達 #\忘 #\時 #\間
  #\一 #\人 #\や #\お #\出 #\何 #\帰 #\ろ #\ぜ #\友 #\め #\君 #\思 #\驚 #\健
  #\二 #\談 #\誰 #\言 #\聞 #\彼 #\好 #\ー #\乗 #\元 #\せ #\今)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 (set-arr~ @ 7 0)
         ...
         (cond ((== V 0)
               ...
               ((&& (== V 2) (== N 1) (== (: 12) 0))
                (<>
                 ...
                 (set-arr~ @ 7 0)
                 (proc 18)
                 (menu-show (<.> (text "おめでとう") (text "驚いた")
                             (text "誰に？") (text "それがどうした")))
                 (cond ((== N 1)
                        (<>
               ...
               ((&& (== V 2) (== N 1) (== (: 14) 0))
                (<>
                 (cond ((== (: 20) 0)
                        (<>
                         (text #:color 7 "【" 0 "】さとみ、もしかしてその彼氏って・・・。")
                         (wait)))
                       ((== (: 20) 1)
                        (<>
                         (text #:color 7 "【" 0 "】もう一度聞くけど、その彼氏って・・・。")
                         (wait)))
                       (else (<>)))
                 (set-reg: 101 1)
                 (set-arr~ @ 7 0)
                 (proc 18)
                 (menu-show (<.> (if (== (: 15) 0) (text "一哉"))
                             (if (== (: 16) 1) (text "三郎"))
                             (if (== (: 17) 0) (text "たかし"))
                             (text "健二") (if (== (: 18) 0) (text "忠彦"))
                             (if (== (: 19) 0) (text "マタロウ"))))
                 (cond ((== N 1)
                        (<>
               ...
               ((&& (== V 2) (== N 1) (== (: 21) 0))
                (<>
                 ...
                 (wait)
                 (text #:color 6 "【さとみ】いや、もうその名前は聞きたくない・・・彼女が悪い訳じゃないけど、名前を聞くたびに自分がみじめな気分になるの。")
                 (wait)
                 (text #:color 7 "【" 0 "】・・・。")
                 (wait)
               ...
               ((&& (== V 2) (== N 1))
                (<>
                 ...
                 (set-arr~ @ 7 0)
                 (proc 18)
                 (menu-show (<.> (text "なぐさめる")
                             (text "抱きしめる") (text "家に帰す")))
                 (cond ((== N 1)
                        (<>
               ...
               ((&& (== V 1) (== N 2))
                (<>
                 (text #:color 7 "【" 0 "】（さとみの髪が、水銀灯の光でキラキラしてるな。）")
                 (wait)))
               ((&& (== V 1) (== N 3))
                (<>
                 (text #:color 7 "【" 0 "】（今まで、こんな悲しい顔をしたさとみを見た事がない・・・。）")
                 (wait)))
               ((&& (== V 1) (== N 4) (== (: 30) 0))
                (<>
               ...
               ((&& (== V 1) (== N 5) (== (: 31) 1))
                (<>
                 (text #:color 7 "【" 0 "】（ちらっ・・・けっこう大きいかな？）")
                 (wait)))
               ((&& (== V 1) (== N 6))
                (<>
                 (text #:color 7 "【" 0 "】（さとみの手が、しっかりと鎖を握ってる・・・。）")
                 (wait)))
               ((&& (== V 1) (== N 7))
                (<>
                 (text #:color 7 "【" 0 "】（さとみだ・・・ブランコに乗ってるぞ。）")
                 (wait)))
               ((&& (== V 1) (== N 8))
                (<>
                 (text #:color 7 "【" 0 "】（ブランコの鎖だ・・・これがなければ、ただの板だな。）")
                 (wait)))
               ((&& (== V 1) (== N 9))
                (<>
                 (text #:color 7 "【" 0 "】（公園の地面だ・・・もちろん土だぜ。）")
                 (wait)))
               (else (<>)))))
 (set-arr~ @ 7 1))