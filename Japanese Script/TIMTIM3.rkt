(mes
 ...
 (dict #\・ #\な #\【 #\】 #\。 #\だ #\い #\か #\、 #\は #\る #\太 #\郎 #\の
  #\て #\に #\ん #\う #\し #\を #\が #\？ #\ら #\で #\あ #\も #\よ #\マ #\ロ
  #\っ #\た #\僕 #\え #\タ #\ウ #\く #\と #\事 #\勉 #\強 #\ま #\そ #\れ #\じ
  #\ゃ #\何 #\茶 #\す #\き #\君 #\こ #\り #\ー #\性 #\考)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 (set-arr~ @ 7 0)
         ...
         (cond ((== V 0)
               ...
               ((&& (== V 2) (== N 7) (== (: 18) 1))
                (<>
                 ...
                 (text #:color 7 "【" 0 "】はあ？")
                 (wait)
                 (text #:color 5 "【太郎】だからだな・・・僕の勉強の邪魔をしようと、僕がその女性の事を考えるように、その女性が僕の事を呪っているんだ。")
                 (wait)
