(mes
 ...
 (dict #\・ #\【 #\】 #\し #\い #\な #\よ #\の #\て #\。 #\こ #\、 #\に #\を
  #\？ #\っ #\か #\う #\す #\は #\ん #\る #\だ #\が #\生 #\で #\た #\と #\先
  #\ら #\君 #\さ #\そ #\ま #\ゃ #\も #\え #\け #\げ #\！ #\何 #\り #\校 #\屋
  #\上 #\ね #\（ #\）)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
        ...
        (<>
         ...
         (cond ((== V 0)
                (<>
                 ...
                 (cond ((&& (== N 1) (== (: 50) 0))
                        (<>
                         (text #:color 6 "【よしこ】待ちなさい・・・" 0 "君は、何をしに屋上に来たの？")
                         (wait)))
                       ((&& (== N 1) (== (: 50) 1))
                        (<>
               ...
               ((&& (== V 2) (== N 1) (== (: 12) 0))
                (<>
                 ...
                 (wait)
                 (text #:color 6 "【よしこ】私はいつも教育の事を考えてますよ・・・だから夏休みでも、こうして学校に来て、生徒達の家庭訪問もする訳です。")
                 (wait)
                 (set-reg: 12 1)))
               ((&& (== V 2) (== N 1) (== (: 12) 1))
                (<>
