(mes
 ...
 (dict #\・ #\【 #\】 #\い #\。 #\な #\の #\、 #\真 #\子 #\て #\う #\ん #\し
  #\は #\ら #\っ #\君 #\だ #\も #\か #\わ #\と #\そ #\事 #\れ #\生 #\た #\が
  #\る #\ぁ #\あ #\で #\よ #\ゃ #\？ #\ち #\私 #\き #\く #\！ #\先 #\ど #\ま
  #\俺 #\じ #\に #\徒 #\す #\ね #\言 #\好 #\を #\け #\気 #\り #\つ #\見 #\こ)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 (set-arr~ @ 7 0)
                   ...
                   (cond ((< (: 108) 3)
                         ...
                         ((< (: 108) 13)
                          (<>
                           ...
                           (wait)
                           (text #:color 3 "【真子】世の中にはね、どうする事もできない事だってあるのよ・・・" 0 "君がもっと大人になったらわかると思うわ。")
                           (wait)
