(mes
 ...
 (dict #\・ #\【 #\】 #\。 #\い #\な #\だ #\っ #\て #\ん #\、 #\の #\美 #\か
  #\る #\は #\？ #\に #\た #\し #\う #\が #\穂 #\く #\よ #\を #\こ #\あ #\ゃ
  #\で #\と #\ち #\ら #\も #\一 #\ー #\！ #\沙 #\れ #\き #\放 #\送 #\ぜ #\じ
  #\や #\哉 #\さ #\ど #\お #\俺 #\事 #\ろ #\そ #\何 #\イ #\誰 #\君 #\つ #\ス
  #\室 #\す #\レ #\み #\部 #\マ #\ょ #\ま #\行 #\校 #\来 #\好 #\ト #\手 #\女
  #\け #\太 #\郎 #\り #\聞 #\オ #\ッ #\言 #\子 #\健 #\二 #\ふ #\学 #\タ #\勉
  #\強 #\場 #\わ)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 ...
 (cond ((== (: 243) 0)
        (<>
         (text #:color 7 "【" 0 "】ここは放送室だな・・・夏休みだから誰もいないようだ。")
         (wait)))
       ((&& (== (: 292) 1) (== (: 346) 0) (== (: 685) 0))
        (<>
         (set-arr~ @ 7 1)
 ...
 (while (== 1 1)
        (<>
         ...
         (cond ((== V 0)
               ...
               ((&& (== V 1) (== N 8) (== (: 17) 1))
                (<>
                 (text #:color 7 "【" 0 "】細かい字で、校内放送の規定が書いてある・・・俺には関係のない事だな。")
                 (wait)))
               ((&& (== V 1) (== N 9) (== (: 18) 0))
                (<>
               ...
               ((&& (== V 1) (== N 10) (== (: 19) 0))
                (<>
                 (text #:color 7 "【" 0 "】蛍光灯だ・・・今はついてない。")
                 (wait)
                 (set-reg: 19 1)))
               ((&& (== V 1) (== N 10) (== (: 19) 1))
                (<>
                 (text #:color 7 "【" 0 "】蛍光灯だぜ・・・そんなに珍しいか？")
                 (wait)))
               ((&& (== V 1) (== N 11) (== (: 20) 0))
                (<>
               ...
               ((&& (== V 1) (== N 11) (== (: 20) 1))
                (<>
                 (text #:color 7 "【" 0 "】誰もいない・・・なんだか寂しくなってくるな。")
                 (wait)))
               (else (<>)))))
 (set-arr~ @ 7 1))