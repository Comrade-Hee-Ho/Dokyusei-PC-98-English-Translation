(mes
 ...
 (dict #\・ #\【 #\】 #\。 #\は #\い #\る #\ち #\な #\っ #\の #\て #\、 #\だ
  #\か #\う #\？ #\し #\ん #\に #\あ #\た #\と #\ゃ #\！ #\よ #\え #\俺 #\ら
  #\こ #\を #\く #\れ #\女 #\そ #\子 #\が #\じ #\わ #\ね #\ど #\り #\歳 #\行
  #\で #\も #\前 #\言 #\ー #\ぜ #\茶 #\す #\名 #\ま #\店 #\お #\さ #\ょ #\私
  #\人 #\や #\ろ #\け #\（ #\ン #\） #\喫 #\一 #\ば #\何 #\き #\事 #\緒 #\ご
  #\１ #\つ #\目 #\ナ #\パ #\ぇ #\変 #\楽 #\見 #\駄 #\８ #\下 #\チ #\め #\別
  #\年 #\ぞ #\間 #\違 #\勧 #\誘 #\方 #\訳)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
         ...
         (cond ((== V 0)
                (<>
                 ...
                 (cond ((&& (== N 1) (== (: 50) 0))
                       ...
                       ((&& (== N 3) (== (: 50) 0))
                        (<>
                         (text #:color 7 "【" 0 "】" 0 "の、ばかばかばかばかっ！！")
                         (wait)))
                       ((&& (== N 3) (== (: 50) 1))
                        (<>
                         (text #:color 7 "【" 0 "】電車に乗って『ＯＴＩＭＴＩＭ』に行くのか！？")
                         (wait)))
                       ((&& (== N 4) (== (: 50) 0))
                        (<>
                         (text #:color 7 "【" 0 "】（当り前だ・・・ここであきらめてたまるか。）")
                         (wait)))
                       ((&& (== N 4) (== (: 50) 1))
                        (<>
                         (text #:color 7 "【" 0 "】あれれ、喫茶店に行くんだろ！？")
                         (wait)))
                       (else (<>)))))
               ((&& (== V 2) (== N 1) (== (: 30) 0))
                (<>
               ...
               ((&& (== V 2) (== N 1) (== (: 10) 0))
                (<>
                 ...
                 (set-arr~ @ 7 0)
                 (proc 18)
                 (menu-show (<.> (text "いい名前") (text "ひどい名前")
                             (text "人間の名前")))
                 (cond ((== N 1)
                        (<>
                 ...
                 (cond ((== N 1)
                       ...
                       ((== N 6)
                        (<>
                         ...
                         (text #:color 3 "【ちはる】はあ？")
                         (wait)
                         (text #:color 7 "【" 0 "】ほーら、こんなに泥がついちゃって・・・駄目ですよ、靴の手入れはマメにしないと、ごしごしごし。")
                         (wait)
               ...
               ((&& (== V 1) (== N 3))
                (<>
                 (text #:color 7 "【" 0 "】（うーむ、なかなかの美形だぜ・・・俺様にぴったりだ。）")
                 (wait)))
               ((&& (== V 1) (== N 4))
                (<>
               ...
               ((&& (== V 1) (== N 5))
                (<>
                 (text #:color 7 "【" 0 "】（あまり大きくないが・・・まさか折りたたんでる訳じゃないだろうな？）")
                 (wait)))
               ((&& (== V 1) (== N 6))
                (<>
