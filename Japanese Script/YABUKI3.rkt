(mes
 ...
 (dict #\・ #\【 #\】 #\ん #\。 #\い #\う #\な #\だ #\太 #\郎 #\る #\の #\、
  #\て #\は #\か #\っ #\に #\が #\ー #\し #\と #\？ #\も #\よ #\！ #\た #\え
  #\事 #\で #\を #\く #\そ #\マ #\や #\あ #\ら #\タ #\間 #\ゃ #\ど #\ロ #\ウ
  #\僕 #\お #\ま #\こ #\じ #\す #\言 #\勉 #\強 #\俺 #\考 #\れ)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 (set-arr~ @ 7 0)
         ...
         (cond ((== V 0)
                (<>
                 ...
                 (cond ((&& (== N 1) (== (: 50) 0))
                       ...
                       ((&& (== N 2) (== (: 50) 0))
                        (<>
                         (text #:color 5 "【太郎】まあ待て・・・僕と話をすると、色々と勉強になるぞ。")
                         (wait)))
                       ((&& (== N 2) (== (: 50) 1) (< M 300))
                        (<>
                         (text #:color 5 "【太郎】うーん・・・うーん・・・うーん・・・。")
               ...
               ((&& (== V 1) (== N 9))
                (<>
                 ...
                 (wait)
                 (text #:color 5 "【太郎】そもそも頭髪というものはだな、色々な意味で頭部を守る為に存在してるんだ・・・よって、坊主という髪型は好ましくない。")
                 (wait)))
               ((&& (== V 1) (== N 10))
                (<>
                 (text #:color 5 "【太郎】僕の目が悪くなったのは、勉強のせいだが・・・もし君も目が悪いとしたらコンピューターゲームのせいだろう。")
                 (wait)))
               ((&& (== V 1) (== N 11))
                (<>
               ...
               ((&& (== V 1) (== N 12))
                (<>
                 (text #:color 5 "【太郎】心配するな・・・僕は替えの制服を持っている。")
                 (wait)))
               ((&& (== V 1) (== N 13))
                (<>
