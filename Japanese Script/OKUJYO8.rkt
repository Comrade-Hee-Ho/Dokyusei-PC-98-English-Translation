(mes
 ...
 (dict #\・ #\【 #\】 #\い #\。 #\な #\子 #\真 #\の #\て #\、 #\っ #\ら #\で
  #\に #\だ #\か #\も #\？ #\（ #\う #\が #\る #\） #\こ #\ん #\し #\と #\は
  #\た #\君 #\わ #\先 #\生 #\よ #\事 #\ふ #\ま #\俺 #\を #\誰)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 (set-arr~ @ 7 0)
         ...
         (cond ((== V 0)
                (<>
                 ...
                 (cond ((== N 1)
                       ...
                       ((== N 2)
                        (<>
                         (text #:color 7 "【" 0 "】（そうだな・・・真子先生がいるから、まだここにいよう。）")
                         (wait)))
                       (else (<>)))))
               ((&& (== V 2) (== N 29) (== (: 10) 0))
                (<>
               ...
               ((&& (== V 2) (== N 29) (== (: 10) 2))
                (<>
                 (text #:color 3 "【真子】" 0 "君って・・・罪な男よね。")
                 (wait)))
               ((&& (== V 1) (== N 23))
                (<>
                 (text #:color 7 "【" 0 "】（真子先生が俺の事を見てるぜ・・・立っちゃうな。）")
                 (wait)))
               ((&& (== V 1) (== N 30))
                (<>
                 (text #:color 7 "【" 0 "】（太陽の光で、髪の毛がキラキラと光ってる・・・。）")
                 (wait)))
               ((&& (== V 1) (== N 24))
                (<>
                 (text #:color 7 "【" 0 "】（真子先生の首は・・・とってもセクシーだ。）")
                 (wait)))
               ((&& (== V 1) (== N 25))
                (<>
                 (text #:color 7 "【" 0 "】（赤いネクタイだな・・・青でも黄色でもピンクでもない。）")
                 (wait)))
               ((&& (== V 1) (== N 26))
                (<>
                 (text #:color 7 "【" 0 "】（うーん・・・。）")
               ...
               ((&& (== V 1) (== N 27))
                (<>
                 (text #:color 7 "【" 0 "】（真子先生だ・・・・奇麗な人だよ、まったく。）")
                 (wait)))
               ((&& (== V 1) (== N 28))
                (<>
                 (text #:color 7 "【" 0 "】（この手で・・・ナニをナニしてもらいたい。）")
                 (wait)))
               (else (<>)))))
 (set-arr~ @ 7 1))