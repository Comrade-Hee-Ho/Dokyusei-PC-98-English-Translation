(mes
 ...
 (dict #\・ #\【 #\】 #\い #\。 #\の #\舞 #\っ #\な #\、 #\か #\て #\ん #\う
  #\る #\た #\？ #\ら #\ゃ #\（ #\） #\あ #\は #\に #\わ #\ち #\し #\だ #\が
  #\君 #\と #\よ #\き #\！ #\で #\ど #\く #\も #\こ #\ろ #\人 #\ま #\女 #\子
  #\つ #\ょ #\先 #\ね #\さ)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 ...
 (while (== 1 1)
        (<>
         ...
         (cond ((== V 0)
               ...
               ((&& (== V 1) (== N 2))
                (<>
                 (text #:color 7 "【" 0 "】（健二のやつ・・・この髪に触れてないだろうな？）")
                 (wait)))
               ((&& (== V 1) (== N 3))
                (<>
               ...
               ((&& (== V 1) (== N 6) (== (: 18) 1))
                (<>
                 (text #:color 7 "【" 0 "】（舞ちゃんって・・・胸が大きいのかな？）")
                 (wait)))
               ((&& (== V 1) (== N 7) (== (: 19) 0))
                (<>
               ...
               ((&& (== V 1) (== N 8))
                (<>
                 (text #:color 7 "【" 0 "】（舞ちゃんって、セーラー服が似合うな・・・くるみちゃんも似合うけど。）")
                 (wait)))
               (else (<>)))))
 (set-arr~ @ 7 1))