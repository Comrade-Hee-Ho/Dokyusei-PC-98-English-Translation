(mes
 ...
 (dict #\・ #\な #\い #\【 #\】 #\だ #\。 #\の #\か #\が #\る #\太 #\郎 #\は
  #\も #\、 #\事 #\っ #\を #\と #\に #\た #\く #\う #\て #\？ #\ん #\ら #\よ
  #\し #\え #\言 #\れ #\こ #\女 #\行 #\僕 #\タ #\病 #\何 #\あ #\性 #\考 #\そ
  #\恋 #\じ #\ゃ #\け #\わ)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 ...
 (while (== 1 1)
        (<>
         ...
         (cond ((== V 0)
               ...
               ((&& (== V 1) (== N 9))
                (<>
                 (text #:color 5 "【太郎】髪の毛の話はもういい・・・そんな話をしても、僕のＩＱは高くならない。")
                 (wait)))
               ((&& (== V 1) (== N 10))
                (<>
               ...
               ((&& (== V 2) (== N 7) (== (: 18) 1))
                (<>
                 ...
                 (wait)
                 (text #:color 5 "【太郎】僕よりＩＱの低い君に何がわかる・・・２、３日もすれば彼女の事を考える事はなくなるだろう、きっと一時的な事だ。")
                 (wait)))
               (else (<>)))))
 (set-arr~ @ 7 1))