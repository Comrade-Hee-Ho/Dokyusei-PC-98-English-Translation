(mes
 ...
 (dict #\・ #\【 #\】 #\な #\い #\し #\っ #\て #\よ #\こ #\ん #\、 #\。 #\で
  #\に #\す #\た #\か #\だ #\を #\ら #\の #\生 #\！ #\が #\る #\？ #\は #\先
  #\う #\も #\ま #\れ #\さ #\く #\や #\事 #\あ #\と #\け #\言 #\君 #\き #\来
  #\ょ #\芹 #\沢 #\そ #\り #\え #\ー #\ゃ #\ぎ #\何 #\ち #\目 #\へ #\ぞ #\（
  #\） #\放 #\送 #\ど #\私 #\夏 #\み #\せ #\許 #\じ #\つ)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
        ...
        (<>
         ...
         (cond ((== V 0)
                (<>
                 ...
                 (cond ((&& (== N 1) (== (: 50) 0))
                        (<>
                         (text #:color 6 "【よしこ】待ちなさい・・・まだ話は終ってません。")
                         (wait)))
                       ((&& (== N 1) (== (: 50) 1))
                        (<>
                       ...
                       ((== N 2)
                        (<>
                         (text #:color 7 "【" 0 "】中に入るって・・・もう中に入ってるようなもんだな。")
                         (wait)))
                       ((== N 3)
                        (<>
                         (text #:color 7 "【" 0 "】もうちょっと、芹沢先生をからかってやるか・・・。")
                         (wait)))
                       (else (<>)))))
               ((&& (== V 2) (== N 1) (== (: 10) 0))
                (<>
                 ...
                 (wait)
                 (text #:color 6 "【よしこ】先生を侮辱したら許しませんよ・・・" 0 "君の事です、夏休みが終った時に何かが起こる仕掛けでも考えたんでしょ？")
                 (wait)
               ...
               ((&& (== V 2) (== N 1) (== (: 11) 0))
                (<>
                 ...
                 (wait)
                 (text #:color 6 "【よしこ】こんな時だけ『僕』なんて言っても駄目ですよ・・・真面目な生徒が体育祭のリレーで、逆方向に走り出しますか！？")
                 (wait)
                ...
                (<>
                 ...
                 (cond ((== N 1)
                        (<>
                         ...
                         (wait)
                         (text #:color 7 "【" 0 "】いいよ、許してくれなくても・・・許してくれなくても後悔しないくらい、すっごくいやらしい事をしちゃうぞ。")
                         (wait)
               ...
               ((&& (== V 1) (== N 4))
                (<>
                 (text #:color 7 "【" 0 "】（優しい顔をしてるんだけど・・・言う事がきついんだよ。）")
                 (wait)))
               ((&& (== V 1) (== N 5))
                (<>
