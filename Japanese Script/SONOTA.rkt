(mes
 ...
 (dict #\・ #\な #\【 #\】 #\い #\。 #\っ #\た #\の #\、 #\て #\か #\ん #\だ
  #\は #\る #\ら #\し #\う #\で #\と #\あ #\も #\を #\が #\事 #\ー #\け #\に
  #\よ #\ま #\れ #\や #\ち #\す #\ゃ #\く #\ぜ #\そ #\つ #\？ #\わ #\き #\ど
  #\女 #\見 #\ぞ #\思 #\生 #\ょ)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
                  ...
                  (<>
                   ...
                   (if-else (== (: 796) 1)
                            (<>
                             ...
                             (wait)
                             (text #:color 7 "【" 0 "】バイオリンの先生と生徒で、芝居をしてるって言ったけど・・・はっきり言ってアブノーマルだったぜ。")
                             (wait)
                             (text #:color 7 "【" 0 "】・・・。")
                             (wait)
                   ...
                   (if-else (== (: 802) 1)
                            (<>
                             ...
                             (wait)
                             (text #:color 7 "【" 0 "】モデルの女の子がかわいかった事は理解できるけど・・・芸術家の考える事はまったく理解できないな。")
                             (wait)
                   ...
                   (if-else (== (: 815) 1)
                            (<>
                             ...
                             (text #:color 7 "【" 0 "】・・・。")
                             (wait)
                             (text #:color 7 "【" 0 "】何が『柔道一直線弾き』な『亀甲縛り弾き』をアレンジしただよ・・・人の学校を使って、性的趣味を堪能するなよな。")
                             (wait)
