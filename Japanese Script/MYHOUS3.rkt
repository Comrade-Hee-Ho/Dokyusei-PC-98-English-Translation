(mes
 ...
 (dict #\・ #\【 #\】 #\る #\。 #\く #\な #\い #\み #\ん #\う #\っ #\だ #\か
  #\て #\に #\と #\の #\、 #\が #\し #\？ #\あ #\た #\は #\ら #\よ #\も #\す
  #\一 #\ち #\ゃ #\で #\を #\り #\哉 #\さ #\そ #\こ #\や #\れ #\わ #\ぜ #\じ
  #\ど #\ま #\私 #\君 #\行 #\事 #\け #\き #\ー #\相 #\話 #\え #\何 #\ょ #\お
  #\気 #\然 #\触)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 ...
 (while (== 1 1)
        (<>
         ...
         (cond ((== V 0)
               ...
               ((&& (== V 1) (== N 5))
                (<>
                 (text #:color 7 "【" 0 "】夏だと言うのになんて白い肌なんだ・・・うーん、逆に興奮しちゃうな。")
                 (wait)))
               ((&& (== V 1) (== N 6))
                (<>
               ...
               ((&& (== V 1) (== N 8))
                (<>
                 (text #:color 7 "【" 0 "】くるみちゃんだ・・・セーラー服を着てるな。")
                 (wait)))
               ((&& (== V 2) (== N 1) (== (: 11) 0))
                (<>
                 ...
                 (cond ((== N 1)
                       ...
                       ((== N 2)
                        (<>
                         ...
                         (wait)
                         (text #:color 7 "【" 0 "】ああ、あいつは昔から変態だったんだ・・・押入れの中に、三角木馬やムチやスケベ椅子が入ってるって噂だ。")
                         (wait)
