(mes
 ...
 (dict #\・ #\【 #\】 #\。 #\舞 #\い #\の #\な #\て #\、 #\っ #\君 #\ん #\し
  #\た #\と #\私 #\う #\ゃ #\ち #\か #\だ #\き #\に #\が #\？ #\ど #\も #\わ
  #\は #\る #\事 #\よ #\ら #\く #\け #\あ #\で #\ぁ #\言 #\ね #\好 #\を #\そ
  #\え #\れ #\思 #\つ #\俺 #\合)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
        ...
        (<>
         ...
         (if-else (== N 8)
                  (<>
                   ...
                   (cond ((< (: 111) 6)
                          (<>
                           (text #:color 3 "【舞】" 0 "君・・・屋上になんか呼び出したりして、私に何か用かしら？")
                           (wait)))
                         ((> (: 111) 5)
                          (<>
                           (text #:color 3 "【舞】" 0 "君どうしたの？・・・顔がいつもと違うみたい。")
                           (wait)))
                         (else (<>)))
                   ...
                   (cond ((< (: 111) 3)
                          (<>
                           ...
                           (text #:color 7 "【" 0 "】・・・。")
                           (wait)
                           (text #:color 3 "【舞】明日から学校でしょう？・・・私、" 0 "君と違うクラスになるように、先生にお願いしよとう思ってたの。")
                           (wait)
