(mes
 ...
 (dict #\・ #\な #\【 #\】 #\い #\か #\。 #\る #\ん #\だ #\一 #\哉 #\に #\う
  #\よ #\て #\っ #\た #\を #\、 #\？ #\し #\の #\ゃ #\病 #\あ #\そ #\は #\が
  #\ら #\く #\れ #\じ #\俺 #\と #\言 #\り #\前 #\で #\見 #\院 #\こ #\や #\け
  #\事 #\ど #\す #\ち #\性 #\コ #\ン #\も #\ー)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
        ...
        (<>
         ...
         (cond ((== V 0)
                (<>
                 ...
                 (cond ((&& (== N 1) (== (: 50) 0))
                        (<>
                         (text #:color 5 "【一哉】なんだよ・・・せっかく会ったんだから、もう少し話をしようぜ。")
                         (wait)))
                       ((&& (== N 1) (== (: 50) 1))
                        (<>
                         (text #:color 5 "【一哉】じゃあな・・・病院にかかるような、危ない遊びをするなよ。")
                         (wait)
                         (text #:color 7 "【" 0 "】へへっ！！俺様のポコチンは丈夫なんだよ・・・一哉こそ、汚い手でポコチンをいぢると、病気になっちゃうぜ。")
                         (wait)
                         (set-var N 6)
                         (slot 1 2)
                         (mes-jump "town1.mes")))
               ...
               ((&& (== V 2) (== N 1) (== (: 12) 0))
                (<>
                 ...
                 (set-arr~ @ 7 0)
                 (proc 18)
                 (menu-show (<.> (text "臭いをかぐ") (text "よく見る")
                             (text "試験紙を使う")))
                 (cond ((== N 1)
                        (<>
