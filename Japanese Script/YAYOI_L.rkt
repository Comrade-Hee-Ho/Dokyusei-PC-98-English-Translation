(mes
 ...
 (dict #\・ #\い #\ん #\【 #\】 #\。 #\、 #\や #\よ #\な #\さ #\で #\て #\っ
  #\た #\す #\あ #\の #\し #\ま #\事 #\き #\か #\ら #\そ #\だ #\私 #\と #\？
  #\に #\う #\め #\ど #\が #\れ #\く #\つ #\！ #\を #\も #\ご #\は #\じ #\け
  #\言 #\合 #\ゃ #\え #\せ #\ぁ #\ろ #\思 #\達 #\ね #\本 #\当 #\こ #\り)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 (set-arr~ @ 7 0)
                   ...
                   (cond ((< (: 116) 3)
                         ...
                         ((< (: 116) 16)
                          (<>
                           ...
                           (wait)
                           (text #:color 6 "【やよい】あなたの事を、ただの患者さんだと思ってましたけど・・・私、心のどこかで" 0 "さんの事を考えてました。")
                           (wait)
                           (text #:color 7 "【" 0 "】・・・。")
                           (wait)
                           ...
                           (wait)
                           (text #:color 6 "【やよい】じゃあ" 0 "さん、７時にここで待ってますから・・・ああ、なんだか身体がほてってきちゃいます。")
                           (wait)
