(mes
 ...
 (dict #\・ #\【 #\】 #\る #\。 #\ち #\は #\い #\、 #\ん #\て #\っ #\な #\た
  #\う #\の #\わ #\君 #\も #\ら #\が #\か #\あ #\そ #\と #\私 #\れ #\し #\！
  #\よ #\く #\？ #\で #\に #\だ #\ぁ #\ゃ #\事 #\つ #\き #\ま #\こ #\ど #\を
  #\一 #\言 #\す #\え #\俺 #\合 #\ね #\じ #\帰 #\達)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
        ...
        (<>
         ...
         (if-else (== N 12)
                  (<>
                   ...
                   (cond ((== (: 467) 0)
                          (<>
                           (text #:color 3 "【ちはる】" 0 "君・・・よくこの家がわかったわね。")
                           (wait)))
                         ((== (: 467) 1)
                          (<>
                   ...
                   (cond ((< (: 114) 3)
                          (<>
                           ...
                           (text #:color 7 "【" 0 "】か、彼氏！？")
                           (wait)
                           (text #:color 3 "【ちはる】あなたなんかと比べられない程、いい人なんだから・・・ああ、これ以上話をしてると馬鹿がうつりそう。")
                           (wait)
                         ...
                         ((< (: 114) 13)
                          (<>
                           ...
                           (wait)
                           (text #:color 3 "【ちはる】私と" 0 "君って、色々あったでしょ？・・・でも、冷静に考えたら、友達でいるのが一番いいかなって思ったの。")
                           (wait)
                           (text #:color 7 "【" 0 "】そ、そんなあ・・・。")
                           (wait)
                         ...
                         ((< (: 114) 16)
                          (<>
                           ...
                           (text #:color 7 "【" 0 "】ちはるちゃん・・・。")
                           (wait)
                           (text #:color 3 "【ちはる】でも私、" 0 "君の家をちゃんと知らなかったし・・・このままになったらどうしようかと思って。")
                           (wait)
                           (text #:color 7 "【" 0 "】・・・。")
                           (wait)
