(mes
 ...
 (dict #\・ #\【 #\】 #\。 #\い #\な #\っ #\の #\、 #\は #\美 #\穂 #\だ #\ん
  #\て #\う #\る #\に #\た #\あ #\（ #\） #\し #\か #\す #\が #\を #\ら #\も
  #\く #\と #\そ #\で #\ゃ #\れ #\君 #\ち #\？ #\よ #\！ #\こ #\ま #\俺 #\き
  #\じ #\り #\ー #\め #\太 #\わ #\お #\ね #\郎 #\ど #\ぜ #\ッ #\え #\見 #\け
  #\や #\初 #\テ #\ル #\ト #\ス #\着 #\ろ #\女 #\さ #\下 #\脱 #\ホ #\ょ #\ば
  #\ン #\入 #\み #\事 #\大 #\ブ #\感 #\び #\指 #\男 #\ウ #\ず #\言 #\ご #\ぞ
  #\私 #\ラ #\部 #\濡 #\彼 #\タ #\ロ #\来 #\場 #\キ #\デ #\中 #\マ #\一 #\つ
  #\ぐ #\身 #\触 #\ビ #\ア #\間 #\帰 #\べ #\チ #\０ #\合 #\出 #\ベ #\上 #\リ)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 (set-arr~ @ 7 0)
 ...
 (if (== (: 710) 0)
     (<>
      ...
      (wait)
      (text #:color 5 "【太郎】僕は君達が話してるのを、ずっと見てたんだ・・・あんな夜中に男女が会話をするなんて、それだけでも不純だと言うのに・・・。")
      (wait)
         ...
         (cond ((== V 0)
                (<>
                 ...
                 (cond ((&& (== N 1) (== (: 10) 0))
                       ...
                       ((&& (== N 1) (== (: 10) 1))
                        (<>
                         (text #:color 7 "【" 0 "】（俺は煩悩に生きる" 0 "だぜ・・・帰るわけがないだろ？）")
                         (wait)))
                       (else (<>)))))
               ((&& (== V 2) (== N 1) (== (: 11) 0))
                (<>
                 (text #:color 6 "【美穂】ねえねえ、" 0 "君も一緒に座ろ。")
                 (wait)
                 (set-reg: 11 1)))
               ((&& (== V 2) (== N 1) (== (: 11) 1))
                (<>
               ...
               ((&& (== V 2) (== N 1) (== (: 11) 5))
                (<>
                 ...
                 (set-arr~ @ 7 0)
                 (proc 18)
                 (menu-show (<.> (text "鼻血が出る")
                             (text "やはり濡れる") (text "逆に乾く")
                             (text "伸び縮みする")))
                 (cond ((== N 1)
                        (<>
               ...
               ((&& (== V 2) (== N 1) (== (: 11) 6))
                (<>
                 ...
                 (wait)
                 (text #:color 7 "彼女の肌はまるで子供のようになめらかだった・・・うぶ毛すら生えてないように見えるその肌は、うっすらと汗ばんでいる。")
                 (wait)
                 (text #:color 6 "【美穂】" 0 "・・・君。")
                 (wait)
                 ...
                 (text #:color 6 "【美穂】あ・・・。")
                 (wait)
                 (text #:color 7 "ブラの隙間から手を入れようとすると、彼女の顔がいやいやをする・・・俺はその表情を見て、少しいじわるをしたくなってきた。")
                 (wait)
                 (text #:color 6 "【美穂】" 0 "君・・・どうしたの？")
                 (wait)
                 (text #:color 7 "俺は美穂の背後に回り、そのつき出されたお尻を見ている・・・お尻も胸と同じように小さく、まだ大人になりきってない感じだ。")
                 (wait)
                 ...
                 (wait)
                 (text #:color 7 "俺の指は、ゆっくりと割れ目にそって下がっていく・・・それまで固かった指の感触が、いきなり柔らかく暖かい感触に変わる。")
                 (wait)
                 (text #:color 6 "【美穂】い・・・や。")
                 (wait)
               ...
               ((&& (== V 1) (== N 3) (== (: 13) 1))
                (<>
                 (text #:color 7 "【" 0 "】（うーん、ギネスブックに載りそうだ・・・。）")
                 (wait)))
               ((&& (== V 1) (== N 4) (== (: 14) 0))
                (<>
                 (text #:color 7 "【" 0 "】（あまり大きくないな・・・。）")
                 (wait)
                 (set-reg: 14 1)))
               ((&& (== V 1) (== N 4) (== (: 14) 1))
                (<>
                 (text #:color 7 "【" 0 "】（７８センチと見たぞ・・・。）")
                 (wait)))
               ((&& (== V 1) (== N 5) (== (: 15) 0))
                (<>
               ...
               ((&& (== V 1) (== N 5) (== (: 15) 1))
                (<>
                 (text #:color 7 "【" 0 "】（色っぽいと言うより、なんだかかわいいって感じだぜ。）")
                 (wait)))
               ((&& (== V 1) (== N 6) (== (: 16) 0))
                (<>
               ...
               ((&& (== V 1) (== N 19) (== (: 20) 1))
                (<>
                 (text #:color 7 "【" 0 "】（何も飲みたくないし・・・飲んでる暇もない。）")
                 (wait)))
               ((&& (== V 1) (== N 20) (== (: 21) 0))
                (<>
