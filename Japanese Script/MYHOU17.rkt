(mes
 ...
 (dict #\・ #\【 #\】 #\。 #\い #\二 #\っ #\健 #\な #\だ #\る #\は #\の #\ら
  #\か #\き #\あ #\め #\ふ #\、 #\う #\て #\舞 #\？ #\よ #\た #\に #\も #\や
  #\わ #\ろ #\で #\が #\れ #\そ #\ん #\く #\ぜ #\を #\僕 #\ま #\事 #\こ #\と)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 (set-arr~ @ 7 0)
         ...
         (cond ((== V 0)
                (<>
                 ...
                 (cond ((&& (== N 1) (== (: 50) 0))
                       ...
                       ((&& (== N 3) (== (: 50) 0))
                        (<>
                         (text #:color 4 "【健二】ふっ・・・もう行っていいぞ。")
                         (wait)))
                       ((&& (== N 3) (== (: 50) 1))
                        (<>
                         (text #:color 4 "【健二】ふっ・・・決着をつけよう。")
                         (wait)))
                       (else (<>)))))
               ((&& (== V 2) (== N 1) (== (: 10) 0))
                (<>
               ...
               ((&& (== V 2) (== N 1) (== (: 50) 1) (== (: 49) 0))
                (<>
                 (text #:color 4 "【健二】これで決着がついた訳だ・・・二度と舞に近づくなよ。")
                 (wait)))
               ((&& (== V 2) (== N 1) (== (: 10) 2))
                (<>
               ...
               ((&& (== V 3) (== N 3))
                (<>
                 (text #:color 4 "【健二】今日は大人の話合いのはずだ・・・ふっ。")
                 (wait)))
               ((&& (== V 1) (== N 4))
                (<>
                 (text #:color 4 "【健二】言っておくが、ウォリーじゃないぞ。")
                 (wait)))
               ((&& (== V 1) (== N 5))
                (<>
                 (text #:color 4 "【健二】舞も、このセーターは気に入ってるんだ・・・うらやましいだろ？")
                 (wait)))
               ((&& (== V 1) (== N 6))
                (<>
