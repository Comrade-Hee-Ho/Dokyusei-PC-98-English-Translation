(mes
 ...
 (dict #\・ #\【 #\】 #\。 #\い #\な #\の #\だ #\っ #\て #\か #\る #\ん #\、
  #\は #\！ #\よ #\ゃ #\に #\う #\こ #\ま #\？ #\じ #\を #\れ #\が #\た #\も
  #\あ #\と #\日 #\ら #\く #\美 #\ぞ #\し #\で #\一 #\声 #\そ #\さ #\彼 #\閉
  #\ぜ #\哉 #\ど #\女 #\ち #\神 #\開 #\げ #\俺 #\何 #\け #\沙 #\今 #\お #\前
  #\り #\ひ #\教 #\室 #\ト #\健 #\二 #\や #\穂)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
         ...
         (cond ((&& (> V 0) (> H 830))
               ...
               ((&& (== V 104) (== (: 483) 1) (== (: 493) 0) (== (: 514) 0))
                (<>
                 ...
                 (wait)
                 (text #:color 5 "【一哉】気味の悪い笑い方をするな・・・ちょくちょく会ってるけど、まだまだだな・・・彼女は俺の事を『彼氏』だと思ってない。")
                 (wait)
                 ...
                 (slot 1 3)
                 (mes-jump "gakko2.mes")))
               ((&& (== V 104) (== (: 668) 1) (> H 825) (== (: 674) 0)
                 (== (: 672) 0))
                (<> (slot 1 3) (mes-jump "souko1.mes")))
               ((&& (== V 104) (== (: 695) 1) (> H 820) (== (: 701) 0)
                 (== (: 708) 0))
                (<>
                 (set-arr~ @ 7 1)
                 (set-arr~ @ 1 4096)
