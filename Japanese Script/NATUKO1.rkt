(mes
 ...
 (dict #\・ #\【 #\】 #\。 #\子 #\い #\夏 #\て #\な #\の #\っ #\ん #\、 #\か
  #\に #\う #\く #\る #\だ #\た #\？ #\し #\ら #\こ #\よ #\さ #\も #\（ #\）
  #\わ #\あ #\が #\き #\は #\と #\ま #\そ #\君 #\で #\を #\お #\り #\痛 #\す
  #\め #\俺 #\ゃ #\目 #\れ #\！ #\ど #\腹 #\じ #\や #\ベ #\ッ #\ト #\ち #\ね
  #\下)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
         ...
         (cond ((== V 0)
               ...
               ((&& (== V 1) (== N 3) (== (: 21) 1))
                (<>
                 ...
                 (wait)
                 (text #:color 7 "【" 0 "】（こんな奇麗な人の部屋にいて、なおかつベットに横になっていて、その上至近距離で見つめ合ってるなんて・・・うーん、信じられないな。）")
                 (wait)))
               ((&& (== V 1) (== N 4) (== (: 22) 0))
                (<>
               ...
               ((&& (== V 1) (== N 5) (== (: 23) 1))
                (<>
                 (text #:color 7 "【" 0 "】（夏子さんの胸のふくらみが・・・俺の腕に当たってる。）")
                 (wait)))
               (else (<>)))))
 (set-arr~ @ 7 1))