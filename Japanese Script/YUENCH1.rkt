(mes
 ...
 (dict #\・ #\い #\【 #\】 #\。 #\な #\子 #\っ #\、 #\夏 #\ん #\て #\だ #\の
  #\う #\に #\は #\？ #\る #\し #\ー #\た #\と #\が #\か #\よ #\（ #\） #\！
  #\ら #\さ #\も #\を #\こ #\あ #\君 #\ち #\そ #\れ #\ル #\じ #\ゃ #\き #\ン
  #\プ #\け #\ど #\ま #\で #\え #\く #\わ #\お #\着 #\見 #\り #\ね #\つ #\遊
  #\事 #\ぜ #\日 #\姿 #\言 #\人 #\気 #\み #\園 #\地 #\何 #\ぶ #\女 #\水 #\ろ
  #\や #\ス #\私 #\行 #\ラ #\ジ #\リ #\乗)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 ...
 (while (== 1 1)
        (<>
         ...
         (cond ((== V 0)
               ...
               ((&& (== V 1) (== N 3) (== (: 12) 1))
                (<>
                 (text #:color 2 "【夏子】" 0 "君、私の髪に何かついてるの？")
                 (wait)))
               ((&& (== V 1) (== N 4) (== (: 13) 0))
                (<>
                 (text #:color 7 "【" 0 "】（夏子さんだ・・・俺はデートしてるんだぜ。）")
                 (wait)))
               ((&& (== V 1) (== N 4) (== (: 13) 1))
                (<>
               ...
               ((&& (== V 1) (== N 5) (== (: 14) 1))
                (<>
                 (text #:color 7 "【" 0 "】（水着を着れば、もっと胸が見えるはずだ・・・ひっひっひっ。）")
                 (wait)))
               ((&& (== V 1) (== N 6) (== (: 15) 0))
                (<>
               ...
               ((&& (== V 1) (== N 1) (== (: 20) 1))
                (<>
                 (text #:color 7 "【" 0 "】（メリーゴーランドだな・・・子供の頃に乗った記憶がある。）")
                 (wait)))
               ((&& (== V 1) (== N 12) (== (: 21) 0))
                (<>
               ...
               ((&& (== V 1) (== N 12))
                (<>
                 (text #:color 7 "【" 0 "】（げげっ！！・・・空中で止まってるぜ、故障してるのか？）")
                 (wait)))
               ((&& (== V 1) (== N 13) (== (: 22) 0))
                (<>
               ...
               ((&& (== V 1) (== N 17))
                (<>
                 (text #:color 7 "【" 0 "】（遊園地だな・・・女の子が大好きな場所だぜ。）")
                 (wait)))
               ((&& (== V 1) (== N 18) (== (: 27) 0))
                (<>
               ...
               ((&& (== V 1) (== N 18))
                (<>
                 (text #:color 7 "【" 0 "】（観覧車だ・・・自慢じゃないが、俺は高い所が苦手なんだ。）")
                 (wait)))
               ((&& (== V 1) (== (: 25) 0))
                (<>
                 (text #:color 2 "【夏子】いい天気ね・・・気持ちがいいわ。")
