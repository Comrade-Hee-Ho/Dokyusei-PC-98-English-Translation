(mes
 ...
 (dict #\・ #\【 #\】 #\。 #\い #\、 #\お #\ん #\ー #\っ #\０ #\あ #\！ #\は
  #\で #\な #\さ #\か #\て #\人 #\す #\ら #\ま #\う #\の #\し #\枚 #\ね #\ゃ
  #\り #\が #\２ #\大 #\子 #\？ #\た #\に #\れ #\入 #\（ #\） #\だ #\円 #\よ
  #\じ #\も #\１ #\と #\夏 #\５ #\舞 #\わ #\ち #\君 #\ど #\園 #\を #\せ #\払
  #\く #\ご #\る #\秘 #\書 #\供 #\私 #\美 #\や #\遊 #\金 #\乗 #\様 #\こ #\中
  #\料 #\俺 #\地 #\そ #\ば #\ろ #\場 #\め #\ょ #\出)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
         ...
         (cond ((&& (== V 126) (> T 1700))
               ...
               ((&& (== V 126) (== (: 746) 1) (== (: 762) 0))
                (<>
                 ...
                 (wait)
                 (text #:color 6 "【美人秘書】ここはお父様がご所有の遊園地じゃないですか・・・お嬢様がお金を払うなんて、私が叱られてしまいます。")
                 (wait)
                 (set-arr~ @ 13 15 322 64 391)
                 (color 8)
                 (clear)
                 ...
                 (cond ((== N 1)
                       ...
                       ((== N 3)
                        (<>
                         ...
                         (color 8)
                         (clear)
                         (text #:color 3 "【おねーさん】大人１００枚ですと、たったの２５万円でーす・・・キャッシュですか、それともカードでお支払いになりますかあ？")
                         (wait)
                         (set-arr~ @ 13 15 322 64 391)
                         (color 8)
                         (clear)
                       ...
                       ((== N 5)
                        (<>
                         (text #:color 7 "【" 0 "】やーめたっ！！一人で来てもつまらないもんなっ！！")
                         (wait)))
                       (else (<>)))
                 (break)))
               (else (<>)))))
