(mes
 ...
 (dict #\・ #\か #\【 #\】 #\な #\り #\お #\い #\。 #\っ #\、 #\し #\て #\う
  #\に #\ん #\は #\る #\よ #\の #\く #\だ #\と #\た #\ら #\君 #\そ #\が #\？
  #\を #\れ #\あ #\こ #\ゃ #\わ #\ま #\も #\気 #\や #\さ #\ち #\人 #\ど #\病)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 (set-arr~ @ 7 0)
         ...
         (cond ((== V 0)
               ...
               ((&& (== V 2) (== N 1) (== (: 10) 1))
                (<>
                 ...
                 (wait)
                 (text #:color 7 "【" 0 "】俺はどこも悪くないってば・・・かおりさんこそ、歳をとると慢性化しやすいから、きっちり治した方がいいぜ。")
                 (wait)
               ...
               ((&& (== V 2) (== N 1) (== (: 10) 2))
                (<>
                 (text #:color 6 "【かおり】" 0 "君が病院に入るのを、見届けてあげる。")
                 (wait)))
               ((&& (== V 1) (== N 2))
                (<>
               ...
               ((&& (== V 1) (== N 6))
                (<>
                 (text #:color 6 "【かおり】いいの、私には似合っているんだから。")
                 (wait)))
               ((&& (== V 1) (== N 7))
                (<>
