(mes
  ...
  (<>
   ...
   (while (!= J 6)
          (<>
           (if-else (== I 0)
                    (<>
                     (blit (+ 40 (* 10 2)) 105 (+ 40 (* 10 2) 1) 122 3
                      (- (+ 67 10) (* J 2)) 370 0)
                     (set-var I (/ I 10))
                     (break))
                    (<>
                     (blit (+ 40 (* (% I 10) 2)) 105 (+ 40 (* (% I 10) 2) 1)
                      122 3 (- (+ 67 10) (* J 2)) 370 0)
                     (set-var I (/ I 10))))
           (set-var J (+ J 1))))
   (blit (+ 40 (* (/ H 100) 2)) 130 (+ 40 (* (/ H 100) 2) 1) 147 3 3 328 0)
   (blit (+ 40 (* (/ (% H 100) 10) 2)) 130 (+ 40 (* (/ (% H 100) 10) 2) 1) 147
    3 7 328 0)
   (blit (+ 40 (* (% (% H 100) 10) 2)) 130 (+ 40 (* (% (% H 100) 10) 2) 1) 147
    3 9 328 0)
   (blit (* (% E 4) 12) (* (/ E 4) 40) (+ (* (% E 4) 12) 11)
    (+ (* (/ E 4) 40) 37) 3 1 349 0)
   (set-var I (/ T 100 12))
   ...
   (if-else (== I 0)
            (<> (set-var I (/ T 100)))
            (<> (set-var I (- (/ T 100) 12))))
   (blit (+ 42 (* (/ I 10) 2)) 40 (+ 42 (* (/ I 10) 2) 1) (+ 40 37) 3 69 328 0)
   (blit (+ 42 (* (% I 10) 2)) 40 (+ 42 (* (% I 10) 2) 1) (+ 40 37) 3 71 328 0)
   (blit 40 40 41 (+ 40 37) 3 73 328 0)
   (set-var I (% T 100))
   (blit (+ 42 (* (/ I 10) 2)) 40 (+ 42 (* (/ I 10) 2) 1) (+ 40 37) 3 75 328 0)
   (blit (+ 42 (* (% I 10) 2)) 40 (+ 42 (* (% I 10) 2) 1) (+ 40 37) 3 77 328 0)
   (set-arr~ @ 20 (+ (&& (~ @ 20) 65280) 0))
   (set-arr~ @ 21 (+ 512 16))
   (set-arr~ @ 20 (// (&& (~ @ 20) 65399) 128))
   (set-arr~ @ 20 (&& (~ @ 20) 4095))
 ...
 (define-proc 15
  (<>
   ...
   (while (!= I (/ (~ @ 97) 2))
          (<>
           (blit (~ @ 94) (+ (~ @ 95) (* I 2)) (- (+ (~ @ 94) (~ @ 96)) 1)
            (+ (~ @ 95) (* I 2)) 1 (~ @ 94) (+ (~ @ 95) (* I 2)) 0)
           (blit (~ @ 94) (- (+ (~ @ 95) (* (/ (~ @ 97) 2) 2)) 1 (* I 2))
            (- (+ (~ @ 94) (~ @ 96)) 1)
            (- (+ (~ @ 95) (* (/ (~ @ 97) 2) 2)) 1 (* I 2)) 1 (~ @ 94)
            (- (+ (~ @ 95) (* (/ (~ @ 97) 2) 2)) 1 (* I 2)) 0)
           (set-var I (+ I 1))))
   (if (== (&& (~ @ 97) 1) 1)
       (<>
        (blit (~ @ 94) (- (+ (~ @ 95) (~ @ 97)) 1) (- (+ (~ @ 94) (~ @ 96)) 1)
         (- (+ (~ @ 95) (~ @ 97)) 1) 1 (~ @ 94) (- (+ (~ @ 95) (~ @ 97)) 1) 0)))
   (set-arr~ @ 6 0)))
 (define-proc 16
  (<>
   (proc 14)
   ...
   (while (!= I (/ (~ @ 97) 2))
          (<>
           (blit-mask (~ @ 94) (+ (~ @ 95) (* I 2)) (- (+ (~ @ 94) (~ @ 96)) 1)
            (+ (~ @ 95) (* I 2)) 1 (~ @ 94) (+ (~ @ 95) (* I 2)) 0)
           (blit-mask (~ @ 94) (- (+ (~ @ 95) (* (/ (~ @ 97) 2) 2)) 1 (* I 2))
            (- (+ (~ @ 94) (~ @ 96)) 1)
            (- (+ (~ @ 95) (* (/ (~ @ 97) 2) 2)) 1 (* I 2)) 1 (~ @ 94)
            (- (+ (~ @ 95) (* (/ (~ @ 97) 2) 2)) 1 (* I 2)) 0)
           (set-var I (+ I 1))))
   (if (== (&& (~ @ 97) 1) 1)
       (<>
        (blit-mask (~ @ 94) (- (+ (~ @ 95) (~ @ 97)) 1)
         (- (+ (~ @ 94) (~ @ 96)) 1) (- (+ (~ @ 95) (~ @ 97)) 1) 1 (~ @ 94)
         (- (+ (~ @ 95) (~ @ 97)) 1) 0)))
   (set-arr~ @ 6 0)))
 (define-proc 17
  (<>
   ...
   (define-proc 38
    (<>
     ...
     (set-arr~ @ 13 15 322 64 391)
     (clear)
     (text #:color 7 "アイコンで画面をクリックしてください。")
     (set-arr~ @ 23 65280)
     (set-arr~ @ 13 33 295 46 311)
     (color 7)
     (clear)
  ...
  (<>
   (define-proc 30
    (<>
     ...
     (color 112)
     (set-var I (~ @ 23))
     (box-inv (+ 10 (* (: 101) 46)) (+ (* I 16) 8 8) (+ 23 (* (: 101) 46))
      (+ (* I 16) 23 8))
     (mouse 0)))
   (define-proc 31
    (<>
            ...
            (<>
             ...
             (if-else (== (: 1002) 0)
                      (<>
                       ...
                       (blit-mask 0 136 15 151 3 (- (+ 10 (* (: 101) 46)) 1)
                        (+ (* I 16) 8 8) 0))
                      (<>
                       (set-arr~ @ 6 3)
                       (color 7)
                       ...
                       (blit 0 136 15 151 3 (- (+ 10 (* (: 101) 46)) 1)
                        (+ (* I 16) 8 8) 0)))
             (set-var I (+ I 1))))
     (if-else (> (~ @ 26) 10)
              (<>
               (blit-mask (+ 0 16) 128 (+ 15 16) 135 3 (+ 9 (* (: 101) 46))
                (+ (* I 16) 8 8) 0))
              (<>
               (blit-mask 0 128 15 135 3 (+ 9 (* (: 101) 46)) (+ (* I 16) 8 8)
                0)))
     (set-arr~ @ 6 0)
     (color 112)
     (set-arr~ @ 23 0)))
    ...
    (<>
     ...
     (while (!= I 10)
            (<>
             (set-var J (~ @ 22))
             (if (&& (> X (* (+ 9 (* (: 101) 46)) 8))
                  (< X (* (+ 24 (* (: 101) 46)) 8)) (> Y (+ (* I 16) 8 8))
                  (< Y (+ (* I 16) 23 8)) (!= (~ J (+ (* I 2) 1)) 0))
                 (<> (set-var K I) (break)))
             (set-var I (+ I 1))))
     (if (&& (!= K 65535) (!= (~ @ 23) K))
