(mes
 ...
 (dict #\・ #\い #\ん #\【 #\】 #\な #\よ #\。 #\や #\で #\っ #\、 #\さ #\か
  #\は #\う #\の #\あ #\す #\ら #\た #\に #\て #\？ #\そ #\だ #\る #\こ #\が
  #\し #\ど #\ま #\り #\く #\（ #\） #\！)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
         ...
         (cond ((== V 0)
               ...
               ((&& (== V 2) (== N 1) (== (: 10) 0))
                (<>
                 ...
                 (set-arr~ @ 7 0)
                 (proc 18)
                 (menu-show (<.> (text "スケこまし")
                             (text "ただの学生") (text "素直な青年")))
                 (cond ((== N 1)
                        (<>
               ...
               ((&& (== V 1) (== N 2))
                (<>
                 (text #:color 7 "【" 0 "】（ああ・・・やよいさんの顔を見てると、ぴゅっといってしまいそうだ。）")
                 (wait)))
               ((&& (== V 1) (== N 3))
                (<>
                 (text #:color 7 "【" 0 "】（柔らかい髪が、そよ風に揺れている・・・。）")
                 (wait)))
               ((&& (== V 1) (== N 4))
                (<>
                 (text #:color 7 "【" 0 "】（奇麗な肌・・・ああ、やよいさんの事が好きになりそうだ。）")
                 (wait)))
               ((&& (== V 1) (== N 5))
                (<>
                 (text #:color 7 "【" 0 "】（大きかったよな・・・うんうん。）")
                 (wait)))
               ((&& (== V 1) (== N 6))
                (<>
                 (text #:color 7 "【" 0 "】（やよいさんの私服姿もいいな・・・大人の女性だぜ。）")
                 (wait)))
               (else (<>)))))
 (set-arr~ @ 7 1))