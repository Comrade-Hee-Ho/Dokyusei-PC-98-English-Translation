(mes
 ...
 (dict #\・ #\【 #\】 #\か #\い #\。 #\お #\り #\な #\、 #\っ #\の #\た #\て
  #\わ #\ー #\し #\だ #\う #\ん #\よ #\ら #\あ #\は #\ゃ #\？ #\ま #\も #\ね
  #\る #\が #\で #\さ #\ち #\バ #\ン #\じ #\に #\と #\そ #\テ #\せ #\君 #\を
  #\私 #\え #\飲 #\れ #\！ #\ス #\事 #\や #\合 #\待)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
        ...
        (<>
         ...
         (cond ((== V 0)
                (<>
                 ...
                 (cond ((&& (== N 1) (== (: 50) 0))
                        (<>
                         (text #:color 6 "【かおり】まだいいじゃない・・・私の友達はまだ来てないの。")
                         (wait)))
                       ((&& (== N 1) (== (: 50) 1))
                        (<>
                       ...
                       ((== N 2)
                        (<>
                         (text #:color 6 "【かおり】友達が来るまで、つき合ってよ・・・一人で飲んでても暇だし。")
                         (wait)))
                       (else (<>)))))
               ((&& (== V 2) (== N 1) (== (: 10) 0))
                (<>
               ...
               ((&& (== V 1) (== N 8))
                (<>
                 (text #:color 6 "【かおり】" 0 "君は未成年でしょ？・・・あげないわよ。")
                 (wait)))
               ((&& (== V 1) (== N 9))
                (<>
