(mes
 ...
 (dict #\・ #\い #\【 #\】 #\。 #\な #\よ #\や #\ん #\っ #\か #\は #\の #\、
  #\て #\う #\る #\で #\す #\ら #\し #\だ #\た #\が #\ま #\こ #\あ #\も #\に
  #\そ #\ど #\さ #\（ #\） #\を #\と #\？ #\り #\く #\き #\れ #\女 #\え #\わ
  #\俺 #\け #\ン #\ゃ #\じ #\せ #\ー #\彼 #\め #\ね #\事 #\痛 #\性 #\足 #\ば
  #\ポ #\大 #\見 #\言 #\ち #\ょ #\イ #\ぎ #\精 #\直 #\違 #\み #\ビ #\者 #\人
  #\廊 #\下 #\走 #\音 #\聞 #\不 #\ス #\つ #\ろ #\テ #\物)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 (set-arr~ @ 7 0)
 ...
 (while (== 1 1)
        (<>
         ...
         (cond ((== V 0)
               ...
               ((&& (== V 1) (== N 2) (== (: 12) 1))
                (<>
                 (text #:color 7 "【" 0 "】（彼女は・・・どこを見てるんだ？）")
                 (wait)))
               ((&& (== V 1) (== N 3) (== (: 13) 0))
                (<>
                 (text #:color 7 "【" 0 "】（ナースハットがかわいい・・・。）")
                 (wait)
                 (set-reg: 13 1)))
               ((&& (== V 1) (== N 3) (== (: 13) 1))
                (<>
                 (text #:color 7 "【" 0 "】（奇麗な髪だな・・・触れてみたいけど、この格好じゃ無理だ。）")
                 (wait)))
               ((&& (== V 1) (== N 4) (== (: 14) 0))
                (<>
               ...
               ((&& (== V 1) (== N 4) (== (: 14) 1))
                (<>
                 (text #:color 7 "【" 0 "】（夏は女性の肌が露出する・・・いい季節だな。）")
                 (wait)))
               ((&& (== V 1) (== N 5) (== (: 15) 0))
                (<>
                 (text #:color 7 "【" 0 "】（大きいよ・・・絶対に。）")
                 (wait)
                 (set-reg: 15 1)))
               ((&& (== V 1) (== N 5) (== (: 15) 1))
                (<>
                 (text #:color 7 "【" 0 "】（なんか重そうに見えるほど大きいな・・・肩がこらないのかな？）")
                 (wait)))
               ((&& (== V 1) (== N 6) (== (: 16) 0))
                (<>
                 (text #:color 7 "【" 0 "】（・・・。）")
               ...
               ((&& (== V 1) (== N 7) (== (: 17) 1))
                (<>
                 (text #:color 7 "【" 0 "】（彼女は・・・俺のここを見ても、興奮しないのだろうか？）")
                 (wait)))
               ((&& (== V 1) (== N 8) (== (: 18) 0))
                (<>
                 (text #:color 7 "【" 0 "】（悪いね、これは俺様の足だ・・・。）")
                 (wait)
                 (set-reg: 18 1)))
               ((&& (== V 1) (== N 8) (== (: 18) 1))
                (<>
                 (text #:color 7 "【" 0 "】（だから俺の足だってば・・・。）")
                 (wait)))
               ((&& (== V 1) (== N 9) (== (: 19) 0))
                (<>
