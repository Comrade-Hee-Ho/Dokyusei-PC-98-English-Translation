(mes
 ...
 (dict #\・ #\【 #\】 #\な #\い #\。 #\だ #\太 #\郎 #\、 #\は #\う #\ん #\に
  #\の #\っ #\る #\て #\た #\か #\が #\も #\よ #\あ #\こ #\！ #\し #\と #\マ
  #\ら #\？ #\事 #\ろ #\ロ #\言 #\ま #\ウ #\え #\く #\ゃ #\君 #\す #\き #\じ
  #\を #\れ #\僕 #\タ #\行 #\ぞ #\そ #\ど #\お #\前 #\所 #\さ #\り #\で #\ょ)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 (set-arr~ @ 7 0)
 ...
 (while (== 1 1)
        (<>
         ...
         (cond ((== V 0)
               ...
               ((&& (== V 1) (== N 9))
                (<>
                 (text #:color 5 "【太郎】僕は髪の毛の話をしに来た訳じゃない。")
                 (wait)))
               ((&& (== V 1) (== N 10))
                (<>
                 (text #:color 5 "【太郎】メガネは視力を矯正する道具だ・・・そんな事も知らないのか？")
                 (wait)))
               ((&& (== V 1) (== N 11))
                (<>
