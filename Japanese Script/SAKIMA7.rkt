(mes
 ...
 (dict #\・ #\【 #\】 #\い #\。 #\っ #\子 #\な #\ん #\亜 #\た #\、 #\う #\か
  #\て #\だ #\は #\の #\し #\わ #\あ #\も #\？ #\ね #\ら #\え #\よ #\さ #\れ
  #\に #\が #\で #\を #\と #\ど #\る #\買 #\ま #\何 #\ゃ #\け #\ば #\言 #\真
  #\く #\！ #\君 #\そ #\姉 #\ち #\事 #\俺 #\ょ #\（ #\）)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 ...
 (while (== 1 1)
        (<>
         ...
         (cond ((== V 0)
               ...
               ((&& (== V 1) (== N 3))
                (<>
                 (text #:color 7 "【" 0 "】（髪だけが、グルグル回りそうだ・・・ははは。）")
                 (wait)))
               ((&& (== V 1) (== N 4))
                (<>
                 (text #:color 7 "【" 0 "】（でかいんだよ、これが・・・見た事はないけど。）")
                 (wait)))
               ((&& (== V 1) (== N 5))
                (<>
