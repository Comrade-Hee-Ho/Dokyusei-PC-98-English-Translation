(mes
 ...
 (dict #\・ #\【 #\】 #\な #\い #\。 #\だ #\る #\、 #\太 #\の #\郎 #\て #\ん
  #\う #\は #\っ #\し #\か #\く #\が #\や #\よ #\に #\す #\ら #\も #\あ #\じ
  #\を #\ま #\え #\事 #\そ #\ゃ #\た #\マ #\タ #\ロ #\ウ #\？ #\で #\女 #\と
  #\ど #\き #\君 #\ぞ #\考 #\つ #\り #\れ #\頭)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
         ...
         (cond ((== V 0)
                (<>
                 ...
                 (cond ((== N 1)
                       ...
                       ((== N 2)
                        (<>
                         (text #:color 7 "【" 0 "】いやだよ・・・一人で公園に入っても、ちっとも楽しくない。")
                         (wait)))
                       ((== N 3)
                        (<>
               ...
               ((&& (== V 2) (== N 7) (== (: 18) 2))
                (<>
                 (text #:color 5 "【太郎】散歩の時間はおしまいだ・・・帰るとするか。")
                 (wait)))
               (else (<>)))))
 (set-arr~ @ 7 1))