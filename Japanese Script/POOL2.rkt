(mes
 ...
 (dict #\・ #\【 #\】 #\い #\っ #\。 #\な #\て #\舞 #\、 #\ん #\う #\の #\る
  #\だ #\し #\は #\か #\？ #\が #\た #\と #\！ #\に #\ち #\ゃ #\ら #\よ #\れ
  #\も #\あ #\を #\で #\や #\事 #\そ #\え #\く #\け #\ま #\わ #\さ #\君 #\り
  #\ー #\お #\水 #\ね #\こ #\言 #\習 #\き #\部 #\ル #\道 #\す #\ど #\俺 #\（
  #\） #\泳 #\ょ #\ぐ #\じ #\ク #\特 #\別 #\私 #\み #\色 #\シ #\ン #\イ #\見
  #\一 #\入 #\め #\時 #\間 #\所 #\日 #\ろ #\つ #\度 #\タ #\ぞ #\リ #\話 #\プ
  #\ば #\通 #\グ #\虎 #\穴 #\華 #\ふ #\何 #\着)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
         ...
         (cond ((== V 0)
                (<>
                 ...
                 (cond ((&& (== N 1) (== (: 50) 0))
                       ...
                       ((== N 3)
                        (<>
                         (text #:color 7 "【" 0 "】まだ舞ちゃんと話がしたい・・・ここにいようぜ。")
                         (wait)))
                       (else (<>)))))
               ((&& (== V 2) (== N 1) (== (: 10) 0))
                (<>
                 ...
                 (cond ((== N 1)
                        (<>
                         ...
                         (wait)
                         (text #:color 7 "【" 0 "】ちょっと待ってくれよ、俺が特別って言った意味は・・・舞ちゃんがお嬢様だとか、頭がいいとか、そんな事じゃないんだ。")
                         (wait)
                         (text #:color 3 "【舞】？？？")
                         (wait)
               ...
               ((&& (== V 2) (== N 1) (== (: 11) 0))
                (<>
                 (cond ((== (: 12) 0)
                       ...
                       ((== (: 12) 1)
                        (<>
                         (text #:color 7 "【" 0 "】だからあ、舞ちゃんが習ってるお稽古事って・・・。")
                         (wait)))
                       (else (<>)))
                 (set-reg: 101 1)
                 (set-arr~ @ 7 0)
                 (proc 18)
                 (menu-show (<.> (text "教習所") (text "日本舞踊")
                             (text "茶道") (text "ボクシング")
                             (text "書道") (text "虎の穴") (text "華道")))
                 (cond ((&& (== N 1) (== (: 13) 0))
                        (<>
                       ...
                       ((&& (== N 4) (== (: 16) 0))
                        (<>
                         (text #:color 7 "【" 0 "】ボクシングをやってるでしょ？・・・そのつぶれた鼻を見れば誰だってわかるさ、はっはっはっ！！")
                         (wait)
                         (text #:color 3 "【舞】・・・。")
                         (wait)
                       ...
                       ((&& (== N 7) (== (: 19) 0))
                        (<>
                         ...
                         (wait)
                         (text #:color 3 "【舞】好きよ・・・でもね、華道で使うハデなお花より、人の目の触れない所に咲いてる控え目なお花が好きなの。")
                         (wait)
                         (set-reg: 19 1)))
                       ((&& (== N 7) (== (: 19) 1))
                        (<>
               ...
               ((&& (== V 2) (== N 1) (== (: 50) 1))
                (<>
                 (text #:color 3 "【舞】いけない・・・あんまりさぼっていると、後輩に示しがつかないわね。")
                 (wait)))
               ((&& (== V 1) (== N 2) (== (: 22) 0))
                (<>
               ...
               ((&& (== V 1) (== N 2) (== (: 22) 1))
                (<>
                 (text #:color 7 "【" 0 "】舞ちゃんの髪の毛は、ちょっとだけ濡れている。")
                 (wait)))
               ((&& (== V 1) (== N 3) (== (: 23) 0))
                (<>
               ...
               ((&& (== V 1) (== N 3) (== (: 23) 1))
                (<>
                 (text #:color 7 "【" 0 "】舞ちゃんだったら、身体がなくても顔だけでイケそうだぜ。")
                 (wait)))
               ((&& (== V 1) (== N 4) (== (: 24) 0))
                (<>
               ...
               ((&& (== V 1) (== N 4) (== (: 24) 1))
                (<>
                 (text #:color 7 "【" 0 "】黄色いタオルだ・・・汚れてる訳じゃないぞ。")
                 (wait)))
               ((&& (== V 1) (== N 5) (== (: 25) 0))
                (<>
               ...
               ((&& (== V 1) (== N 6) (== (: 26) 1))
                (<>
                 (text #:color 7 "【" 0 "】（白い肌に水滴がついて・・・キラキラと輝いている。）")
                 (wait)))
               ((&& (== V 1) (== N 7) (== (: 27) 0))
                (<>
                 (text #:color 7 "【" 0 "】（手が邪魔だな・・・どけろよ、おい。）")
                 (wait)
                 (set-reg: 27 1)))
               ((&& (== V 1) (== N 7) (== (: 27) 1))
                (<>
               ...
               ((&& (== V 1) (== N 9) (== (: 29) 1))
                (<>
                 (text #:color 7 "【" 0 "】ベンチなんか、うらやましくないやいっ！！")
                 (wait)))
               ((&& (== V 1) (== N 10) (== (: 30) 0))
                (<>
               ...
               ((&& (== V 1) (== N 11) (== (: 31) 1))
                (<>
                 (text #:color 7 "【" 0 "】ちっ・・・見るほどの事はない物たぜ。")
                 (wait)))
               ((&& (== V 1) (== N 12) (== (: 32) 0))
                (<>
