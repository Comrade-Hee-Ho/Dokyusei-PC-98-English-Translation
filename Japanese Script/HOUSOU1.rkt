(mes
 ...
 (dict #\・ #\【 #\】 #\。 #\な #\い #\美 #\ん #\穂 #\っ #\の #\て #\？ #\だ
  #\、 #\に #\る #\か #\う #\た #\し #\は #\が #\ー #\ゃ #\も #\あ #\ち #\く
  #\よ #\と #\で #\え #\を #\け #\ら #\ど #\き #\そ #\す #\こ #\子 #\事 #\わ
  #\ル #\！ #\君 #\言 #\り #\人 #\女 #\ね #\れ #\ン #\つ #\ま #\何 #\や #\俺
  #\聞 #\沙 #\ご #\私 #\気 #\来 #\ト #\一 #\さ #\じ #\好 #\お #\学 #\ビ #\緒
  #\彼 #\行 #\日 #\み #\男 #\ぜ #\ラ #\手 #\ず #\ア #\バ #\イ #\せ)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 (set-arr~ @ 7 0)
         ...
         (cond ((== V 0)
                (<>
                 ...
                 (cond ((&& (== N 1) (== (: 50) 0))
                       ...
                       ((== N 2)
                        (<>
                         (text #:color 7 "【" 0 "】まあ・・・すでに中に入ってるようなもんだからな。")
                         (wait)))
                       ((== N 3)
                        (<>
                         (text #:color 7 "【" 0 "】今日は一人じゃないし、いつまでもいられそうな気がする。")
                         (wait)))
                       (else (<>)))))
               ((&& (== V 2) (== N 1) (== (: 10) 0))
                (<>
                 ...
                 (text #:color 7 "【" 0 "】美沙は？")
                 (wait)
                 (text #:color 6 "【美穂】美沙ちゃんは先に帰っちゃった・・・私も一緒に帰るつもりだったけど、学校に来るとやっぱり部室に寄りたくなっちゃうのね。")
                 (wait)
               ...
               ((&& (== V 2) (== N 1) (== (: 12) 0))
                (<>
                 ...
                 (text #:color 6 "【美穂】本当？")
                 (wait)
                 (text #:color 7 "【" 0 "】本当って・・・先負学園の男子生徒で、美穂ちゃんのファンはいっぱいいるぜ、そのくらいかわいいんだ。")
                 (wait)
                 (text #:color 6 "【美穂】・・・。")
                 (wait)
               ...
               ((&& (== V 2) (== N 1) (== (: 14) 0))
                (<>
                 ...
                 (set-arr~ @ 7 0)
                 (proc 18)
                 (menu-show (<.> (text "トラック助手")
                             (text "ビルの窓拭き")
                             (text "セールスマン") (text "家庭教師")
                             (text "人殺し")))
                 (cond ((== N 1)
                        (<>
               ...
               ((&& (== V 1) (== N 4) (== (: 11) 1))
                (<>
                 (text #:color 7 "【" 0 "】（丸顔で・・・目が大きくて、まつ毛が長くて、かわいい顔だな。）")
                 (wait)))
               ((&& (== V 1) (== N 5) (== (: 12) 0))
                (<>
