(mes
 ...
 (dict #\・ #\い #\な #\【 #\】 #\。 #\、 #\だ #\の #\二 #\健 #\に #\て #\る
  #\か #\っ #\は #\た #\を #\で #\う #\し #\？ #\も #\ん #\が #\れ #\よ #\ー
  #\と #\ら #\僕 #\く #\そ #\さ #\や #\庶 #\民 #\つ #\ま #\俺 #\ぜ #\会 #\け
  #\こ #\言 #\き #\じ #\何 #\す #\ふ #\目 #\え #\せ #\味 #\み #\ろ #\お #\あ
  #\今 #\一 #\カ #\場 #\ラ #\リ #\度 #\能)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
         ...
         (cond ((== V 0)
                (<>
                 ...
                 (cond ((&& (== N 1) (== (: 50) 0))
                       ...
                       ((== N 3)
                        (<>
                         (text #:color 4 "【健二】そうだよ・・・僕がいいと言うまで、この場を離れてはいけない。")
                         (wait)))
                       (else (<>)))))
               ((&& (== V 2) (== N 1) (== (: 10) 0))
                (<>
                 ...
                 (wait)
                 (text #:color 4 "【健二】僕だってたまには、庶民の味を楽しみたいさ・・・さとみがアルバイトしてる庶民の喫茶店で、庶民のコーヒーを味わったのさ。")
                 (wait)
               ...
               ((&& (== V 2) (== N 1) (== (: 10) 1) (== (: 11) 0))
                (<>
                 ...
                 (wait)
                 (text #:color 4 "【健二】決まっているじゃないか、ブルジョアの食べ物さ・・・新鮮で、高価で、斬新で、世界の珍味で、美しくてエレガントな食べ物さ。")
                 (wait)
               ...
               ((&& (== V 2) (== N 1) (== (: 50) 1))
                (<>
                 (text #:color 4 "【健二】さーて、庶民のコーヒーの口直しに・・・屋敷に戻って、ヴァテマラから取り寄せた本場のコーヒーの味を堪能するか。")
                 (wait)
               ...
               ((&& (== V 1) (== N 5) (== (: 16) 1))
                (<>
                 (text #:color 4 "【健二】欲しいか？・・・あげないぞ。")
                 (wait)))
               ((&& (== V 1) (== N 6) (== (: 17) 0))
                (<>
                 (text #:color 4 "【健二】人間とは不公平なものだな・・・僕みたいに、生まれながら恵まれ、才能に溢れた人間もいれば・・・" 0 "みたいに、女の子を追いかけるしか能がない人間もいる。")
                 (wait)
