(mes
 ...
 (dict #\・ #\い #\【 #\】 #\っ #\な #\、 #\の #\一 #\だ #\ん #\哉 #\た #\あ
  #\。 #\て #\か #\く #\る #\は #\う #\？ #\に #\し #\れ #\そ #\も #\よ #\ゃ
  #\と #\が #\ま #\事 #\ら #\を #\さ #\で #\ち #\や #\じ #\俺 #\こ #\！ #\ぜ
  #\悪 #\み #\け #\子 #\ど #\話 #\夏 #\え #\言 #\ー #\ろ #\気 #\お #\前)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 (set-arr~ @ 7 0)
         ...
         (cond ((== V 0)
                (<>
                 ...
                 (cond ((&& (== N 1) (== (: 50) 0))
                       ...
                       ((== N 3)
                        (<>
                         (text #:color 7 "【" 0 "】（そうだな・・・もう少しここにいよう。）")
                         (wait)))
                       (else (<>)))))
               ((&& (== V 2) (== N 8) (== (: 10) 0))
                (<>
                 ...
                 (wait)
                 (text #:color 5 "【一哉】や、やめてくれ・・・くるみとは別れちゃったし、その上、夏子さんにフラれたら・・・ああ、俺はどうしたらいいんだあ！！")
                 (wait)
                 (set-reg: 10 1)))
               ((&& (== V 2) (== N 8) (== (: 11) 0))
                (<>
                 (text #:color 5 "【一哉】前はもうちょっとマシだったんだ会って話はしてくれるんだ・・・でも、くるみと別れた事を言った途端に態度がおかしくなってさ。")
                 (wait)
                 (text #:color 7 "【" 0 "】彼女、自分のせいで別れたと思ったんじゃないのか？")
                 (wait)
                 (text #:color 5 "【一哉】" 0 "さあ、恋愛なんてそんなもんだろう？・・・夏子さんは俺達より歳上なんだから、そんな事を気にするかなあ。")
                 (wait)
                 (text #:color 7 "【" 0 "】一哉、一つだけアドバイスしてやるぜ・・・自分の好きな女の前では、たとえどんな内容でも他の女の話題は禁物だぜ。")
                 (wait)
