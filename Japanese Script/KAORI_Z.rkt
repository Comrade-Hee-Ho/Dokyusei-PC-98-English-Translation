(mes
 ...
 (dict #\・ #\っ #\【 #\】 #\。 #\た #\ん #\て #\、 #\か #\し #\の #\は #\だ
  #\お #\さ #\を #\な #\り #\い #\に #\と #\け #\そ #\う #\ー #\あ #\よ #\で
  #\も #\俺 #\が #\ま #\タ #\女 #\出 #\れ #\ナ #\ニ #\ン #\彼 #\前 #\キ #\ク
  #\会 #\え #\ら #\る #\シ #\ど)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
                  ...
                  (<>
                   ...
                   (cond ((== (: 556) 0)
                          (<>
                           ...
                           (text #:color 7 "【" 0 "】・・・。")
                           (wait)
                           (text #:color 7 "【" 0 "】あの店の前をウロウロしていれば、また会えるかな？・・・それにしても、彼女は何者なんだろう？")
                           (wait)))
                         ((== (: 566) 1)
                          (<>
                           (slot 1 5)
                   ...
                   (if-else (== (: 571) 1)
                            (<>
                             ...
                             (animate 1 0)
                             (set-arr~ @ 7 0)
                             (text #:color 7 "【" 0 "】その次に、矢吹町のカフェバーで会って・・・すでに会った時には、かおりさんは酔っ払ってたんだ。")
                             (wait)
                             ...
                             (animate 0 8 1)
                             (animate 4 8)
                             (text #:color 7 "【" 0 "】そして酔いつぶれて、変なおやぢとケンカをして、俺は二度とあの焼き肉屋に行けなくなってしまった。")
                             (wait)
                             (set-arr~ @ 7 1)
                             (set-arr~ @ 1 4096)
                             (set-arr~ @ 9 (&& (~ @ 9) 65534))
                             ...
                             (animate 0 8 0)
                             (animate 4 8)
                             (text #:color 7 "【" 0 "】タクシーに乗ったのはいいけど、かおりさんは身体が揺れるって言うし・・・仕方がないから、俺がかおりさんの身体を押さえてたんだよな。")
                             (wait)
                             (text #:color 7 "【" 0 "】・・・。")
                             (wait)
                             ...
                             (wait)
                             (text #:color 7 "【" 0 "】かおりさんは、タクシーの運ちゃんに道を教えてだけど・・・結局着いた場所は、焼き肉屋の前だったんだ。")
                             (wait)
                             ...
                             (animate 0 8 1)
                             (animate 4 8)
                             (text #:color 7 "【" 0 "】かおりさんに、ナニをナニしてもらって・・・今度は俺がかおりさんのナニをナニしてあげたんだ。")
                             (wait)
