(mes
 ...
 (dict #\・ #\し #\【 #\】 #\。 #\よ #\こ #\い #\ん #\な #\、 #\の #\は #\あ
  #\く #\ま #\で #\す #\に #\り #\た #\せ #\と #\う #\て #\話 #\君 #\！ #\っ
  #\生 #\か #\そ #\言 #\を)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 ...
 (while (== 1 1)
        (<>
         ...
         (cond ((== V 0)
               ...
               ((&& (== V 1) (== N 2))
                (<>
                 (text #:color 6 "【よしこ】髪の毛の話はしたくありません。")
                 (wait)))
               ((&& (== V 1) (== N 3))
                (<>
                 (text #:color 6 "【よしこ】メガネの話はしたくありません。")
                 (wait)))
               ((&& (== V 1) (== N 4))
                (<>
                 (text #:color 6 "【よしこ】顔の話はしたくありません。")
                 (wait)))
               ((&& (== V 1) (== N 5))
                (<>
                 (text #:color 6 "【よしこ】肌の話はしたくありません。")
                 (wait)))
               ((&& (== V 1) (== N 6))
                (<>
                 (text #:color 6 "【よしこ】胸の話は・・・したくありません。")
                 (wait)))
               ((&& (== V 1) (== N 7))
                (<>
                 (text #:color 6 "【よしこ】本の話はしたくありません。")
                 (wait)))
               ((&& (== V 1) (== N 8))
                (<>
                 (text #:color 6 "【よしこ】自分の話はしたくありません。")
                 (wait)))
               (else (<>)))))
 (set-arr~ @ 7 1))