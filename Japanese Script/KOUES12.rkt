(mes
 ...
 (dict #\・ #\【 #\】 #\な #\い #\。 #\健 #\二 #\か #\る #\、 #\て #\ん #\ら
  #\は #\だ #\っ #\の #\に #\が #\舞 #\し #\う #\事 #\？ #\た #\も #\ゃ #\を
  #\知 #\よ #\や #\じ #\一 #\ち #\あ #\と #\家 #\え #\聞 #\僕 #\ぜ #\そ #\で)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 (set-arr~ @ 7 0)
         ...
         (cond ((== V 0)
                (<>
                 ...
                 (cond ((== N 1)
                       ...
                       ((== N 3)
                        (<>
                         (text #:color 4 "【健二】僕は一日に一回、舞の顔を見ないと・・・眠れないんだ。")
                         (wait)))
                       (else (<>)))))
               ((&& (== V 2) (== N 1) (== (: 10) 0))
                (<>
               ...
               ((&& (== V 2) (== N 1) (== (: 10) 2))
                (<>
                 (text #:color 4 "【健二】舞が怒られるような事を、するはずはないと思うが・・・うーん。")
                 (wait)))
               ((&& (== V 1) (== N 2))
                (<>
               ...
               ((&& (== V 1) (== N 6))
                (<>
                 (text #:color 7 "【" 0 "】（舞ちゃんが家から出してもらえない理由は・・・俺にはわかるぜ。）")
                 (wait)))
               (else (<>)))))
 (set-arr~ @ 7 1))