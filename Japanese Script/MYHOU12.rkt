(mes
 ...
 (dict #\・ #\【 #\】 #\な #\。 #\ん #\一 #\哉 #\か #\る #\い #\っ #\は #\、
  #\て #\う #\だ #\く #\た #\よ #\あ #\み #\の #\に #\ゃ #\も #\ま #\ち #\俺
  #\と #\を #\ぜ #\？ #\が #\さ #\ど #\し #\や #\言 #\そ #\す #\つ #\来 #\事
  #\け #\き #\れ #\ら #\話)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 ...
 (while (== 1 1)
        (<>
         ...
         (cond ((== V 0)
                ...
                (<>
                 ...
                 (if-else (== (: 515) 1)
                          (<>
                           ...
                           (wait)
                           (text #:color 7 "【" 0 "】（でも、一哉がくるみちゃんをふった時点で・・・くるみちゃんは一哉の彼女じゃないもんな、うんうん。）")
                           (wait))
                          (<>))
                 (set-reg: 11 1)))
               ((&& (== V 2) (== N 8) (== (: 12) 0))
               ...
               ((&& (== V 2) (== N 8))
                (<>
                 (text #:color 5 "【一哉】今からくるみの家に行ってみようかな・・・。")
                 (wait)))
               ((&& (== V 1) (== N 9))
                (<>
