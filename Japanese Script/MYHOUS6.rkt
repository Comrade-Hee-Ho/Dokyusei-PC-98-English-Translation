(mes
 ...
 (dict #\・ #\【 #\】 #\な #\。 #\い #\み #\ろ #\ひ #\に #\、 #\て #\う #\の
  #\っ #\は #\ん #\し #\か #\？ #\と #\た #\る #\君 #\だ #\ら #\よ #\あ #\も
  #\れ #\ゃ #\が #\会 #\わ #\そ #\す #\こ #\く #\ね #\社 #\さ #\じ #\（ #\）
  #\事 #\ち #\を #\私 #\め #\ま #\彼 #\ど #\で #\度 #\許 #\嫌 #\日 #\気 #\え
  #\ご #\来 #\言 #\行 #\や #\！ #\冬 #\彦 #\き #\所 #\け #\当 #\別 #\二 #\思
  #\創 #\立 #\記 #\念)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 ...
 (if (== (: 405) 0)
     (<>
      ...
      (if (> T 1859)
          (<>
           (text #:color 7 "【" 0 "】ひろみちゃん！？・・・こんな時間にどうしたの？")
           (wait)))
      (if (< T 1900)
          (<> (text #:color 7 "【" 0 "】ひろみちゃん！？") (wait)))
        ...
        (<>
         ...
         (cond ((== V 0)
                (<>
                 ...
                 (cond ((&& (== N 1) (== (: 50) 0))
                        (<>
                         (text #:color 2 "【ひろみ】" 0 "君、待って・・・まだ話があるの。")
                         (wait)))
                       ((&& (== N 1) (== (: 50) 1))
                        (<>
                       ...
                       ((&& (== N 2) (== (: 50) 0))
                        (<>
                         (text #:color 2 "【ひろみ】" 0 "君、行かないで・・・まだ話をしたいの。")
                         (wait)))
                       ((== N 3)
                        (<>
                       ...
                       ((&& (== N 4) (== (: 50) 0))
                        (<>
                         (text #:color 7 "【" 0 "】（そうだな・・・ひろみさんと話をしよう。）")
                         (wait)))
                       ((&& (== N 4) (== (: 50) 1))
                        (<>
                         (text #:color 7 "【" 0 "】（あれれ！？・・・ひろみさんの会社に行くんじゃないか？）")
                         (wait)))
                       (else (<>)))))
               ((&& (== V 2) (== N 1) (< (: 103) 10))
                (<>
                 ...
                 (cond ((== N 1)
                        (<>
                         ...
                         (wait)
                         (text #:color 2 "【ひろみ】もう二度と" 0 "君には迷惑をかけないから・・・彼とは絶対に別れるし、" 0 "君にも二度と会わないようにする。")
                         (wait)
                         (text #:color 7 "【" 0 "】え！？")
                         (wait)
                         (text #:color 2 "【ひろみ】そうすれば、彼がまた" 0 "君の所に来る事はないわ・・・じゃあ、" 0 "君・・・さようなら。")
                         (wait)
                         (text #:color 7 "【" 0 "】あ・・・。")
                         (wait)
                         (set-arr~ @ 7 1)
                       ...
                       ((== N 2)
                        (<>
                         ...
                         (wait)
                         (text #:color 2 "【ひろみ】彼とは絶対に別れるし、私も" 0 "君に二度と会わない・・・そうすれば、彼だって" 0 "君の所に来る理由がないもの。")
                         (wait)
                         (text #:color 7 "【" 0 "】え！？")
                         (wait)
               ...
               ((&& (== V 2) (== N 1) (== (: 11) 0))
                (<>
                 (text #:color 2 "【ひろみ】冬彦君が、私に会いに来て・・・『" 0 "君とは決着がついた、もう一度僕とやり直そう』なんて言うから、もうびっくりしちゃって。")
                 (wait)
                 (text #:color 2 "【ひろみ】・・・。")
                 (wait)
               ...
               ((&& (== V 2) (== N 1) (== (: 50) 1))
                (<>
                 (text #:color 2 "【ひろみ】ねえ、私の会社に行きましょうよ。")
                 (wait)))
               ((&& (== V 1) (== N 2))
                (<>
                 (text #:color 7 "【" 0 "】（ひろみさんはショートカットだな・・・。）")
                 (wait)))
               ((&& (== V 1) (== N 3))
                (<>
                 (text #:color 7 "【" 0 "】（微笑んでいるけど、どこか寂しそうな笑顔だ・・・。）")
                 (wait)))
               ((&& (== V 1) (== N 4))
                (<>
