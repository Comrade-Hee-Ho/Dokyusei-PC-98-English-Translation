(mes
 ...
 (dict #\・ #\な #\い #\【 #\】 #\だ #\。 #\の #\、 #\っ #\太 #\郎 #\か #\ん
  #\ら #\る #\は #\て #\そ #\う #\が #\く #\に #\を #\た #\で #\し #\よ #\や
  #\れ #\？ #\言 #\も #\と #\き #\何 #\女 #\事 #\マ #\タ #\ロ #\ウ #\性 #\！
  #\あ #\つ #\え #\頭 #\ろ #\ゃ #\君 #\大 #\け #\り #\じ #\ま #\す #\ど)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 (set-arr~ @ 7 0)
 ...
 (if (== (: 451) 0)
     (<>
      ...
      (wait)
      (text #:color 5 "【太郎】その女性の事を考えると、生殖器が大きくなるんだ・・・たぶん血液が流れ込んでいる為だと思うが、その分、頭の血行が悪くなる。")
      (wait)
 ...
 (while (== 1 1)
        (<>
         ...
         (cond ((== V 0)
               ...
               ((&& (== V 1) (== N 10))
                (<>
                 (text #:color 7 "【" 0 "】マタロウのメガネだ・・・もう見飽きたよ。")
                 (wait)))
               ((&& (== V 1) (== N 11))
                (<>
