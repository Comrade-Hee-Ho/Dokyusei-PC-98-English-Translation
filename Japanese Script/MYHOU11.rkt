(mes
 ...
 (dict #\・ #\【 #\】 #\る #\。 #\く #\い #\み #\の #\な #\ん #\う #\っ #\て
  #\か #\に #\が #\た #\、 #\ゃ #\だ #\と #\？ #\は #\あ #\一 #\し #\ち #\哉
  #\私 #\を #\も #\さ #\れ #\悪 #\（ #\） #\き #\そ #\ど #\事 #\こ #\！ #\よ
  #\君 #\ら #\女 #\何 #\け #\り #\子 #\俺 #\で #\わ #\言 #\人 #\ー #\せ #\夏
  #\テ #\じ #\ま #\え #\思 #\性 #\ホ #\ル #\お #\行 #\や #\ろ #\ば #\つ #\ッ
  #\驚 #\す #\大)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
         ...
         (cond ((== V 0)
                (<>
                 ...
                 (cond ((== N 1)
                       ...
                       ((&& (== N 2) (== (: 50) 0))
                        (<>
                         (text #:color 7 "【" 0 "】（いや・・・くるみちゃんと話をした方がいいだろう。）")
                         (wait)))
                       ((&& (== N 2) (== (: 49) 1))
                        (<>
                         (text #:color 7 "【" 0 "】（ホテルに行くと決めたんだ・・・部屋に戻る事はないだろう。）")
                         (wait)))
                       ((&& (== N 2) (== (: 50) 1))
                        (<>
                       ...
                       ((&& (== N 3) (== (: 50) 0))
                        (<>
                         (text #:color 7 "【" 0 "】（この様子は普通じゃない・・・くるみちゃんと話をしよう。）")
                         (wait)))
                       ((&& (== N 3) (== (: 50) 1))
                        (<>
                       ...
                       ((&& (== N 4) (== (: 50) 0))
                        (<>
                         (text #:color 7 "【" 0 "】（そうだ・・・まだここにいようぜ。）")
                         (wait)))
                       ((== N 4)
                        (<>
                         (text #:color 7 "【" 0 "】（まだここにいるのか・・・？）")
                         (wait)))
                       (else (<>)))))
               ((&& (== V 2) (== N 1) (== (: 10) 0))
                (<>
               ...
               ((&& (== V 2) (== N 1) (== (: 12) 0))
                (<>
                 ...
                 (cond ((== N 1)
                       ...
                       ((== N 2)
                        (<>
                         (text #:color 7 "【" 0 "】別に驚かないぜ・・・くるみちゃんが言ってたじゃないか、一哉に好きな人ができたのかもしれないって。")
                         (wait)
               ...
               ((&& (== V 2) (== N 1) (== (: 14) 0))
                (<>
                 ...
                 (set-arr~ @ 7 0)
                 (proc 18)
                 (menu-show (<.> (text "一哉が悪い")
                             (text "くるみが悪い")
                             (text "夏子が悪い") (text "俺が悪い")))
                 (cond ((== N 1)
                        (<>
               ...
               ((&& (== V 2) (== N 1) (== (: 49) 1))
                (<>
                 (text #:color 6 "【くるみ】" 0 "さん・・・ホテルに連れてって。")
                 (wait)))
               ((&& (== V 2) (== N 1))
                (<>
               ...
               ((&& (== V 1) (== N 2))
                (<>
                 (text #:color 7 "【" 0 "】（彼女の心は傷ついてるように見える・・・かわいそうだな。）")
                 (wait)))
               (else (<>)))))
 (set-arr~ @ 7 1))