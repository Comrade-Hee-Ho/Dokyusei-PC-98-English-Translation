(mes
 ...
 (dict #\・ #\の #\【 #\】 #\い #\。 #\な #\っ #\て #\か #\た #\、 #\ん #\し
  #\だ #\美 #\を #\沙 #\は #\と #\が #\ら #\も #\に #\で #\る #\あ #\う #\ち
  #\事 #\つ #\よ #\そ #\や #\れ #\ー #\け #\言 #\ま #\俺 #\ゃ #\え #\く #\デ
  #\子 #\考 #\こ #\時 #\落 #\り #\見 #\上 #\気 #\込 #\ど #\ト #\女 #\ば #\わ
  #\リ #\ケ #\室 #\び #\ろ #\ず #\お)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
        ...
        (<>
         ...
         (cond ((&& (== N 10) (== (: 711) 0))
                (<>
                 ...
                 (wait)
                 (text #:color 7 "【" 0 "】性格は悪くないんだが、言葉使いは荒いし、色気もないし・・・まあ、彼女の方からやってほしいと言うのなら考えてもいいぞ。")
                 (wait)
                 (if-else (== (: 260) 1)
                          (<>
                           (slot 1 3)
                           ...
                           (animate 1 0)
                           (set-arr~ @ 7 0)
                           (text #:color 7 "【" 0 "】と言いつつ・・・美沙のセーラー服姿を見ると、雰囲気が変わるんだよ、セーラー服は女の子を何倍もかわいく見せるらしい。")
                           (wait)
                           (text #:color 7 "【" 0 "】胸もけっこうでかそうだし・・・脚も奇麗だし、足首なんか、こうキュッとしまってて・・・いいかげんにしよう。")
                           (wait))
                          (<>))
                 (if-else (== (: 279) 1)
                          (<>
                           ...
                           (wait)
                           (text #:color 7 "【" 0 "】あいつでも落ち込んだ顔をする事があるんだよな・・・言葉使いは荒っぽいけど、けっこうデリケートなのかもしれないぞ。")
                           (wait)
                           (text #:color 7 "【" 0 "】・・・。")
                           (wait)
                           ...
                           (cond ((== (: 709) 0)
                                 ...
                                 ((== (: 709) 1)
                                  (<>
                                   ...
                                   (wait)
                                   (text #:color 7 "【" 0 "】どうりで練習にも出てないはずだよ・・・美沙のやつ、俺に何も言わないなんてずいぶんだよな。")
                                   (wait)))
                                 (else (<>))))
                          (<>))
                 (if-else (== (: 690) 1)
                 ...
                 (if-else (== (: 709) 1)
                          (<>
                           ...
                           (animate 1 0)
                           (set-arr~ @ 7 0)
                           (text #:color 7 "【" 0 "】なんて事を思い出してる場合じゃないな・・・再び練習に出た美沙は、再び肉離れを起こしてしまったんだ。")
                           (wait)
                 ...
                 (cond ((== (: 709) 0)
                        (<>
                         (text #:color 7 "【" 0 "】ははは・・・こんな事を美沙に聞かれたら、殴られるに決まってる。")
                         (wait)))
                       ((== (: 709) 1)
                        (<>
                         (text #:color 7 "【" 0 "】美沙のやつ、ずいぶん落ち込んでいたけど・・・大丈夫かな。")
                         (wait)))
                       (else (<>)))
                 (set-reg: 608 1)
                 (slot 1 2)
               ...
               ((&& (== N 10) (== (: 711) 1))
                (<>
                 ...
                 (animate 1 0)
                 (set-arr~ @ 7 0)
                 (text #:color 7 "【" 0 "】公園の前で会った時も、色々と悩んでたよな・・・美沙は見かけよりもずっと弱くて、デリケートなのかもしれない。")
                 (wait)
                 (slot 1 8)
                 (set-arr~ @ 7 1)
                 (set-arr~ @ 1 4096)
                 ...
                 (wait)
                 (text #:color 7 "【" 0 "】その時の怪我は大した事はなかったけど・・・美沙が考えていた事って、ふとももの肉離れの事だったんだろう。")
                 (wait)
                 (set-arr~ @ 7 1)
                 (set-arr~ @ 1 4096)
                 (set-arr~ @ 9 (&& (~ @ 9) 65534))
