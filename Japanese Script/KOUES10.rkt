(mes
 ...
 (dict #\・ #\【 #\】 #\っ #\ん #\な #\て #\。 #\い #\か #\う #\る #\子 #\に
  #\、 #\亜 #\し #\た #\こ #\の #\？ #\さ #\わ #\君 #\だ #\と #\そ #\ゃ #\ら
  #\き #\ろ #\が #\（ #\） #\く #\一 #\で #\思 #\も #\れ #\ど #\を #\出)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 (set-arr~ @ 7 0)
 ...
 (while (== 1 1)
        (<>
         ...
         (cond ((== V 0)
               ...
               ((&& (== V 1) (== N 3))
                (<>
                 (text #:color 7 "【" 0 "】（似合ってると思うけど・・・カツラじゃないよな？）")
                 (wait)))
               ((&& (== V 1) (== N 4))
                (<>
                 (text #:color 7 "【" 0 "】（痴漢が喜びそうな胸をしてるぜ・・・。）")
                 (wait)))
               ((&& (== V 1) (== N 5))
                (<>
