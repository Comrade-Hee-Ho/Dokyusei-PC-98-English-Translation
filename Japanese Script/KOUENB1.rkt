(mes
 ...
 (dict #\・ #\【 #\】 #\っ #\い #\、 #\う #\。 #\て #\の #\ろ #\み #\ひ #\な
  #\た #\か #\ん #\だ #\と #\あ #\に #\？ #\も #\し #\ち #\よ #\ら #\ふ #\ゃ
  #\！ #\る #\は #\ー #\こ #\く #\れ #\り #\き #\（ #\が #\） #\君 #\そ #\で
  #\を #\や #\来 #\ね #\へ #\わ #\早 #\気 #\日 #\ま #\間 #\ょ #\ど #\俺)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 (set-arr~ @ 7 0)
 ...
 (cond ((== T 1100)
       ...
       ((> T 1059)
        (<>
         ...
         (wait)
         (text #:color 2 "【ひろみ】ちょっとじゃないわよ、あと５分待って来なかったら帰ろうかと思ってたのよ・・・罰として、今日はたっぷりつき合ってもらうからね。")
         (wait)
         (text #:color 7 "【" 0 "】へいへい・・・。")
         (wait)
         (set-reg: 401 1)
 ...
 (while (== 1 1)
        (<>
         ...
         (cond ((== V 0)
               ...
               ((&& (== V 2) (== N 1) (== (: 10) 1))
                (<>
                 (text #:color 2 "【ひろみ】" 0 "君、いい天気でよかったね。")
                 (wait)))
               ((&& (== V 1) (== N 2))
                (<>
                 (text #:color 7 "【" 0 "】（ひろみちゃんの髪だ・・・俺はこの髪に触れる事ができるだろうか？）")
                 (wait)))
               ((&& (== V 1) (== N 3))
                (<>
               ...
               ((&& (== V 1) (== N 6))
                (<>
                 (text #:color 7 "【" 0 "】（胸に触って、乳首を吸いまくってやるぜ・・・へっへっへっ。）")
                 (wait)))
               ((&& (== V 1) (== N 7))
                (<>
