(mes
 ...
 (dict #\・ #\っ #\【 #\】 #\ん #\。 #\の #\て #\、 #\な #\し #\だ #\た #\い
  #\は #\う #\に #\を #\と #\女 #\が #\子 #\で #\俺 #\彼 #\あ #\く #\さ #\る
  #\か #\そ #\ー #\亜 #\よ #\ま #\ら #\ひ #\も #\ス #\け #\す #\ン #\り #\事
  #\ど #\え #\行 #\ぜ #\ナ #\ニ)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
        ...
        (<>
         ...
         (if-else (== N 2)
                  (<>
                   ...
                   (wait)
                   (text #:color 7 "【" 0 "】まあ、あんな美人のお姉さんを持てば、仕方のない事かもしれないが・・・亜子さんだって、とってもかわいいと思うけどなあ。")
                   (wait)
                   (if-else (== (: 314) 1)
                            (<>
                             (slot 1 5)
                             ...
                             (animate 1 0)
                             (set-arr~ @ 7 0)
                             (text #:color 7 "【" 0 "】そう言えば、その亜子さんと一緒に喫茶店に行ったんだっけ・・・スプーンをなめなめ、色々と話をしたんだ。")
                             (wait)
                             (set-arr~ @ 7 1)
                             (set-arr~ @ 1 4096)
                             (set-arr~ @ 9 (&& (~ @ 9) 65534))
                             ...
                             (proc 24)
                             (set-arr~ @ 7 0)
                             (text #:color 7 "【" 0 "】ひっひっひっ、さとみがくれたスプーンのおかげで・・・俺は亜子さんのパンチラを充分に堪能する事ができたぞ。")
                             (wait)
                             (text #:color 7 "【" 0 "】うーん、あの時は興奮のあまり・・・ポコチンでテーブルを持ち上げそうになってしまったぜ、うん。")
                             (wait)
                             (set-arr~ @ 7 1)
                             (set-arr~ @ 1 4096)
                             (set-arr~ @ 9 (&& (~ @ 9) 65534))
                             ...
                             (animate 1 0)
                             (set-arr~ @ 7 0)
                             (text #:color 7 "【" 0 "】うーん、あのポーズも刺激的だってな・・・子供用のすべり台で無理にすべろうとするから、パンティがまる見えだった。")
                             (wait)
                             (text #:color 7 "【" 0 "】その上、お尻がはまって抜けなくなって・・・ひっひっひっ、おかげで胸とか色々と触れたけどね。")
                             (wait)
                             (set-arr~ @ 7 1)
                             (set-arr~ @ 1 4096)
                             (set-arr~ @ 9 (&& (~ @ 9) 65534))
                             ...
                             (animate 0 8 0)
                             (animate 4 8)
                             (text #:color 7 "【" 0 "】最後の仕上げは、ご褒美としてさせてもらったキスだな・・・キスをしたあと彼女は喜んで走って行ってしまった。")
                             (wait)
                             (text #:color 7 "【" 0 "】・・・。")
                             (wait)
