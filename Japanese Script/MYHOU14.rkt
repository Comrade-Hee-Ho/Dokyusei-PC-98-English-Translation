(mes
 ...
 (dict #\・ #\い #\【 #\】 #\ん #\。 #\や #\よ #\さ #\な #\し #\あ #\た #\だ
  #\れ #\に #\て #\ま #\、 #\の #\で #\る #\っ #\く #\か #\も #\う #\す #\ら
  #\は #\惚 #\何 #\が #\言 #\（ #\） #\私 #\り #\そ)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 ...
 (while (== 1 1)
        (<>
         ...
         (cond ((== V 0)
                ...
                (<>
                 ...
                 (cond ((&& (== N 1) (== (: 11) 0))
                        (<>
                         ...
                         (text #:color 6 "【やよい】・・・。")
                         (wait)
                         (text #:color 7 "【" 0 "】誤解しないでくれ、あんな事をしてもらったからじゃないんだ・・・俺はやよいさんの優しい心に惚れてしまった。")
                         (wait)
               ...
               ((&& (== V 2) (== N 1) (== (: 10) 2))
                (<>
                 (text #:color 6 "【やよい】私・・・帰りますけど。")
                 (wait)))
               ((&& (== V 1) (== N 2))
                (<>
                 (text #:color 7 "【" 0 "】（やよいさんの顔は・・・夜に見ても美しい。）")
                 (wait)))
               ((&& (== V 1) (== N 3))
                (<>
                 (text #:color 7 "【" 0 "】（ああ・・・もう一度、あの髪に触りたい。）")
                 (wait)))
               ((&& (== V 1) (== N 4))
                (<>
                 (text #:color 7 "【" 0 "】（あの首筋にキスできたら・・・俺は太く長く生きてもいい。）")
                 (wait)))
               ((&& (== V 1) (== N 5))
                (<>
                 (text #:color 7 "【" 0 "】（・・・。）")
               ...
               ((&& (== V 1) (== N 6))
                (<>
                 (text #:color 7 "【" 0 "】（やよいさんだ・・・あの時の事が思い出される。）")
                 (wait)))
               (else (<>)))))
 (set-arr~ @ 7 1))