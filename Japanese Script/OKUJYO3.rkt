(mes
 ...
 (dict #\・ #\な #\の #\【 #\】 #\る #\。 #\れ #\い #\だ #\ら #\太 #\郎 #\を
  #\、 #\て #\か #\は #\う #\し #\が #\あ #\も #\ん #\に #\事 #\？ #\よ #\と
  #\女 #\そ #\っ #\忘 #\ろ #\性 #\で #\す #\こ #\え #\た #\ど #\く #\ま #\り
  #\気 #\ち #\！ #\つ #\見 #\ば)
 (set-arr~ @ 7 1)
 (set-arr~ @ 3 0)
 (set-arr~ @ 2 45056)
 ...
 (if (== (: 452) 0)
     (<>
      ...
      (wait)
      (text #:color 7 "【" 0 "】ふと気がつくと、学校の屋上に来ている・・・金網ごしに見下ろすと、なぜか自分の身体が吸い込まれるような気がする。")
      (wait)
         ...
         (cond ((== V 0)
                (<>
                 ...
                 (cond ((== N 1)
                       ...
                       ((== N 2)
                        (<>
                         (text #:color 5 "【太郎】君はまだ屋上にいるのか？・・・仕方がない、つき合ってあげよう。")
                         (wait)))
                       (else (<>)))))
               ((&& (== V 3) (== N 8))
                (<>
